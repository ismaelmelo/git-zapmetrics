...
$uc_ator_view = NULL; // Initialize page object first

class cuc_ator_view extends cuc_ator {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["nu_uc"] <> "") {
				...
				$sReturnUrl = "uc_atorlist.php"; // Return to list
			}
			if (@$_GET["nu_ator"] <> "") {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "uc_atorlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "uc_atorlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($uc_ator_view)) $uc_ator_view = new cuc_ator_view();

// Page init
$uc_ator_view->Page_Init();

// Page main
$uc_ator_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$uc_ator_view->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var uc_ator_view = new ew_Page("uc_ator_view");
uc_ator_view.PageID = "view"; // Page ID
var EW_PAGE_ID = uc_ator_view.PageID; // For backward compatibility

// Form object
var fuc_atorview = new ew_Form("fuc_atorview");

// Form_CustomValidate event
fuc_atorview.Form_CustomValidate = 
...
fuc_atorview.ValidateRequired = true;
<?php } else { ?>
fuc_atorview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fuc_atorview.Lists["x_nu_uc"] = {"LinkField":"x_nu_uc","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_alternativo","x_no_uc","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fuc_atorview.Lists["x_nu_ator"] = {"LinkField":"x_nu_ator","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_ator","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $uc_ator_view->ExportOptions->Render("body") ?>
<?php if (!$uc_ator_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($uc_ator_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php $uc_ator_view->ShowPageHeader(); ?>
<?php
$uc_ator_view->ShowMessage();
?>
<form name="fuc_atorview" id="fuc_atorview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="uc_ator">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_uc_atorview" class="table table-bordered table-striped">
<?php if ($uc_ator->nu_uc->Visible) { // nu_uc ?>
	<tr id="r_nu_uc">
		<td><span id="elh_uc_ator_nu_uc"><?php echo $uc_ator->nu_uc->FldCaption() ?></span></td>
		<td<?php echo $uc_ator->nu_uc->CellAttributes() ?>>
<span id="el_uc_ator_nu_uc" class="control-group">
...
<?php if ($uc_ator->nu_ator->Visible) { // nu_ator ?>
	<tr id="r_nu_ator">
		<td><span id="elh_uc_ator_nu_ator"><?php echo $uc_ator->nu_ator->FldCaption() ?></span></td>
