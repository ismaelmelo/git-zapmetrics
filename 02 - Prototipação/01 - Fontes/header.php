...
var EW_UPLOAD_ALLOWED_FILE_EXT = "gif,jpg,jpeg,bmp,png,doc,xls,pdf,zip,pdf,docm,docx,xlsx,xls,odt,php,html"; // Allowed upload file extension
...
<?php
ew_AddStylesheet("http://code.jquery.com/ui/1.10.3/themes/smoothness/jquery-ui.css"); // Add CSS stylesheet
ew_AddClientScript("http://code.jquery.com/ui/1.10.3/jquery-ui.js"); // Add JavaScript
?>
<script type="text/javascript">
...
<?php if (!ew_IsMobile()) { ?>
  ...
  <div id="ewHeaderRow" class="ewHeaderRow"><img src="phpimages/logogit.png" alt="" style="border: 0;">	</div>
	<!-- header (end) -->
<?php } ?>
<?php if (ew_IsMobile()) { ?>
