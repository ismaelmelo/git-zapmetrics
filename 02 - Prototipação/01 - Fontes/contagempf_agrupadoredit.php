...
$contagempf_agrupador_edit = NULL; // Initialize page object first

class ccontagempf_agrupador_edit extends ccontagempf_agrupador {
	...
	// Page object name
	var $PageObjName = 'contagempf_agrupador_edit';
	...
	function Page_Main() {
		...
		if ($this->nu_contagem->CurrentValue == "")
			$this->Page_Terminate("contagempf_agrupadorlist.php"); // Invalid key, return to list
		if ($this->nu_agrupador->CurrentValue == "")
			$this->Page_Terminate("contagempf_agrupadorlist.php"); // Invalid key, return to list
...
// Create page object
if (!isset($contagempf_agrupador_edit)) $contagempf_agrupador_edit = new ccontagempf_agrupador_edit();

// Page init
$contagempf_agrupador_edit->Page_Init();

// Page main
$contagempf_agrupador_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$contagempf_agrupador_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var contagempf_agrupador_edit = new ew_Page("contagempf_agrupador_edit");
contagempf_agrupador_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = contagempf_agrupador_edit.PageID; // For backward compatibility

// Form object
var fcontagempf_agrupadoredit = new ew_Form("fcontagempf_agrupadoredit");

// Validate form
fcontagempf_agrupadoredit.Validate = function() {
...
fcontagempf_agrupadoredit.Form_CustomValidate = 
...
fcontagempf_agrupadoredit.ValidateRequired = true;
<?php } else { ?>
fcontagempf_agrupadoredit.ValidateRequired = false; 
<?php } ?>
...
<?php $contagempf_agrupador_edit->ShowPageHeader(); ?>
<?php
$contagempf_agrupador_edit->ShowMessage();
?>
<form name="fcontagempf_agrupadoredit" id="fcontagempf_agrupadoredit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="contagempf_agrupador">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_contagempf_agrupadoredit" class="table table-bordered table-striped">
</table>
</td></tr></table>
<input type="hidden" data-field="x_nu_contagem" name="x_nu_contagem" id="x_nu_contagem" value="<?php echo ew_HtmlEncode($contagempf_agrupador->nu_contagem->CurrentValue) ?>">
<input type="hidden" data-field="x_nu_agrupador" name="x_nu_agrupador" id="x_nu_agrupador" value="<?php echo ew_HtmlEncode($contagempf_agrupador->nu_agrupador->CurrentValue) ?>">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("EditBtn") ?></button>
</form>
<script type="text/javascript">
fcontagempf_agrupadoredit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$contagempf_agrupador_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$contagempf_agrupador_edit->Page_Terminate();
?>
