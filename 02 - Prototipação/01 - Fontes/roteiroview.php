...
$roteiro_view = NULL; // Initialize page object first

class croteiro_view extends croteiro {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["nu_roteiro"] <> "") {
			$this->RecKey["nu_roteiro"] = $_GET["nu_roteiro"];
			$KeyUrl .= "&nu_roteiro=" . urlencode($this->RecKey["nu_roteiro"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["nu_roteiro"] <> "") {
				...
				$this->RecKey["nu_roteiro"] = $this->nu_roteiro->QueryStringValue;
			} else {
				$sReturnUrl = "roteirolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "roteirolist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "roteirolist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupOtherOptions() {
		...
		// Detail table 'faseroteiro'
		$body = $Language->TablePhrase("faseroteiro", "TblCaption");
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("faseroteirolist.php?" . EW_TABLE_SHOW_MASTER . "=roteiro&nu_roteiro=" . strval($this->nu_roteiro->CurrentValue) . "") . "\">" . $body . "</a>";
		$item = &$option->Add("detail_faseroteiro");
		$item->Body = $body;
		$item->Visible = $Security->AllowList(CurrentProjectID() . 'faseroteiro');
		if ($item->Visible) {
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("faseroteiro", $DetailTblVar)) {
				...
				if ($GLOBALS["faseroteiro_grid"]->DetailView) {
					$GLOBALS["faseroteiro_grid"]->CurrentMode = "view";
...
// Create page object
if (!isset($roteiro_view)) $roteiro_view = new croteiro_view();

// Page init
$roteiro_view->Page_Init();

// Page main
$roteiro_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$roteiro_view->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var roteiro_view = new ew_Page("roteiro_view");
roteiro_view.PageID = "view"; // Page ID
var EW_PAGE_ID = roteiro_view.PageID; // For backward compatibility

// Form object
var froteiroview = new ew_Form("froteiroview");

// Form_CustomValidate event
froteiroview.Form_CustomValidate = 
...
froteiroview.ValidateRequired = true;
<?php } else { ?>
froteiroview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
froteiroview.Lists["x_nu_metodologia"] = {"LinkField":"x_nu_metodologia","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_metodologia","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $roteiro_view->ExportOptions->Render("body") ?>
<?php if (!$roteiro_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($roteiro_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php $roteiro_view->ShowPageHeader(); ?>
<?php
$roteiro_view->ShowMessage();
?>
<form name="froteiroview" id="froteiroview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="roteiro">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_roteiroview" class="table table-bordered table-striped">
...
<span<?php echo $roteiro->ds_roteiro->ViewAttributes() ?>>
<?php echo $roteiro->ds_roteiro->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
	if (in_array("faseroteiro", explode(",", $roteiro->getCurrentDetailTable())) && $faseroteiro->DetailView) {
?>
