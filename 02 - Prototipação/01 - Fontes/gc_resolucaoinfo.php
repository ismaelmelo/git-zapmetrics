...
//
// Table class for gc_resolucao
//
class cgc_resolucao extends cTable {
	var $nu_resolucao;
	...
	function __construct() {
		...
		$this->TableVar = 'gc_resolucao';
		$this->TableName = 'gc_resolucao';
		...
		// nu_resolucao
		$this->nu_resolucao = new cField('gc_resolucao', 'gc_resolucao', 'x_nu_resolucao', 'nu_resolucao', '[nu_resolucao]', 'CAST([nu_resolucao] AS NVARCHAR)', 3, -1, FALSE, '[nu_resolucao]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->nu_resolucao->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['nu_resolucao'] = &$this->nu_resolucao;

		// nu_grupoOuComite
		$this->nu_grupoOuComite = new cField('gc_resolucao', 'gc_resolucao', 'x_nu_grupoOuComite', 'nu_grupoOuComite', '[nu_grupoOuComite]', 'CAST([nu_grupoOuComite] AS NVARCHAR)', 3, -1, FALSE, '[nu_grupoOuComite]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// ds_resolucao
		$this->ds_resolucao = new cField('gc_resolucao', 'gc_resolucao', 'x_ds_resolucao', 'ds_resolucao', '[ds_resolucao]', '[ds_resolucao]', 201, -1, FALSE, '[ds_resolucao]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['ds_resolucao'] = &$this->ds_resolucao;

		// no_local
		$this->no_local = new cField('gc_resolucao', 'gc_resolucao', 'x_no_local', 'no_local', '[no_local]', '[no_local]', 200, -1, FALSE, '[no_local]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['no_local'] = &$this->no_local;

		// im_anexo
		$this->im_anexo = new cField('gc_resolucao', 'gc_resolucao', 'x_im_anexo', 'im_anexo', '[im_anexo]', '[im_anexo]', 200, -1, TRUE, '[im_anexo]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->im_anexo->UploadMultiple = TRUE;
		$this->fields['im_anexo'] = &$this->im_anexo;

		// dt_publicacao
		$this->dt_publicacao = new cField('gc_resolucao', 'gc_resolucao', 'x_dt_publicacao', 'dt_publicacao', '[dt_publicacao]', '(REPLACE(STR(DAY([dt_publicacao]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([dt_publicacao]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([dt_publicacao]),4,0))', 135, 7, FALSE, '[dt_publicacao]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->dt_publicacao->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['dt_publicacao'] = &$this->dt_publicacao;

		// ic_situacao
		$this->ic_situacao = new cField('gc_resolucao', 'gc_resolucao', 'x_ic_situacao', 'ic_situacao', '[ic_situacao]', '[ic_situacao]', 129, -1, FALSE, '[ic_situacao]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['ic_situacao'] = &$this->ic_situacao;

		// nu_usuario
		$this->nu_usuario = new cField('gc_resolucao', 'gc_resolucao', 'x_nu_usuario', 'nu_usuario', '[nu_usuario]', 'CAST([nu_usuario] AS NVARCHAR)', 3, -1, FALSE, '[nu_usuario]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->nu_usuario->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['nu_usuario'] = &$this->nu_usuario;

		// ts_datahora
		$this->ts_datahora = new cField('gc_resolucao', 'gc_resolucao', 'x_ts_datahora', 'ts_datahora', '[ts_datahora]', '(REPLACE(STR(DAY([ts_datahora]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([ts_datahora]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([ts_datahora]),4,0))', 135, 7, FALSE, '[ts_datahora]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "[dbo].[gc_resolucao]";
	...
	function DeleteSQL(&$rs, $where = "") {
		...
		if ($rs) {
			if (array_key_exists('nu_resolucao', $rs))
				ew_AddFilter($where, ew_QuotedName('nu_resolucao') . '=' . ew_QuotedValue($rs['nu_resolucao'], $this->nu_resolucao->FldDataType));
		}
		$filter = $this->CurrentFilter;
		ew_AddFilter($filter, $where);
		if ($filter <> "")
	...
	function SqlKeyFilter() {
		return "[nu_resolucao] = @nu_resolucao@";
	}

	// Key filter
	function KeyFilter() {
		$sKeyFilter = $this->SqlKeyFilter();
		if (!is_numeric($this->nu_resolucao->CurrentValue))
			$sKeyFilter = "0=1"; // Invalid key
		$sKeyFilter = str_replace("@nu_resolucao@", ew_AdjustSql($this->nu_resolucao->CurrentValue), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("gc_resolucaoview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("gc_resolucaoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "gc_resolucaoadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("gc_resolucaoedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("gc_resolucaoadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("gc_resolucaodelete.php", $this->UrlParm());
	}
	...
	function KeyUrl($url, $parm = "") {
		$sUrl = $url . "?";
		if ($parm <> "") $sUrl .= $parm . "&";
		if (!is_null($this->nu_resolucao->CurrentValue)) {
			$sUrl .= "nu_resolucao=" . urlencode($this->nu_resolucao->CurrentValue);
		} else {
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			$arKeys[] = @$_GET["nu_resolucao"]; // nu_resolucao
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->nu_resolucao->CurrentValue = $key;
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				if ($this->nu_resolucao->Exportable) $Doc->ExportCaption($this->nu_resolucao);
				if ($this->nu_grupoOuComite->Exportable) $Doc->ExportCaption($this->nu_grupoOuComite);
				if ($this->ds_resolucao->Exportable) $Doc->ExportCaption($this->ds_resolucao);
				if ($this->no_local->Exportable) $Doc->ExportCaption($this->no_local);
				if ($this->im_anexo->Exportable) $Doc->ExportCaption($this->im_anexo);
				if ($this->dt_publicacao->Exportable) $Doc->ExportCaption($this->dt_publicacao);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					if ($this->nu_resolucao->Exportable) $Doc->ExportField($this->nu_resolucao);
					if ($this->nu_grupoOuComite->Exportable) $Doc->ExportField($this->nu_grupoOuComite);
					if ($this->ds_resolucao->Exportable) $Doc->ExportField($this->ds_resolucao);
					if ($this->no_local->Exportable) $Doc->ExportField($this->no_local);
					if ($this->im_anexo->Exportable) $Doc->ExportField($this->im_anexo);
					if ($this->dt_publicacao->Exportable) $Doc->ExportField($this->dt_publicacao);
