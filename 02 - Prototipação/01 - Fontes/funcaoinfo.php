...
class cfuncao extends cTable {
	...
	function __construct() {
		...
		// nu_funcao
		$this->nu_funcao = new cField('funcao', 'funcao', 'x_nu_funcao', 'nu_funcao', '[nu_funcao]', 'CAST([nu_funcao] AS NVARCHAR)', 3, -1, FALSE, '[nu_funcao]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->nu_funcao->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['nu_funcao'] = &$this->nu_funcao;

		// no_funcao
		$this->no_funcao = new cField('funcao', 'funcao', 'x_no_funcao', 'no_funcao', '[no_funcao]', '[no_funcao]', 200, -1, FALSE, '[no_funcao]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['no_funcao'] = &$this->no_funcao;

		// ic_ativo
		$this->ic_ativo = new cField('funcao', 'funcao', 'x_ic_ativo', 'ic_ativo', '[ic_ativo]', '[ic_ativo]', 129, -1, FALSE, '[ic_ativo]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlOrderBy() { // Order By
		return "[no_funcao] ASC,[ic_ativo] ASC";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("funcaoview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("funcaoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "funcaoadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("funcaoedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("funcaoadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("funcaodelete.php", $this->UrlParm());
	}
