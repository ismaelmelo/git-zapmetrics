...
$contagempf_funcao_edit = NULL; // Initialize page object first

class ccontagempf_funcao_edit extends ccontagempf_funcao {
	...
	// Page object name
	var $PageObjName = 'contagempf_funcao_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->nu_funcao->CurrentValue == "")
			$this->Page_Terminate("contagempf_funcaolist.php"); // Invalid key, return to list
	...
	function LoadFormValues() {
		...
		if (!$this->nu_funcao->FldIsDetailKey)
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// ds_alr
			$this->ds_alr->SetDbValueDef($rsnew, $this->ds_alr->CurrentValue, NULL, $this->ds_alr->ReadOnly);

			// qt_der
			$this->qt_der->SetDbValueDef($rsnew, $this->qt_der->CurrentValue, NULL, $this->qt_der->ReadOnly);

			// ds_der
			$this->ds_der->SetDbValueDef($rsnew, $this->ds_der->CurrentValue, NULL, $this->ds_der->ReadOnly);
			...
			// ic_analalogia
			$this->ic_analalogia->SetDbValueDef($rsnew, $this->ic_analalogia->CurrentValue, NULL, $this->ic_analalogia->ReadOnly);
...
// Create page object
if (!isset($contagempf_funcao_edit)) $contagempf_funcao_edit = new ccontagempf_funcao_edit();

// Page init
$contagempf_funcao_edit->Page_Init();

// Page main
$contagempf_funcao_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$contagempf_funcao_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var contagempf_funcao_edit = new ew_Page("contagempf_funcao_edit");
contagempf_funcao_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = contagempf_funcao_edit.PageID; // For backward compatibility

// Form object
var fcontagempf_funcaoedit = new ew_Form("fcontagempf_funcaoedit");

// Validate form
fcontagempf_funcaoedit.Validate = function() {
...
fcontagempf_funcaoedit.Form_CustomValidate = 
...
fcontagempf_funcaoedit.ValidateRequired = true;
<?php } else { ?>
fcontagempf_funcaoedit.ValidateRequired = false; 
<?php } ?>

// Multi-Page properties
fcontagempf_funcaoedit.MultiPage = new ew_MultiPage("fcontagempf_funcaoedit",
...
fcontagempf_funcaoedit.Lists["x_nu_contagem"] = {"LinkField":"x_nu_contagem","Ajax":true,"AutoFill":false,"DisplayFields":["x_nu_contagem","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fcontagempf_funcaoedit.Lists["x_nu_agrupador"] = {"LinkField":"x_nu_agrupador","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_agrupador","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fcontagempf_funcaoedit.Lists["x_nu_uc"] = {"LinkField":"x_nu_uc","Ajax":true,"AutoFill":false,"DisplayFields":["x_co_alternativo","x_no_uc","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fcontagempf_funcaoedit.Lists["x_nu_tpManutencao"] = {"LinkField":"x_nu_tpManutencao","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_tpManutencao","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fcontagempf_funcaoedit.Lists["x_nu_tpElemento"] = {"LinkField":"x_nu_tpElemento","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_tpElemento","","",""],"ParentFields":["x_nu_tpManutencao"],"FilterFields":["x_nu_tpManutencao"],"Options":[]};
...
<?php $contagempf_funcao_edit->ShowPageHeader(); ?>
<?php
$contagempf_funcao_edit->ShowMessage();
?>
<form name="fcontagempf_funcaoedit" id="fcontagempf_funcaoedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="contagempf_funcao">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table class="ewStdTable"><tbody><tr><td>
<div class="tabbable" id="contagempf_funcao_edit">
...
<table id="tbl_contagempf_funcaoedit1" class="table table-bordered table-striped">
...
<input type="hidden" data-field="x_nu_agrupador" name="x_nu_agrupador" id="x_nu_agrupador" value="<?php echo ew_HtmlEncode($contagempf_funcao->nu_agrupador->CurrentValue) ?>">
...
<script type="text/javascript">
fcontagempf_funcaoedit.Lists["x_nu_tpManutencao"].Options = <?php echo (is_array($contagempf_funcao->nu_tpManutencao->EditValue)) ? ew_ArrayToJson($contagempf_funcao->nu_tpManutencao->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fcontagempf_funcaoedit.Lists["x_nu_tpElemento"].Options = <?php echo (is_array($contagempf_funcao->nu_tpElemento->EditValue)) ? ew_ArrayToJson($contagempf_funcao->nu_tpElemento->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<input type="hidden" data-field="x_pc_varFasesRoteiro" name="x_pc_varFasesRoteiro" id="x_pc_varFasesRoteiro" value="<?php echo ew_HtmlEncode($contagempf_funcao->pc_varFasesRoteiro->CurrentValue) ?>">
...
<table cellspacing="0" class="ewGrid" style="width: 100%"><tr><td>
<table id="tbl_contagempf_funcaoedit2" class="table table-bordered table-striped">
<?php if ($contagempf_funcao->nu_contagem->Visible) { // nu_contagem ?>
	<tr id="r_nu_contagem">
		<td><span id="elh_contagempf_funcao_nu_contagem"><?php echo $contagempf_funcao->nu_contagem->FldCaption() ?></span></td>
		<td<?php echo $contagempf_funcao->nu_contagem->CellAttributes() ?>>
<span id="el_contagempf_funcao_nu_contagem" class="control-group">
<span<?php echo $contagempf_funcao->nu_contagem->ViewAttributes() ?>>
<?php echo $contagempf_funcao->nu_contagem->EditValue ?></span>
</span>
<input type="hidden" data-field="x_nu_contagem" name="x_nu_contagem" id="x_nu_contagem" value="<?php echo ew_HtmlEncode($contagempf_funcao->nu_contagem->CurrentValue) ?>">
...
<input type="hidden" data-field="x_nu_funcao" name="x_nu_funcao" id="x_nu_funcao" value="<?php echo ew_HtmlEncode($contagempf_funcao->nu_funcao->CurrentValue) ?>">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("EditBtn") ?></button>
</form>
<script type="text/javascript">
fcontagempf_funcaoedit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$contagempf_funcao_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$contagempf_funcao_edit->Page_Terminate();
?>
