...
$controleoperacional = NULL;

//
// Table class for controleoperacional
//
class ccontroleoperacional extends cTable {
	var $nu_prospecto;
	var $no_prospecto;
	var $vr_prioridade;
	var $nu_area;
	...
	function __construct() {
		...
		$this->TableVar = 'controleoperacional';
		$this->TableName = 'controleoperacional';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// nu_prospecto
		$this->nu_prospecto = new cField('controleoperacional', 'controleoperacional', 'x_nu_prospecto', 'nu_prospecto', '[nu_prospecto]', 'CAST([nu_prospecto] AS NVARCHAR)', 3, -1, FALSE, '[nu_prospecto]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->nu_prospecto->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['nu_prospecto'] = &$this->nu_prospecto;

		// no_prospecto
		$this->no_prospecto = new cField('controleoperacional', 'controleoperacional', 'x_no_prospecto', 'no_prospecto', '[no_prospecto]', '[no_prospecto]', 200, -1, FALSE, '[no_prospecto]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['no_prospecto'] = &$this->no_prospecto;

		// vr_prioridade
		$this->vr_prioridade = new cField('controleoperacional', 'controleoperacional', 'x_vr_prioridade', 'vr_prioridade', '[vr_prioridade]', 'CAST([vr_prioridade] AS NVARCHAR)', 131, -1, FALSE, '[vr_prioridade]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->vr_prioridade->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['vr_prioridade'] = &$this->vr_prioridade;

		// nu_area
		$this->nu_area = new cField('controleoperacional', 'controleoperacional', 'x_nu_area', 'nu_area', '[nu_area]', 'CAST([nu_area] AS NVARCHAR)', 3, -1, FALSE, '[nu_area]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->nu_area->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['nu_area'] = &$this->nu_area;

		// nu_categoriaProspecto
		$this->nu_categoriaProspecto = new cField('controleoperacional', 'controleoperacional', 'x_nu_categoriaProspecto', 'nu_categoriaProspecto', '[nu_categoriaProspecto]', 'CAST([nu_categoriaProspecto] AS NVARCHAR)', 3, -1, FALSE, '[nu_categoriaProspecto]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// ds_sistemas
		$this->ds_sistemas = new cField('controleoperacional', 'controleoperacional', 'x_ds_sistemas', 'ds_sistemas', '[ds_sistemas]', '[ds_sistemas]', 201, -1, FALSE, '[ds_sistemas]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['ds_sistemas'] = &$this->ds_sistemas;

		// nu_alternativaUrgencia
		$this->nu_alternativaUrgencia = new cField('controleoperacional', 'controleoperacional', 'x_nu_alternativaUrgencia', 'nu_alternativaUrgencia', '[nu_alternativaUrgencia]', 'CAST([nu_alternativaUrgencia] AS NVARCHAR)', 3, -1, FALSE, '[nu_alternativaUrgencia]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->nu_alternativaImpacto = new cField('controleoperacional', 'controleoperacional', 'x_nu_alternativaImpacto', 'nu_alternativaImpacto', '[nu_alternativaImpacto]', 'CAST([nu_alternativaImpacto] AS NVARCHAR)', 3, -1, FALSE, '[nu_alternativaImpacto]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->nu_alternativaAbrangencia = new cField('controleoperacional', 'controleoperacional', 'x_nu_alternativaAbrangencia', 'nu_alternativaAbrangencia', '[nu_alternativaAbrangencia]', 'CAST([nu_alternativaAbrangencia] AS NVARCHAR)', 3, -1, FALSE, '[nu_alternativaAbrangencia]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// dt_prazo
		$this->dt_prazo = new cField('controleoperacional', 'controleoperacional', 'x_dt_prazo', 'dt_prazo', '[dt_prazo]', '(REPLACE(STR(DAY([dt_prazo]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([dt_prazo]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([dt_prazo]),4,0))', 135, 7, FALSE, '[dt_prazo]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->dt_prazo->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['dt_prazo'] = &$this->dt_prazo;

		// ic_implicacaoLegal
		$this->ic_implicacaoLegal = new cField('controleoperacional', 'controleoperacional', 'x_ic_implicacaoLegal', 'ic_implicacaoLegal', '[ic_implicacaoLegal]', '[ic_implicacaoLegal]', 129, -1, FALSE, '[ic_implicacaoLegal]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['ic_implicacaoLegal'] = &$this->ic_implicacaoLegal;

		// ic_risco
		$this->ic_risco = new cField('controleoperacional', 'controleoperacional', 'x_ic_risco', 'ic_risco', '[ic_risco]', '[ic_risco]', 129, -1, FALSE, '[ic_risco]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['ic_risco'] = &$this->ic_risco;

		// nu_alternativaAlinhamento
		$this->nu_alternativaAlinhamento = new cField('controleoperacional', 'controleoperacional', 'x_nu_alternativaAlinhamento', 'nu_alternativaAlinhamento', '[nu_alternativaAlinhamento]', 'CAST([nu_alternativaAlinhamento] AS NVARCHAR)', 3, -1, FALSE, '[nu_alternativaAlinhamento]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->nu_alternativaTmpFila = new cField('controleoperacional', 'controleoperacional', 'x_nu_alternativaTmpFila', 'nu_alternativaTmpFila', '[nu_alternativaTmpFila]', 'CAST([nu_alternativaTmpFila] AS NVARCHAR)', 3, -1, FALSE, '[nu_alternativaTmpFila]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->nu_alternativaTmpEstimado = new cField('controleoperacional', 'controleoperacional', 'x_nu_alternativaTmpEstimado', 'nu_alternativaTmpEstimado', '[nu_alternativaTmpEstimado]', 'CAST([nu_alternativaTmpEstimado] AS NVARCHAR)', 3, -1, FALSE, '[nu_alternativaTmpEstimado]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// vr_impacto
		$this->vr_impacto = new cField('controleoperacional', 'controleoperacional', 'x_vr_impacto', 'vr_impacto', '[vr_impacto]', 'CAST([vr_impacto] AS NVARCHAR)', 131, -1, FALSE, '[vr_impacto]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->vr_impacto->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['vr_impacto'] = &$this->vr_impacto;

		// vr_alinhamento
		$this->vr_alinhamento = new cField('controleoperacional', 'controleoperacional', 'x_vr_alinhamento', 'vr_alinhamento', '[vr_alinhamento]', 'CAST([vr_alinhamento] AS NVARCHAR)', 131, -1, FALSE, '[vr_alinhamento]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->vr_alinhamento->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['vr_alinhamento'] = &$this->vr_alinhamento;

		// vr_abrangencia
		$this->vr_abrangencia = new cField('controleoperacional', 'controleoperacional', 'x_vr_abrangencia', 'vr_abrangencia', '[vr_abrangencia]', 'CAST([vr_abrangencia] AS NVARCHAR)', 131, -1, FALSE, '[vr_abrangencia]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->vr_abrangencia->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['vr_abrangencia'] = &$this->vr_abrangencia;

		// vr_urgencia
		$this->vr_urgencia = new cField('controleoperacional', 'controleoperacional', 'x_vr_urgencia', 'vr_urgencia', '[vr_urgencia]', 'CAST([vr_urgencia] AS NVARCHAR)', 131, -1, FALSE, '[vr_urgencia]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->vr_urgencia->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['vr_urgencia'] = &$this->vr_urgencia;

		// vr_duracao
		$this->vr_duracao = new cField('controleoperacional', 'controleoperacional', 'x_vr_duracao', 'vr_duracao', '[vr_duracao]', 'CAST([vr_duracao] AS NVARCHAR)', 131, -1, FALSE, '[vr_duracao]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->vr_duracao->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['vr_duracao'] = &$this->vr_duracao;

		// vr_tmpFila
		$this->vr_tmpFila = new cField('controleoperacional', 'controleoperacional', 'x_vr_tmpFila', 'vr_tmpFila', '[vr_tmpFila]', 'CAST([vr_tmpFila] AS NVARCHAR)', 131, -1, FALSE, '[vr_tmpFila]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->vr_tmpFila->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['vr_tmpFila'] = &$this->vr_tmpFila;

		// ic_stProspecto
		$this->ic_stProspecto = new cField('controleoperacional', 'controleoperacional', 'x_ic_stProspecto', 'ic_stProspecto', '[ic_stProspecto]', '[ic_stProspecto]', 129, -1, FALSE, '[ic_stProspecto]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['ic_stProspecto'] = &$this->ic_stProspecto;

		// ic_ativo
		$this->ic_ativo = new cField('controleoperacional', 'controleoperacional', 'x_ic_ativo', 'ic_ativo', '[ic_ativo]', '[ic_ativo]', 129, -1, FALSE, '[ic_ativo]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlFrom() { // From
		return "[db_owner].[controleoperacional]";
	}
	...
	// Update Table
	var $UpdateTable = "[db_owner].[controleoperacional]";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "controleoperacionallist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("controleoperacionalview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("controleoperacionalview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "controleoperacionaladd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("controleoperacionaledit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("controleoperacionaladd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("controleoperacionaldelete.php", $this->UrlParm());
	}
