...
$uc_delete = NULL; // Initialize page object first

class cuc_delete extends cuc {
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("uclist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in uc class, ucinfo.php
...
// Create page object
if (!isset($uc_delete)) $uc_delete = new cuc_delete();
...
$uc_delete->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var uc_delete = new ew_Page("uc_delete");
uc_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = uc_delete.PageID; // For backward compatibility

// Form object
var fucdelete = new ew_Form("fucdelete");

// Form_CustomValidate event
fucdelete.Form_CustomValidate = 
...
fucdelete.ValidateRequired = true;
<?php } else { ?>
fucdelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fucdelete.Lists["x_nu_stUc"] = {"LinkField":"x_nu_stUc","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_stUc","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
if ($uc_delete->Recordset = $uc_delete->LoadRecordset())
	$uc_deleteTotalRecs = $uc_delete->Recordset->RecordCount(); // Get record count
if ($uc_deleteTotalRecs <= 0) { // No record found, exit
	if ($uc_delete->Recordset)
		$uc_delete->Recordset->Close();
	$uc_delete->Page_Terminate("uclist.php"); // Return to list
}
?>
<?php $Breadcrumb->Render(); ?>
<?php $uc_delete->ShowPageHeader(); ?>
<?php
$uc_delete->ShowMessage();
?>
<form name="fucdelete" id="fucdelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="uc">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($uc_delete->RecKeys as $key) { ?>
<?php $keyvalue = is_array($key) ? implode($EW_COMPOSITE_KEY_SEPARATOR, $key) : $key; ?>
<input type="hidden" name="key_m[]" value="<?php echo ew_HtmlEncode($keyvalue) ?>">
<?php } ?>
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_ucdelete" class="ewTable ewTableSeparate">
<?php echo $uc->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
		<td><span id="elh_uc_co_alternativo" class="uc_co_alternativo"><?php echo $uc->co_alternativo->FldCaption() ?></span></td>
		<td><span id="elh_uc_no_uc" class="uc_no_uc"><?php echo $uc->no_uc->FldCaption() ?></span></td>
		<td><span id="elh_uc_nu_stUc" class="uc_nu_stUc"><?php echo $uc->nu_stUc->FldCaption() ?></span></td>
	</tr>
	</thead>
	<tbody>
<?php
$uc_delete->RecCnt = 0;
$i = 0;
while (!$uc_delete->Recordset->EOF) {
	$uc_delete->RecCnt++;
	$uc_delete->RowCnt++;

	// Set row properties
	$uc->ResetAttrs();
	$uc->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$uc_delete->LoadRowValues($uc_delete->Recordset);
...
<span id="el<?php echo $uc_delete->RowCnt ?>_uc_co_alternativo" class="control-group uc_co_alternativo">
...
<span id="el<?php echo $uc_delete->RowCnt ?>_uc_no_uc" class="control-group uc_no_uc">
<span<?php echo $uc->no_uc->ViewAttributes() ?>>
<?php echo $uc->no_uc->ListViewValue() ?></span>
</span>
</td>
		<td<?php echo $uc->nu_stUc->CellAttributes() ?>>
<span id="el<?php echo $uc_delete->RowCnt ?>_uc_nu_stUc" class="control-group uc_nu_stUc">
