...
$necstake_view = NULL; // Initialize page object first

class cnecstake_view extends cnecstake {
	...
	function __construct() {
		...
		if (@$_GET["nu_necessidade"] <> "") {
			$this->RecKey["nu_necessidade"] = $_GET["nu_necessidade"];
			$KeyUrl .= "&nu_necessidade=" . urlencode($this->RecKey["nu_necessidade"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["nu_necessidade"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["nu_necessidade"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["nu_necessidade"] <> "") {
				...
				$this->RecKey["nu_necessidade"] = $this->nu_necessidade->QueryStringValue;
			} else {
				$sReturnUrl = "necstakelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "necstakelist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "necstakelist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_necstake\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_necstake',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fnecstakeview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($necstake_view)) $necstake_view = new cnecstake_view();

// Page init
$necstake_view->Page_Init();

// Page main
$necstake_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$necstake_view->Page_Render();
?>
...
// Page object
var necstake_view = new ew_Page("necstake_view");
necstake_view.PageID = "view"; // Page ID
var EW_PAGE_ID = necstake_view.PageID; // For backward compatibility

// Form object
var fnecstakeview = new ew_Form("fnecstakeview");

// Form_CustomValidate event
fnecstakeview.Form_CustomValidate = 
...
fnecstakeview.ValidateRequired = true;
<?php } else { ?>
fnecstakeview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fnecstakeview.Lists["x_nu_periodoPei"] = {"LinkField":"x_nu_periodoPei","Ajax":null,"AutoFill":false,"DisplayFields":["x_nu_anoInicio","x_nu_anoFim","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fnecstakeview.Lists["x_nu_motivador"] = {"LinkField":"x_nu_motivador","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_motivador","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $necstake_view->ExportOptions->Render("body") ?>
<?php if (!$necstake_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($necstake_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $necstake_view->ShowPageHeader(); ?>
<?php
$necstake_view->ShowMessage();
?>
<form name="fnecstakeview" id="fnecstakeview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="necstake">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_necstakeview" class="table table-bordered table-striped">
<?php if ($necstake->nu_periodoPei->Visible) { // nu_periodoPei ?>
	<tr id="r_nu_periodoPei">
		<td><span id="elh_necstake_nu_periodoPei"><?php echo $necstake->nu_periodoPei->FldCaption() ?></span></td>
...
<?php if ($necstake->nu_motivador->Visible) { // nu_motivador ?>
	<tr id="r_nu_motivador">
		<td><span id="elh_necstake_nu_motivador"><?php echo $necstake->nu_motivador->FldCaption() ?></span></td>
...
<span<?php echo $necstake->ds_necessidade->ViewAttributes() ?>>
<?php echo $necstake->ds_necessidade->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($necstake->ic_situacao->Visible) { // ic_situacao ?>
	<tr id="r_ic_situacao">
		<td><span id="elh_necstake_ic_situacao"><?php echo $necstake->ic_situacao->FldCaption() ?></span></td>
