...
$solicitacao_uc_view = NULL; // Initialize page object first

class csolicitacao_uc_view extends csolicitacao_uc {
	...
	// Page object name
	var $PageObjName = 'solicitacao_uc_view';
	...
	function Page_Init() {
		...
		if (@$_GET["nu_uc"] <> "") {
			if ($gsExportFile <> "") $gsExportFile .= "_";
			$gsExportFile .= ew_StripSlashes($_GET["nu_uc"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["nu_solicitacao"] <> "") {
				...
				$sReturnUrl = "solicitacao_uclist.php"; // Return to list
			}
			if (@$_GET["nu_uc"] <> "") {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "solicitacao_uclist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "solicitacao_uclist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_solicitacao_uc\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_solicitacao_uc',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fsolicitacao_ucview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($solicitacao_uc_view)) $solicitacao_uc_view = new csolicitacao_uc_view();

// Page init
$solicitacao_uc_view->Page_Init();

// Page main
$solicitacao_uc_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$solicitacao_uc_view->Page_Render();
?>
...
// Page object
var solicitacao_uc_view = new ew_Page("solicitacao_uc_view");
solicitacao_uc_view.PageID = "view"; // Page ID
var EW_PAGE_ID = solicitacao_uc_view.PageID; // For backward compatibility

// Form object
var fsolicitacao_ucview = new ew_Form("fsolicitacao_ucview");

// Form_CustomValidate event
fsolicitacao_ucview.Form_CustomValidate = 
...
fsolicitacao_ucview.ValidateRequired = true;
<?php } else { ?>
fsolicitacao_ucview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fsolicitacao_ucview.Lists["x_nu_sistema"] = {"LinkField":"x_nu_sistema","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_alternativo","x_no_sistema","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fsolicitacao_ucview.Lists["x_nu_uc"] = {"LinkField":"x_nu_uc","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_alternativo","x_no_uc","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $solicitacao_uc_view->ExportOptions->Render("body") ?>
<?php if (!$solicitacao_uc_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($solicitacao_uc_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $solicitacao_uc_view->ShowPageHeader(); ?>
<?php
$solicitacao_uc_view->ShowMessage();
?>
<form name="fsolicitacao_ucview" id="fsolicitacao_ucview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="solicitacao_uc">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_solicitacao_ucview" class="table table-bordered table-striped">
<?php if ($solicitacao_uc->nu_sistema->Visible) { // nu_sistema ?>
	<tr id="r_nu_sistema">
		<td><span id="elh_solicitacao_uc_nu_sistema"><?php echo $solicitacao_uc->nu_sistema->FldCaption() ?></span></td>
...
<?php if ($solicitacao_uc->nu_uc->Visible) { // nu_uc ?>
	<tr id="r_nu_uc">
		<td><span id="elh_solicitacao_uc_nu_uc"><?php echo $solicitacao_uc->nu_uc->FldCaption() ?></span></td>
...
<script type="text/javascript">
fsolicitacao_ucview.Init();
</script>
<?php
$solicitacao_uc_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($solicitacao_uc->Export == "") { ?>
...
<?php
$solicitacao_uc_view->Page_Terminate();
?>
