...
// Form object
var fareadelete = new ew_Form("fareadelete");
...
fareadelete.ValidateRequired = true;
<?php } else { ?>
fareadelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fareadelete.Lists["x_nu_tpArea"] = {"LinkField":"x_nu_tpArea","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_tpArea","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fareadelete.Lists["x_nu_pessoaResp"] = {"LinkField":"x_nu_pessoa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_pessoa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="fareadelete" id="fareadelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<table id="tbl_areadelete" class="ewTable ewTableSeparate">
<?php echo $area->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
		<td><span id="elh_area_no_area" class="area_no_area"><?php echo $area->no_area->FldCaption() ?></span></td>
		<td><span id="elh_area_nu_tpArea" class="area_nu_tpArea"><?php echo $area->nu_tpArea->FldCaption() ?></span></td>
		<td><span id="elh_area_nu_pessoaResp" class="area_nu_pessoaResp"><?php echo $area->nu_pessoaResp->FldCaption() ?></span></td>
		<td><span id="elh_area_ic_ativo" class="area_ic_ativo"><?php echo $area->ic_ativo->FldCaption() ?></span></td>
	</tr>
	</thead>
	<tbody>
<?php
...
<span id="el<?php echo $area_delete->RowCnt ?>_area_no_area" class="control-group area_no_area">
...
<span id="el<?php echo $area_delete->RowCnt ?>_area_nu_tpArea" class="control-group area_nu_tpArea">
...
<span id="el<?php echo $area_delete->RowCnt ?>_area_nu_pessoaResp" class="control-group area_nu_pessoaResp">
...
<span id="el<?php echo $area_delete->RowCnt ?>_area_ic_ativo" class="control-group area_ic_ativo">
