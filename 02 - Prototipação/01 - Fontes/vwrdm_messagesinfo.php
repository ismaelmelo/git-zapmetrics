...
//
// Table class for vwrdm_messages
//
class cvwrdm_messages extends cTable {
	var $id;
	var $board_id;
	var $parent_id;
	var $subject;
	...
	function __construct() {
		...
		$this->TableVar = 'vwrdm_messages';
		$this->TableName = 'vwrdm_messages';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('vwrdm_messages', 'vwrdm_messages', 'x_id', 'id', '[id]', 'CAST([id] AS NVARCHAR)', 3, -1, FALSE, '[id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// board_id
		$this->board_id = new cField('vwrdm_messages', 'vwrdm_messages', 'x_board_id', 'board_id', '[board_id]', 'CAST([board_id] AS NVARCHAR)', 3, -1, FALSE, '[board_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->board_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['board_id'] = &$this->board_id;

		// parent_id
		$this->parent_id = new cField('vwrdm_messages', 'vwrdm_messages', 'x_parent_id', 'parent_id', '[parent_id]', 'CAST([parent_id] AS NVARCHAR)', 3, -1, FALSE, '[parent_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->parent_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['parent_id'] = &$this->parent_id;

		// subject
		$this->subject = new cField('vwrdm_messages', 'vwrdm_messages', 'x_subject', 'subject', '[subject]', '[subject]', 202, -1, FALSE, '[subject]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['subject'] = &$this->subject;

		// content
		$this->content = new cField('vwrdm_messages', 'vwrdm_messages', 'x_content', 'content', '[content]', '[content]', 203, -1, FALSE, '[content]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['content'] = &$this->content;

		// author_id
		$this->author_id = new cField('vwrdm_messages', 'vwrdm_messages', 'x_author_id', 'author_id', '[author_id]', 'CAST([author_id] AS NVARCHAR)', 3, -1, FALSE, '[author_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->author_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['author_id'] = &$this->author_id;

		// replies_count
		$this->replies_count = new cField('vwrdm_messages', 'vwrdm_messages', 'x_replies_count', 'replies_count', '[replies_count]', 'CAST([replies_count] AS NVARCHAR)', 3, -1, FALSE, '[replies_count]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->replies_count->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['replies_count'] = &$this->replies_count;

		// last_reply_id
		$this->last_reply_id = new cField('vwrdm_messages', 'vwrdm_messages', 'x_last_reply_id', 'last_reply_id', '[last_reply_id]', 'CAST([last_reply_id] AS NVARCHAR)', 3, -1, FALSE, '[last_reply_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->last_reply_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['last_reply_id'] = &$this->last_reply_id;

		// created_on
		$this->created_on = new cField('vwrdm_messages', 'vwrdm_messages', 'x_created_on', 'created_on', '[created_on]', '(REPLACE(STR(DAY([created_on]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([created_on]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([created_on]),4,0))', 135, 7, FALSE, '[created_on]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->created_on->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['created_on'] = &$this->created_on;

		// updated_on
		$this->updated_on = new cField('vwrdm_messages', 'vwrdm_messages', 'x_updated_on', 'updated_on', '[updated_on]', '(REPLACE(STR(DAY([updated_on]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([updated_on]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([updated_on]),4,0))', 135, 7, FALSE, '[updated_on]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->updated_on->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['updated_on'] = &$this->updated_on;

		// locked
		$this->locked = new cField('vwrdm_messages', 'vwrdm_messages', 'x_locked', 'locked', '[locked]', 'CAST([locked] AS NVARCHAR)', 131, -1, FALSE, '[locked]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->locked->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['locked'] = &$this->locked;

		// sticky
		$this->sticky = new cField('vwrdm_messages', 'vwrdm_messages', 'x_sticky', 'sticky', '[sticky]', 'CAST([sticky] AS NVARCHAR)', 3, -1, FALSE, '[sticky]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->sticky->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['sticky'] = &$this->sticky;
	}
	...
	function SqlFrom() { // From
		return "[db_owner].[vwrdm_messages]";
	}
	...
	// Update Table
	var $UpdateTable = "[db_owner].[vwrdm_messages]";
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("vwrdm_messagesview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("vwrdm_messagesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "vwrdm_messagesadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("vwrdm_messagesedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("vwrdm_messagesadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("vwrdm_messagesdelete.php", $this->UrlParm());
	}
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				if ($this->board_id->Exportable) $Doc->ExportCaption($this->board_id);
				...
				if ($this->replies_count->Exportable) $Doc->ExportCaption($this->replies_count);
				if ($this->last_reply_id->Exportable) $Doc->ExportCaption($this->last_reply_id);
				...
				if ($this->sticky->Exportable) $Doc->ExportCaption($this->sticky);
			} else {
				if ($this->id->Exportable) $Doc->ExportCaption($this->id);
				if ($this->board_id->Exportable) $Doc->ExportCaption($this->board_id);
				if ($this->parent_id->Exportable) $Doc->ExportCaption($this->parent_id);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					if ($this->board_id->Exportable) $Doc->ExportField($this->board_id);
					...
					if ($this->replies_count->Exportable) $Doc->ExportField($this->replies_count);
					if ($this->last_reply_id->Exportable) $Doc->ExportField($this->last_reply_id);
					...
					if ($this->sticky->Exportable) $Doc->ExportField($this->sticky);
				} else {
					if ($this->id->Exportable) $Doc->ExportField($this->id);
					if ($this->board_id->Exportable) $Doc->ExportField($this->board_id);
					if ($this->parent_id->Exportable) $Doc->ExportField($this->parent_id);
