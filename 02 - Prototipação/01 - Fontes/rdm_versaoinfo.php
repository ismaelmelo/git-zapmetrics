...
//
// Table class for rdm_versao
//
class crdm_versao extends cTable {
	var $id;
	var $project_id;
	var $name;
	var $description;
	...
	function __construct() {
		...
		$this->TableVar = 'rdm_versao';
		$this->TableName = 'rdm_versao';
		...
		// id
		$this->id = new cField('rdm_versao', 'rdm_versao', 'x_id', 'id', '[id]', 'CAST([id] AS NVARCHAR)', 3, -1, FALSE, '[id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// project_id
		$this->project_id = new cField('rdm_versao', 'rdm_versao', 'x_project_id', 'project_id', '[project_id]', 'CAST([project_id] AS NVARCHAR)', 3, -1, FALSE, '[project_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->project_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['project_id'] = &$this->project_id;

		// name
		$this->name = new cField('rdm_versao', 'rdm_versao', 'x_name', 'name', '[name]', '[name]', 200, -1, FALSE, '[name]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['name'] = &$this->name;

		// description
		$this->description = new cField('rdm_versao', 'rdm_versao', 'x_description', 'description', '[description]', '[description]', 201, -1, FALSE, '[description]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['description'] = &$this->description;

		// status
		$this->status = new cField('rdm_versao', 'rdm_versao', 'x_status', 'status', '[status]', '[status]', 200, -1, FALSE, '[status]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['status'] = &$this->status;

		// created_on
		$this->created_on = new cField('rdm_versao', 'rdm_versao', 'x_created_on', 'created_on', '[created_on]', 'CAST([created_on] AS NVARCHAR)', 3, 17, FALSE, '[created_on]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->created_on->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['created_on'] = &$this->created_on;

		// updated_on
		$this->updated_on = new cField('rdm_versao', 'rdm_versao', 'x_updated_on', 'updated_on', '[updated_on]', 'CAST([updated_on] AS NVARCHAR)', 3, 17, FALSE, '[updated_on]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "[dbo].[rdm_versao]";
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("rdm_versaoview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("rdm_versaoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "rdm_versaoadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("rdm_versaoedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("rdm_versaoadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("rdm_versaodelete.php", $this->UrlParm());
	}
