...
$tbrdm_versions_view = NULL; // Initialize page object first

class ctbrdm_versions_view extends ctbrdm_versions {
	...
	// Page object name
	var $PageObjName = 'tbrdm_versions_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "tbrdm_versionslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tbrdm_versionslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "tbrdm_versionslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_tbrdm_versions\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_tbrdm_versions',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.ftbrdm_versionsview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($tbrdm_versions_view)) $tbrdm_versions_view = new ctbrdm_versions_view();

// Page init
$tbrdm_versions_view->Page_Init();

// Page main
$tbrdm_versions_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbrdm_versions_view->Page_Render();
?>
...
// Page object
var tbrdm_versions_view = new ew_Page("tbrdm_versions_view");
tbrdm_versions_view.PageID = "view"; // Page ID
var EW_PAGE_ID = tbrdm_versions_view.PageID; // For backward compatibility

// Form object
var ftbrdm_versionsview = new ew_Form("ftbrdm_versionsview");

// Form_CustomValidate event
ftbrdm_versionsview.Form_CustomValidate = 
...
ftbrdm_versionsview.ValidateRequired = true;
<?php } else { ?>
ftbrdm_versionsview.ValidateRequired = false; 
<?php } ?>
...
<?php $tbrdm_versions_view->ExportOptions->Render("body") ?>
<?php if (!$tbrdm_versions_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($tbrdm_versions_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $tbrdm_versions_view->ShowPageHeader(); ?>
<?php
$tbrdm_versions_view->ShowMessage();
?>
<form name="ftbrdm_versionsview" id="ftbrdm_versionsview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="tbrdm_versions">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_tbrdm_versionsview" class="table table-bordered table-striped">
<?php if ($tbrdm_versions->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_tbrdm_versions_id"><?php echo $tbrdm_versions->id->FldCaption() ?></span></td>
...
<?php echo $tbrdm_versions->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_versions->project_id->Visible) { // project_id ?>
	<tr id="r_project_id">
		<td><span id="elh_tbrdm_versions_project_id"><?php echo $tbrdm_versions->project_id->FldCaption() ?></span></td>
...
<?php echo $tbrdm_versions->project_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_versions->name->Visible) { // name ?>
	<tr id="r_name">
		<td><span id="elh_tbrdm_versions_name"><?php echo $tbrdm_versions->name->FldCaption() ?></span></td>
...
<?php echo $tbrdm_versions->name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_versions->description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_versions->effective_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_versions->created_on->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_versions->updated_on->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_versions->wiki_page_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_versions->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_versions->sharing->Visible) { // sharing ?>
	<tr id="r_sharing">
		<td><span id="elh_tbrdm_versions_sharing"><?php echo $tbrdm_versions->sharing->FldCaption() ?></span></td>
...
<?php echo $tbrdm_versions->sharing->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ftbrdm_versionsview.Init();
</script>
<?php
$tbrdm_versions_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($tbrdm_versions->Export == "") { ?>
...
<?php
$tbrdm_versions_view->Page_Terminate();
?>
