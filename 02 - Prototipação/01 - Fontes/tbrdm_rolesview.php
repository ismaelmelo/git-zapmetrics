...
$tbrdm_roles_view = NULL; // Initialize page object first

class ctbrdm_roles_view extends ctbrdm_roles {
	...
	// Page object name
	var $PageObjName = 'tbrdm_roles_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "tbrdm_roleslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tbrdm_roleslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "tbrdm_roleslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_tbrdm_roles\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_tbrdm_roles',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.ftbrdm_rolesview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($tbrdm_roles_view)) $tbrdm_roles_view = new ctbrdm_roles_view();

// Page init
$tbrdm_roles_view->Page_Init();

// Page main
$tbrdm_roles_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbrdm_roles_view->Page_Render();
?>
...
// Page object
var tbrdm_roles_view = new ew_Page("tbrdm_roles_view");
tbrdm_roles_view.PageID = "view"; // Page ID
var EW_PAGE_ID = tbrdm_roles_view.PageID; // For backward compatibility

// Form object
var ftbrdm_rolesview = new ew_Form("ftbrdm_rolesview");

// Form_CustomValidate event
ftbrdm_rolesview.Form_CustomValidate = 
...
ftbrdm_rolesview.ValidateRequired = true;
<?php } else { ?>
ftbrdm_rolesview.ValidateRequired = false; 
<?php } ?>
...
<?php $tbrdm_roles_view->ExportOptions->Render("body") ?>
<?php if (!$tbrdm_roles_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($tbrdm_roles_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $tbrdm_roles_view->ShowPageHeader(); ?>
<?php
$tbrdm_roles_view->ShowMessage();
?>
<form name="ftbrdm_rolesview" id="ftbrdm_rolesview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="tbrdm_roles">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_tbrdm_rolesview" class="table table-bordered table-striped">
<?php if ($tbrdm_roles->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_tbrdm_roles_id"><?php echo $tbrdm_roles->id->FldCaption() ?></span></td>
...
<?php echo $tbrdm_roles->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_roles->name->Visible) { // name ?>
	<tr id="r_name">
		<td><span id="elh_tbrdm_roles_name"><?php echo $tbrdm_roles->name->FldCaption() ?></span></td>
...
<?php echo $tbrdm_roles->name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_roles->position->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_roles->assignable->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_roles->builtin->Visible) { // builtin ?>
	<tr id="r_builtin">
		<td><span id="elh_tbrdm_roles_builtin"><?php echo $tbrdm_roles->builtin->FldCaption() ?></span></td>
...
<?php echo $tbrdm_roles->builtin->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $tbrdm_roles->permissions->ViewAttributes() ?>>
<?php echo $tbrdm_roles->permissions->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_roles->issues_visibility->Visible) { // issues_visibility ?>
	<tr id="r_issues_visibility">
		<td><span id="elh_tbrdm_roles_issues_visibility"><?php echo $tbrdm_roles->issues_visibility->FldCaption() ?></span></td>
...
<?php echo $tbrdm_roles->issues_visibility->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ftbrdm_rolesview.Init();
</script>
<?php
$tbrdm_roles_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($tbrdm_roles->Export == "") { ?>
...
<?php
$tbrdm_roles_view->Page_Terminate();
?>
