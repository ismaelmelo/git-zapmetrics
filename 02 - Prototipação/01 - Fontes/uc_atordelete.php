...
$uc_ator_delete = NULL; // Initialize page object first

class cuc_ator_delete extends cuc_ator {
	...
	// Page object name
	var $PageObjName = 'uc_ator_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("uc_atorlist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in uc_ator class, uc_atorinfo.php
...
// Create page object
if (!isset($uc_ator_delete)) $uc_ator_delete = new cuc_ator_delete();

// Page init
$uc_ator_delete->Page_Init();

// Page main
$uc_ator_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$uc_ator_delete->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var uc_ator_delete = new ew_Page("uc_ator_delete");
uc_ator_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = uc_ator_delete.PageID; // For backward compatibility

// Form object
var fuc_atordelete = new ew_Form("fuc_atordelete");

// Form_CustomValidate event
fuc_atordelete.Form_CustomValidate = 
...
fuc_atordelete.ValidateRequired = true;
<?php } else { ?>
fuc_atordelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fuc_atordelete.Lists["x_nu_ator"] = {"LinkField":"x_nu_ator","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_ator","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
if ($uc_ator_delete->Recordset = $uc_ator_delete->LoadRecordset())
	$uc_ator_deleteTotalRecs = $uc_ator_delete->Recordset->RecordCount(); // Get record count
if ($uc_ator_deleteTotalRecs <= 0) { // No record found, exit
	if ($uc_ator_delete->Recordset)
		$uc_ator_delete->Recordset->Close();
	$uc_ator_delete->Page_Terminate("uc_atorlist.php"); // Return to list
}
?>
<?php $Breadcrumb->Render(); ?>
<?php $uc_ator_delete->ShowPageHeader(); ?>
<?php
$uc_ator_delete->ShowMessage();
?>
<form name="fuc_atordelete" id="fuc_atordelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="uc_ator">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($uc_ator_delete->RecKeys as $key) { ?>
<?php $keyvalue = is_array($key) ? implode($EW_COMPOSITE_KEY_SEPARATOR, $key) : $key; ?>
<input type="hidden" name="key_m[]" value="<?php echo ew_HtmlEncode($keyvalue) ?>">
<?php } ?>
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_uc_atordelete" class="ewTable ewTableSeparate">
<?php echo $uc_ator->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
		<td><span id="elh_uc_ator_nu_ator" class="uc_ator_nu_ator"><?php echo $uc_ator->nu_ator->FldCaption() ?></span></td>
	</tr>
	</thead>
	<tbody>
<?php
$uc_ator_delete->RecCnt = 0;
$i = 0;
while (!$uc_ator_delete->Recordset->EOF) {
	$uc_ator_delete->RecCnt++;
	$uc_ator_delete->RowCnt++;

	// Set row properties
	$uc_ator->ResetAttrs();
	$uc_ator->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$uc_ator_delete->LoadRowValues($uc_ator_delete->Recordset);

	// Render row
	$uc_ator_delete->RenderRow();
?>
	<tr<?php echo $uc_ator->RowAttributes() ?>>
		<td<?php echo $uc_ator->nu_ator->CellAttributes() ?>>
<span id="el<?php echo $uc_ator_delete->RowCnt ?>_uc_ator_nu_ator" class="control-group uc_ator_nu_ator">
...
<?php
	$uc_ator_delete->Recordset->MoveNext();
}
$uc_ator_delete->Recordset->Close();
?>
</tbody>
