...
$tbrdm_users_view = NULL; // Initialize page object first

class ctbrdm_users_view extends ctbrdm_users {
	...
	// Page object name
	var $PageObjName = 'tbrdm_users_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "tbrdm_userslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tbrdm_userslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "tbrdm_userslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_tbrdm_users\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_tbrdm_users',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.ftbrdm_usersview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($tbrdm_users_view)) $tbrdm_users_view = new ctbrdm_users_view();

// Page init
$tbrdm_users_view->Page_Init();

// Page main
$tbrdm_users_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbrdm_users_view->Page_Render();
?>
...
// Page object
var tbrdm_users_view = new ew_Page("tbrdm_users_view");
tbrdm_users_view.PageID = "view"; // Page ID
var EW_PAGE_ID = tbrdm_users_view.PageID; // For backward compatibility

// Form object
var ftbrdm_usersview = new ew_Form("ftbrdm_usersview");

// Form_CustomValidate event
ftbrdm_usersview.Form_CustomValidate = 
...
ftbrdm_usersview.ValidateRequired = true;
<?php } else { ?>
ftbrdm_usersview.ValidateRequired = false; 
<?php } ?>
...
<?php $tbrdm_users_view->ExportOptions->Render("body") ?>
<?php if (!$tbrdm_users_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($tbrdm_users_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $tbrdm_users_view->ShowPageHeader(); ?>
<?php
$tbrdm_users_view->ShowMessage();
?>
<form name="ftbrdm_usersview" id="ftbrdm_usersview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="tbrdm_users">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_tbrdm_usersview" class="table table-bordered table-striped">
<?php if ($tbrdm_users->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_tbrdm_users_id"><?php echo $tbrdm_users->id->FldCaption() ?></span></td>
...
<?php echo $tbrdm_users->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_users->_login->Visible) { // login ?>
	<tr id="r__login">
		<td><span id="elh_tbrdm_users__login"><?php echo $tbrdm_users->_login->FldCaption() ?></span></td>
...
<?php echo $tbrdm_users->_login->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_users->mail->Visible) { // mail ?>
	<tr id="r_mail">
		<td><span id="elh_tbrdm_users_mail"><?php echo $tbrdm_users->mail->FldCaption() ?></span></td>
...
<?php echo $tbrdm_users->mail->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_users->admin->Visible) { // admin ?>
	<tr id="r_admin">
		<td><span id="elh_tbrdm_users_admin"><?php echo $tbrdm_users->admin->FldCaption() ?></span></td>
...
<?php echo $tbrdm_users->admin->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_users->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_tbrdm_users_status"><?php echo $tbrdm_users->status->FldCaption() ?></span></td>
...
<?php echo $tbrdm_users->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_users->last_login_on->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_users->_language->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_users->created_on->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_users->updated_on->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_users->type->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_users->identity_url->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_users->mail_notification->Visible) { // mail_notification ?>
	<tr id="r_mail_notification">
		<td><span id="elh_tbrdm_users_mail_notification"><?php echo $tbrdm_users->mail_notification->FldCaption() ?></span></td>
...
<?php echo $tbrdm_users->mail_notification->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_users->name->Visible) { // name ?>
	<tr id="r_name">
		<td><span id="elh_tbrdm_users_name"><?php echo $tbrdm_users->name->FldCaption() ?></span></td>
...
<?php echo $tbrdm_users->name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ftbrdm_usersview.Init();
</script>
<?php
$tbrdm_users_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($tbrdm_users->Export == "") { ?>
...
<?php
$tbrdm_users_view->Page_Terminate();
?>
