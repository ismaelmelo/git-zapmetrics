...
//
// Table class for tbrdm_users
//
class ctbrdm_users extends cTable {
	var $id;
	var $_login;
	var $mail;
	var $admin;
	...
	function __construct() {
		...
		$this->TableVar = 'tbrdm_users';
		$this->TableName = 'tbrdm_users';
		...
		// id
		$this->id = new cField('tbrdm_users', 'tbrdm_users', 'x_id', 'id', '[id]', 'CAST([id] AS NVARCHAR)', 3, -1, FALSE, '[id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// login
		$this->_login = new cField('tbrdm_users', 'tbrdm_users', 'x__login', 'login', '[login]', '[login]', 200, -1, FALSE, '[login]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['login'] = &$this->_login;

		// mail
		$this->mail = new cField('tbrdm_users', 'tbrdm_users', 'x_mail', 'mail', '[mail]', '[mail]', 200, -1, FALSE, '[mail]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['mail'] = &$this->mail;

		// admin
		$this->admin = new cField('tbrdm_users', 'tbrdm_users', 'x_admin', 'admin', '[admin]', 'CAST([admin] AS NVARCHAR)', 3, -1, FALSE, '[admin]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->admin->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['admin'] = &$this->admin;

		// status
		$this->status = new cField('tbrdm_users', 'tbrdm_users', 'x_status', 'status', '[status]', 'CAST([status] AS NVARCHAR)', 3, -1, FALSE, '[status]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->status->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['status'] = &$this->status;

		// last_login_on
		$this->last_login_on = new cField('tbrdm_users', 'tbrdm_users', 'x_last_login_on', 'last_login_on', '[last_login_on]', '(REPLACE(STR(DAY([last_login_on]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([last_login_on]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([last_login_on]),4,0))', 135, 7, FALSE, '[last_login_on]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// language
		$this->_language = new cField('tbrdm_users', 'tbrdm_users', 'x__language', 'language', '[language]', '[language]', 200, -1, FALSE, '[language]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['language'] = &$this->_language;

		// created_on
		$this->created_on = new cField('tbrdm_users', 'tbrdm_users', 'x_created_on', 'created_on', '[created_on]', '(REPLACE(STR(DAY([created_on]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([created_on]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([created_on]),4,0))', 135, 7, FALSE, '[created_on]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->created_on->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['created_on'] = &$this->created_on;

		// updated_on
		$this->updated_on = new cField('tbrdm_users', 'tbrdm_users', 'x_updated_on', 'updated_on', '[updated_on]', '(REPLACE(STR(DAY([updated_on]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([updated_on]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([updated_on]),4,0))', 135, 7, FALSE, '[updated_on]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->updated_on->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['updated_on'] = &$this->updated_on;

		// type
		$this->type = new cField('tbrdm_users', 'tbrdm_users', 'x_type', 'type', '[type]', '[type]', 200, -1, FALSE, '[type]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['type'] = &$this->type;

		// identity_url
		$this->identity_url = new cField('tbrdm_users', 'tbrdm_users', 'x_identity_url', 'identity_url', '[identity_url]', '[identity_url]', 200, -1, FALSE, '[identity_url]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['identity_url'] = &$this->identity_url;

		// mail_notification
		$this->mail_notification = new cField('tbrdm_users', 'tbrdm_users', 'x_mail_notification', 'mail_notification', '[mail_notification]', '[mail_notification]', 200, -1, FALSE, '[mail_notification]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['mail_notification'] = &$this->mail_notification;

		// name
		$this->name = new cField('tbrdm_users', 'tbrdm_users', 'x_name', 'name', '[name]', '[name]', 200, -1, FALSE, '[name]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "[dbo].[tbrdm_users]";
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("tbrdm_usersview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("tbrdm_usersview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "tbrdm_usersadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("tbrdm_usersedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("tbrdm_usersadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tbrdm_usersdelete.php", $this->UrlParm());
	}
