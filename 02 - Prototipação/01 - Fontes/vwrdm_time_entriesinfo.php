...
$vwrdm_time_entries = NULL;

//
// Table class for vwrdm_time_entries
//
class cvwrdm_time_entries extends cTable {
	var $id;
	var $project_id;
	var $user_id;
	var $issue_id;
	...
	function __construct() {
		...
		$this->TableVar = 'vwrdm_time_entries';
		$this->TableName = 'vwrdm_time_entries';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('vwrdm_time_entries', 'vwrdm_time_entries', 'x_id', 'id', '[id]', 'CAST([id] AS NVARCHAR)', 3, -1, FALSE, '[id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// project_id
		$this->project_id = new cField('vwrdm_time_entries', 'vwrdm_time_entries', 'x_project_id', 'project_id', '[project_id]', 'CAST([project_id] AS NVARCHAR)', 3, -1, FALSE, '[project_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->project_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['project_id'] = &$this->project_id;

		// user_id
		$this->user_id = new cField('vwrdm_time_entries', 'vwrdm_time_entries', 'x_user_id', 'user_id', '[user_id]', 'CAST([user_id] AS NVARCHAR)', 3, -1, FALSE, '[user_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->user_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['user_id'] = &$this->user_id;

		// issue_id
		$this->issue_id = new cField('vwrdm_time_entries', 'vwrdm_time_entries', 'x_issue_id', 'issue_id', '[issue_id]', 'CAST([issue_id] AS NVARCHAR)', 3, -1, FALSE, '[issue_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->issue_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['issue_id'] = &$this->issue_id;

		// hours
		$this->hours = new cField('vwrdm_time_entries', 'vwrdm_time_entries', 'x_hours', 'hours', '[hours]', 'CAST([hours] AS NVARCHAR)', 4, -1, FALSE, '[hours]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->hours->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['hours'] = &$this->hours;

		// comments
		$this->comments = new cField('vwrdm_time_entries', 'vwrdm_time_entries', 'x_comments', 'comments', '[comments]', '[comments]', 202, -1, FALSE, '[comments]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['comments'] = &$this->comments;

		// activity_id
		$this->activity_id = new cField('vwrdm_time_entries', 'vwrdm_time_entries', 'x_activity_id', 'activity_id', '[activity_id]', 'CAST([activity_id] AS NVARCHAR)', 3, -1, FALSE, '[activity_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->activity_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['activity_id'] = &$this->activity_id;

		// spent_on
		$this->spent_on = new cField('vwrdm_time_entries', 'vwrdm_time_entries', 'x_spent_on', 'spent_on', '[spent_on]', '(REPLACE(STR(DAY([spent_on]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([spent_on]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([spent_on]),4,0))', 133, 7, FALSE, '[spent_on]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->spent_on->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['spent_on'] = &$this->spent_on;

		// tyear
		$this->tyear = new cField('vwrdm_time_entries', 'vwrdm_time_entries', 'x_tyear', 'tyear', '[tyear]', 'CAST([tyear] AS NVARCHAR)', 3, -1, FALSE, '[tyear]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->tyear->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['tyear'] = &$this->tyear;

		// tmonth
		$this->tmonth = new cField('vwrdm_time_entries', 'vwrdm_time_entries', 'x_tmonth', 'tmonth', '[tmonth]', 'CAST([tmonth] AS NVARCHAR)', 3, -1, FALSE, '[tmonth]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->tmonth->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['tmonth'] = &$this->tmonth;

		// tweek
		$this->tweek = new cField('vwrdm_time_entries', 'vwrdm_time_entries', 'x_tweek', 'tweek', '[tweek]', 'CAST([tweek] AS NVARCHAR)', 3, -1, FALSE, '[tweek]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->tweek->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['tweek'] = &$this->tweek;

		// created_on
		$this->created_on = new cField('vwrdm_time_entries', 'vwrdm_time_entries', 'x_created_on', 'created_on', '[created_on]', '(REPLACE(STR(DAY([created_on]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([created_on]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([created_on]),4,0))', 135, 7, FALSE, '[created_on]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->created_on->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['created_on'] = &$this->created_on;

		// updated_on
		$this->updated_on = new cField('vwrdm_time_entries', 'vwrdm_time_entries', 'x_updated_on', 'updated_on', '[updated_on]', '(REPLACE(STR(DAY([updated_on]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([updated_on]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([updated_on]),4,0))', 135, 7, FALSE, '[updated_on]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlFrom() { // From
		return "[db_owner].[vwrdm_time_entries]";
	}
	...
	// Update Table
	var $UpdateTable = "[db_owner].[vwrdm_time_entries]";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "vwrdm_time_entrieslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("vwrdm_time_entriesview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("vwrdm_time_entriesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "vwrdm_time_entriesadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("vwrdm_time_entriesedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("vwrdm_time_entriesadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("vwrdm_time_entriesdelete.php", $this->UrlParm());
	}
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				if ($this->tweek->Exportable) $Doc->ExportCaption($this->tweek);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					if ($this->tweek->Exportable) $Doc->ExportField($this->tweek);
