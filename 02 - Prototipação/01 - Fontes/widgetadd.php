...
$widget_add = NULL; // Initialize page object first

class cwidget_add extends cwidget {
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->im_arquivo);
...
// Create page object
if (!isset($widget_add)) $widget_add = new cwidget_add();

// Page init
$widget_add->Page_Init();

// Page main
$widget_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$widget_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var widget_add = new ew_Page("widget_add");
widget_add.PageID = "add"; // Page ID
var EW_PAGE_ID = widget_add.PageID; // For backward compatibility

// Form object
var fwidgetadd = new ew_Form("fwidgetadd");

// Validate form
fwidgetadd.Validate = function() {
...
fwidgetadd.Form_CustomValidate = 
...
fwidgetadd.ValidateRequired = true;
<?php } else { ?>
fwidgetadd.ValidateRequired = false; 
<?php } ?>
...
<?php $widget_add->ShowPageHeader(); ?>
<?php
$widget_add->ShowMessage();
?>
<form name="fwidgetadd" id="fwidgetadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="widget">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_widgetadd" class="table table-bordered table-striped">
