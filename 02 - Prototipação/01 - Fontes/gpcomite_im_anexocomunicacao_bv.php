...
$gpcomite_im_anexoComunicacao_blobview = NULL; // Initialize page object first

class cgpcomite_im_anexoComunicacao_blobview extends cgpcomite {
	...
	// Page object name
	var $PageObjName = 'gpcomite_im_anexoComunicacao_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('gpcomite', 'x_im_anexoComunicacao');
		...
		if ($this->Recordset = $conn->Execute($sSql)) {
			if (!$this->Recordset->EOF) {
				if (!EW_DEBUG_ENABLED && ob_get_length())
					ob_end_clean();
				$objBinary->Value = $this->Recordset->fields('im_anexoComunicacao');
				...
				if (trim(strval($this->Recordset->fields('im_anexoComunicacao'))) <> "") {
					header("Content-Disposition: attachment; filename=\"" . $this->Recordset->fields('im_anexoComunicacao') . "\"");
				}
...
// Create page object
if (!isset($gpcomite_im_anexoComunicacao_blobview)) $gpcomite_im_anexoComunicacao_blobview = new cgpcomite_im_anexoComunicacao_blobview();

// Page init
$gpcomite_im_anexoComunicacao_blobview->Page_Init();

// Page main
$gpcomite_im_anexoComunicacao_blobview->Page_Main();
?>
<?php
$gpcomite_im_anexoComunicacao_blobview->Page_Terminate();
?>
