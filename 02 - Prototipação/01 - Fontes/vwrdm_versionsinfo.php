...
//
// Table class for vwrdm_versions
//
class cvwrdm_versions extends cTable {
	var $id;
	var $project_id;
	var $name;
	var $description;
	...
	function __construct() {
		...
		$this->TableVar = 'vwrdm_versions';
		$this->TableName = 'vwrdm_versions';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('vwrdm_versions', 'vwrdm_versions', 'x_id', 'id', '[id]', 'CAST([id] AS NVARCHAR)', 3, -1, FALSE, '[id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// project_id
		$this->project_id = new cField('vwrdm_versions', 'vwrdm_versions', 'x_project_id', 'project_id', '[project_id]', 'CAST([project_id] AS NVARCHAR)', 3, -1, FALSE, '[project_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->project_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['project_id'] = &$this->project_id;

		// name
		$this->name = new cField('vwrdm_versions', 'vwrdm_versions', 'x_name', 'name', '[name]', '[name]', 202, -1, FALSE, '[name]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['name'] = &$this->name;

		// description
		$this->description = new cField('vwrdm_versions', 'vwrdm_versions', 'x_description', 'description', '[description]', '[description]', 202, -1, FALSE, '[description]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['description'] = &$this->description;

		// effective_date
		$this->effective_date = new cField('vwrdm_versions', 'vwrdm_versions', 'x_effective_date', 'effective_date', '[effective_date]', '(REPLACE(STR(DAY([effective_date]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([effective_date]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([effective_date]),4,0))', 133, 7, FALSE, '[effective_date]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// created_on
		$this->created_on = new cField('vwrdm_versions', 'vwrdm_versions', 'x_created_on', 'created_on', '[created_on]', '(REPLACE(STR(DAY([created_on]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([created_on]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([created_on]),4,0))', 135, 7, FALSE, '[created_on]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->created_on->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['created_on'] = &$this->created_on;

		// updated_on
		$this->updated_on = new cField('vwrdm_versions', 'vwrdm_versions', 'x_updated_on', 'updated_on', '[updated_on]', '(REPLACE(STR(DAY([updated_on]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([updated_on]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([updated_on]),4,0))', 135, 7, FALSE, '[updated_on]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->updated_on->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['updated_on'] = &$this->updated_on;

		// wiki_page_title
		$this->wiki_page_title = new cField('vwrdm_versions', 'vwrdm_versions', 'x_wiki_page_title', 'wiki_page_title', '[wiki_page_title]', '[wiki_page_title]', 202, -1, FALSE, '[wiki_page_title]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['wiki_page_title'] = &$this->wiki_page_title;

		// status
		$this->status = new cField('vwrdm_versions', 'vwrdm_versions', 'x_status', 'status', '[status]', '[status]', 202, -1, FALSE, '[status]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['status'] = &$this->status;

		// sharing
		$this->sharing = new cField('vwrdm_versions', 'vwrdm_versions', 'x_sharing', 'sharing', '[sharing]', '[sharing]', 202, -1, FALSE, '[sharing]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlFrom() { // From
		return "[db_owner].[vwrdm_versions]";
	}
	...
	// Update Table
	var $UpdateTable = "[db_owner].[vwrdm_versions]";
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("vwrdm_versionsview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("vwrdm_versionsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "vwrdm_versionsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("vwrdm_versionsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("vwrdm_versionsadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("vwrdm_versionsdelete.php", $this->UrlParm());
	}
