...
$tbrdm_members_view = NULL; // Initialize page object first

class ctbrdm_members_view extends ctbrdm_members {
	...
	// Page object name
	var $PageObjName = 'tbrdm_members_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "tbrdm_memberslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tbrdm_memberslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "tbrdm_memberslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_tbrdm_members\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_tbrdm_members',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.ftbrdm_membersview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($tbrdm_members_view)) $tbrdm_members_view = new ctbrdm_members_view();

// Page init
$tbrdm_members_view->Page_Init();

// Page main
$tbrdm_members_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbrdm_members_view->Page_Render();
?>
...
// Page object
var tbrdm_members_view = new ew_Page("tbrdm_members_view");
tbrdm_members_view.PageID = "view"; // Page ID
var EW_PAGE_ID = tbrdm_members_view.PageID; // For backward compatibility

// Form object
var ftbrdm_membersview = new ew_Form("ftbrdm_membersview");

// Form_CustomValidate event
ftbrdm_membersview.Form_CustomValidate = 
...
ftbrdm_membersview.ValidateRequired = true;
<?php } else { ?>
ftbrdm_membersview.ValidateRequired = false; 
<?php } ?>
...
<?php $tbrdm_members_view->ExportOptions->Render("body") ?>
<?php if (!$tbrdm_members_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($tbrdm_members_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $tbrdm_members_view->ShowPageHeader(); ?>
<?php
$tbrdm_members_view->ShowMessage();
?>
<form name="ftbrdm_membersview" id="ftbrdm_membersview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="tbrdm_members">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_tbrdm_membersview" class="table table-bordered table-striped">
<?php if ($tbrdm_members->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_tbrdm_members_id"><?php echo $tbrdm_members->id->FldCaption() ?></span></td>
...
<?php echo $tbrdm_members->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_members->user_id->Visible) { // user_id ?>
	<tr id="r_user_id">
		<td><span id="elh_tbrdm_members_user_id"><?php echo $tbrdm_members->user_id->FldCaption() ?></span></td>
...
<?php echo $tbrdm_members->user_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_members->project_id->Visible) { // project_id ?>
	<tr id="r_project_id">
		<td><span id="elh_tbrdm_members_project_id"><?php echo $tbrdm_members->project_id->FldCaption() ?></span></td>
...
<?php echo $tbrdm_members->project_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_members->created_on->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_members->mail_notification->Visible) { // mail_notification ?>
	<tr id="r_mail_notification">
		<td><span id="elh_tbrdm_members_mail_notification"><?php echo $tbrdm_members->mail_notification->FldCaption() ?></span></td>
...
<?php echo $tbrdm_members->mail_notification->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ftbrdm_membersview.Init();
</script>
<?php
$tbrdm_members_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($tbrdm_members->Export == "") { ?>
...
<?php
$tbrdm_members_view->Page_Terminate();
?>
