...
$atividade_delete = NULL; // Initialize page object first

class catividade_delete extends catividade {
	...
	// Page object name
	var $PageObjName = 'atividade_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("atividadelist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in atividade class, atividadeinfo.php
...
// Create page object
if (!isset($atividade_delete)) $atividade_delete = new catividade_delete();

// Page init
$atividade_delete->Page_Init();

// Page main
$atividade_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$atividade_delete->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var atividade_delete = new ew_Page("atividade_delete");
atividade_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = atividade_delete.PageID; // For backward compatibility

// Form object
var fatividadedelete = new ew_Form("fatividadedelete");

// Form_CustomValidate event
fatividadedelete.Form_CustomValidate = 
...
fatividadedelete.ValidateRequired = true;
<?php } else { ?>
fatividadedelete.ValidateRequired = false; 
<?php } ?>
...
if ($atividade_delete->Recordset = $atividade_delete->LoadRecordset())
	$atividade_deleteTotalRecs = $atividade_delete->Recordset->RecordCount(); // Get record count
if ($atividade_deleteTotalRecs <= 0) { // No record found, exit
	if ($atividade_delete->Recordset)
		$atividade_delete->Recordset->Close();
	$atividade_delete->Page_Terminate("atividadelist.php"); // Return to list
}
?>
<?php $Breadcrumb->Render(); ?>
<?php $atividade_delete->ShowPageHeader(); ?>
<?php
$atividade_delete->ShowMessage();
?>
<form name="fatividadedelete" id="fatividadedelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="atividade">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($atividade_delete->RecKeys as $key) { ?>
<?php $keyvalue = is_array($key) ? implode($EW_COMPOSITE_KEY_SEPARATOR, $key) : $key; ?>
<input type="hidden" name="key_m[]" value="<?php echo ew_HtmlEncode($keyvalue) ?>">
<?php } ?>
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_atividadedelete" class="ewTable ewTableSeparate">
<?php echo $atividade->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
		<td><span id="elh_atividade_no_atividade" class="atividade_no_atividade"><?php echo $atividade->no_atividade->FldCaption() ?></span></td>
		<td><span id="elh_atividade_vr_duracao" class="atividade_vr_duracao"><?php echo $atividade->vr_duracao->FldCaption() ?></span></td>
		<td><span id="elh_atividade_ic_ativo" class="atividade_ic_ativo"><?php echo $atividade->ic_ativo->FldCaption() ?></span></td>
	</tr>
	</thead>
	<tbody>
<?php
$atividade_delete->RecCnt = 0;
$i = 0;
while (!$atividade_delete->Recordset->EOF) {
	$atividade_delete->RecCnt++;
	$atividade_delete->RowCnt++;

	// Set row properties
	$atividade->ResetAttrs();
	$atividade->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$atividade_delete->LoadRowValues($atividade_delete->Recordset);

	// Render row
	$atividade_delete->RenderRow();
?>
	<tr<?php echo $atividade->RowAttributes() ?>>
		<td<?php echo $atividade->no_atividade->CellAttributes() ?>>
<span id="el<?php echo $atividade_delete->RowCnt ?>_atividade_no_atividade" class="control-group atividade_no_atividade">
...
<span id="el<?php echo $atividade_delete->RowCnt ?>_atividade_vr_duracao" class="control-group atividade_vr_duracao">
...
<span id="el<?php echo $atividade_delete->RowCnt ?>_atividade_ic_ativo" class="control-group atividade_ic_ativo">
...
<?php
	$atividade_delete->Recordset->MoveNext();
}
$atividade_delete->Recordset->Close();
?>
</tbody>
...
<script type="text/javascript">
fatividadedelete.Init();
</script>
<?php
$atividade_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$atividade_delete->Page_Terminate();
?>
