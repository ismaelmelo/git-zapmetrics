...
$demanda_im_anexo_blobview = NULL; // Initialize page object first

class cdemanda_im_anexo_blobview extends cdemanda {
	...
	// Page object name
	var $PageObjName = 'demanda_im_anexo_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'demanda');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('demanda', 'x_im_anexo');
...
// Create page object
if (!isset($demanda_im_anexo_blobview)) $demanda_im_anexo_blobview = new cdemanda_im_anexo_blobview();

// Page init
$demanda_im_anexo_blobview->Page_Init();

// Page main
$demanda_im_anexo_blobview->Page_Main();
?>
<?php
$demanda_im_anexo_blobview->Page_Terminate();
?>
