...
//
// Table class for tbrdm_projects
//
class ctbrdm_projects extends cTable {
	var $id;
	var $name;
	var $description;
	var $homepage;
	...
	function __construct() {
		...
		$this->TableVar = 'tbrdm_projects';
		$this->TableName = 'tbrdm_projects';
		...
		// id
		$this->id = new cField('tbrdm_projects', 'tbrdm_projects', 'x_id', 'id', '[id]', 'CAST([id] AS NVARCHAR)', 3, -1, FALSE, '[id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// name
		$this->name = new cField('tbrdm_projects', 'tbrdm_projects', 'x_name', 'name', '[name]', '[name]', 200, -1, FALSE, '[name]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['name'] = &$this->name;

		// description
		$this->description = new cField('tbrdm_projects', 'tbrdm_projects', 'x_description', 'description', '[description]', '[description]', 201, -1, FALSE, '[description]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['description'] = &$this->description;

		// homepage
		$this->homepage = new cField('tbrdm_projects', 'tbrdm_projects', 'x_homepage', 'homepage', '[homepage]', '[homepage]', 200, -1, FALSE, '[homepage]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['homepage'] = &$this->homepage;

		// is_public
		$this->is_public = new cField('tbrdm_projects', 'tbrdm_projects', 'x_is_public', 'is_public', '[is_public]', 'CAST([is_public] AS NVARCHAR)', 3, -1, FALSE, '[is_public]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->is_public->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['is_public'] = &$this->is_public;

		// parent_id
		$this->parent_id = new cField('tbrdm_projects', 'tbrdm_projects', 'x_parent_id', 'parent_id', '[parent_id]', 'CAST([parent_id] AS NVARCHAR)', 3, -1, FALSE, '[parent_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->parent_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['parent_id'] = &$this->parent_id;

		// created_on
		$this->created_on = new cField('tbrdm_projects', 'tbrdm_projects', 'x_created_on', 'created_on', '[created_on]', '(REPLACE(STR(DAY([created_on]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([created_on]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([created_on]),4,0))', 135, 7, FALSE, '[created_on]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->created_on->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['created_on'] = &$this->created_on;

		// updated_on
		$this->updated_on = new cField('tbrdm_projects', 'tbrdm_projects', 'x_updated_on', 'updated_on', '[updated_on]', '(REPLACE(STR(DAY([updated_on]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([updated_on]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([updated_on]),4,0))', 135, 7, FALSE, '[updated_on]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->updated_on->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['updated_on'] = &$this->updated_on;

		// identifier
		$this->identifier = new cField('tbrdm_projects', 'tbrdm_projects', 'x_identifier', 'identifier', '[identifier]', '[identifier]', 200, -1, FALSE, '[identifier]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['identifier'] = &$this->identifier;

		// status
		$this->status = new cField('tbrdm_projects', 'tbrdm_projects', 'x_status', 'status', '[status]', 'CAST([status] AS NVARCHAR)', 3, -1, FALSE, '[status]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "[dbo].[tbrdm_projects]";
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("tbrdm_projectsview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("tbrdm_projectsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "tbrdm_projectsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("tbrdm_projectsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("tbrdm_projectsadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tbrdm_projectsdelete.php", $this->UrlParm());
	}
