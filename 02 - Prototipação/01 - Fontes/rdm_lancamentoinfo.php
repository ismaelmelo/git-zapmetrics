...
//
// Table class for rdm_lancamento
//
class crdm_lancamento extends cTable {
	var $id;
	var $project_id;
	var $issue_id;
	var $user_id;
	...
	function __construct() {
		...
		$this->TableVar = 'rdm_lancamento';
		$this->TableName = 'rdm_lancamento';
		...
		// id
		$this->id = new cField('rdm_lancamento', 'rdm_lancamento', 'x_id', 'id', '[id]', 'CAST([id] AS NVARCHAR)', 3, -1, FALSE, '[id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// project_id
		$this->project_id = new cField('rdm_lancamento', 'rdm_lancamento', 'x_project_id', 'project_id', '[project_id]', 'CAST([project_id] AS NVARCHAR)', 3, -1, FALSE, '[project_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->project_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['project_id'] = &$this->project_id;

		// issue_id
		$this->issue_id = new cField('rdm_lancamento', 'rdm_lancamento', 'x_issue_id', 'issue_id', '[issue_id]', 'CAST([issue_id] AS NVARCHAR)', 3, -1, FALSE, '[issue_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->issue_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['issue_id'] = &$this->issue_id;

		// user_id
		$this->user_id = new cField('rdm_lancamento', 'rdm_lancamento', 'x_user_id', 'user_id', '[user_id]', 'CAST([user_id] AS NVARCHAR)', 3, -1, FALSE, '[user_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->user_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['user_id'] = &$this->user_id;

		// activity_id
		$this->activity_id = new cField('rdm_lancamento', 'rdm_lancamento', 'x_activity_id', 'activity_id', '[activity_id]', 'CAST([activity_id] AS NVARCHAR)', 3, -1, FALSE, '[activity_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->activity_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['activity_id'] = &$this->activity_id;

		// hours
		$this->hours = new cField('rdm_lancamento', 'rdm_lancamento', 'x_hours', 'hours', '[hours]', 'CAST([hours] AS NVARCHAR)', 131, -1, FALSE, '[hours]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->hours->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['hours'] = &$this->hours;

		// comments
		$this->comments = new cField('rdm_lancamento', 'rdm_lancamento', 'x_comments', 'comments', '[comments]', '[comments]', 201, -1, FALSE, '[comments]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['comments'] = &$this->comments;

		// spent_on
		$this->spent_on = new cField('rdm_lancamento', 'rdm_lancamento', 'x_spent_on', 'spent_on', '[spent_on]', 'CAST([spent_on] AS NVARCHAR)', 3, 14, FALSE, '[spent_on]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->spent_on->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['spent_on'] = &$this->spent_on;

		// created_on
		$this->created_on = new cField('rdm_lancamento', 'rdm_lancamento', 'x_created_on', 'created_on', '[created_on]', 'CAST([created_on] AS NVARCHAR)', 3, 17, FALSE, '[created_on]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->created_on->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['created_on'] = &$this->created_on;

		// updated_on
		$this->updated_on = new cField('rdm_lancamento', 'rdm_lancamento', 'x_updated_on', 'updated_on', '[updated_on]', 'CAST([updated_on] AS NVARCHAR)', 3, 17, FALSE, '[updated_on]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "[dbo].[rdm_lancamento]";
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("rdm_lancamentoview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("rdm_lancamentoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "rdm_lancamentoadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("rdm_lancamentoedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("rdm_lancamentoadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("rdm_lancamentodelete.php", $this->UrlParm());
	}
