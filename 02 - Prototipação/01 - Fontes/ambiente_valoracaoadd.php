...
$ambiente_valoracao_add = NULL; // Initialize page object first

class cambiente_valoracao_add extends cambiente_valoracao {
	...
	// Page object name
	var $PageObjName = 'ambiente_valoracao_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["nu_versaoValoracao"] != "") {
				...
				$this->setKey("nu_versaoValoracao", $this->nu_versaoValoracao->CurrentValue); // Set up key
			} else {
				$this->setKey("nu_versaoValoracao", ""); // Clear key
				$this->CopyRecord = FALSE;
			}
			if ($this->CopyRecord) {
	...
	function LoadDefaultValues() {
		...
		$this->vr_constanteA->CurrentValue = "2.94";
		$this->vr_constanteB->CurrentValue = "0.91";
		$this->vr_constanteC->CurrentValue = "3.67";
		$this->vr_constanteD->CurrentValue = "0.28";
		$this->nu_altPREC->CurrentValue = NULL;
		$this->nu_altPREC->OldValue = $this->nu_altPREC->CurrentValue;
		$this->nu_altFLEX->CurrentValue = NULL;
		$this->nu_altFLEX->OldValue = $this->nu_altFLEX->CurrentValue;
		$this->nu_altRESL->CurrentValue = NULL;
		$this->nu_altRESL->OldValue = $this->nu_altRESL->CurrentValue;
		$this->nu_altTEAM->CurrentValue = NULL;
		$this->nu_altTEAM->OldValue = $this->nu_altTEAM->CurrentValue;
		$this->nu_altPMAT->CurrentValue = NULL;
		$this->nu_altPMAT->OldValue = $this->nu_altPMAT->CurrentValue;
		$this->nu_altRELY->CurrentValue = NULL;
		$this->nu_altRELY->OldValue = $this->nu_altRELY->CurrentValue;
		$this->nu_altDATA->CurrentValue = NULL;
		$this->nu_altDATA->OldValue = $this->nu_altDATA->CurrentValue;
		$this->nu_altCPLX1->CurrentValue = NULL;
		$this->nu_altCPLX1->OldValue = $this->nu_altCPLX1->CurrentValue;
		$this->nu_altCPLX2->CurrentValue = NULL;
		$this->nu_altCPLX2->OldValue = $this->nu_altCPLX2->CurrentValue;
		$this->nu_altCPLX3->CurrentValue = NULL;
		$this->nu_altCPLX3->OldValue = $this->nu_altCPLX3->CurrentValue;
		$this->nu_altCPLX4->CurrentValue = NULL;
		$this->nu_altCPLX4->OldValue = $this->nu_altCPLX4->CurrentValue;
		$this->nu_altCPLX5->CurrentValue = NULL;
		$this->nu_altCPLX5->OldValue = $this->nu_altCPLX5->CurrentValue;
		$this->nu_altDOCU->CurrentValue = NULL;
		$this->nu_altDOCU->OldValue = $this->nu_altDOCU->CurrentValue;
		$this->nu_altRUSE->CurrentValue = NULL;
		$this->nu_altRUSE->OldValue = $this->nu_altRUSE->CurrentValue;
		$this->nu_altTIME->CurrentValue = NULL;
		$this->nu_altTIME->OldValue = $this->nu_altTIME->CurrentValue;
		$this->nu_altSTOR->CurrentValue = NULL;
		$this->nu_altSTOR->OldValue = $this->nu_altSTOR->CurrentValue;
		$this->nu_altPVOL->CurrentValue = NULL;
		$this->nu_altPVOL->OldValue = $this->nu_altPVOL->CurrentValue;
		$this->nu_altACAP->CurrentValue = NULL;
		$this->nu_altACAP->OldValue = $this->nu_altACAP->CurrentValue;
		$this->nu_altPCAP->CurrentValue = NULL;
		$this->nu_altPCAP->OldValue = $this->nu_altPCAP->CurrentValue;
		$this->nu_altPCON->CurrentValue = NULL;
		$this->nu_altPCON->OldValue = $this->nu_altPCON->CurrentValue;
		$this->nu_altAPEX->CurrentValue = NULL;
		$this->nu_altAPEX->OldValue = $this->nu_altAPEX->CurrentValue;
		$this->nu_altPLEX->CurrentValue = NULL;
		$this->nu_altPLEX->OldValue = $this->nu_altPLEX->CurrentValue;
		$this->nu_altLTEX->CurrentValue = NULL;
		$this->nu_altLTEX->OldValue = $this->nu_altLTEX->CurrentValue;
		$this->nu_altTOOL->CurrentValue = NULL;
		$this->nu_altTOOL->OldValue = $this->nu_altTOOL->CurrentValue;
		$this->nu_altSITE->CurrentValue = NULL;
		$this->nu_altSITE->OldValue = $this->nu_altSITE->CurrentValue;
		$this->co_quePREC->CurrentValue = NULL;
		$this->co_quePREC->OldValue = $this->co_quePREC->CurrentValue;
		$this->co_queFLEX->CurrentValue = NULL;
		$this->co_queFLEX->OldValue = $this->co_queFLEX->CurrentValue;
		$this->co_queRESL->CurrentValue = NULL;
		$this->co_queRESL->OldValue = $this->co_queRESL->CurrentValue;
		$this->co_queTEAM->CurrentValue = NULL;
		$this->co_queTEAM->OldValue = $this->co_queTEAM->CurrentValue;
		$this->co_quePMAT->CurrentValue = NULL;
		$this->co_quePMAT->OldValue = $this->co_quePMAT->CurrentValue;
		$this->co_queRELY->CurrentValue = NULL;
		$this->co_queRELY->OldValue = $this->co_queRELY->CurrentValue;
		$this->co_queDATA->CurrentValue = NULL;
		$this->co_queDATA->OldValue = $this->co_queDATA->CurrentValue;
		$this->co_queCPLX1->CurrentValue = NULL;
		$this->co_queCPLX1->OldValue = $this->co_queCPLX1->CurrentValue;
		$this->co_queCPLX2->CurrentValue = NULL;
		$this->co_queCPLX2->OldValue = $this->co_queCPLX2->CurrentValue;
		$this->co_queCPLX3->CurrentValue = NULL;
		$this->co_queCPLX3->OldValue = $this->co_queCPLX3->CurrentValue;
		$this->co_queCPLX4->CurrentValue = NULL;
		$this->co_queCPLX4->OldValue = $this->co_queCPLX4->CurrentValue;
		$this->co_queCPLX5->CurrentValue = NULL;
		$this->co_queCPLX5->OldValue = $this->co_queCPLX5->CurrentValue;
		$this->co_queDOCU->CurrentValue = NULL;
		$this->co_queDOCU->OldValue = $this->co_queDOCU->CurrentValue;
		$this->co_queRUSE->CurrentValue = NULL;
		$this->co_queRUSE->OldValue = $this->co_queRUSE->CurrentValue;
		$this->co_queTIME->CurrentValue = NULL;
		$this->co_queTIME->OldValue = $this->co_queTIME->CurrentValue;
		$this->co_queSTOR->CurrentValue = NULL;
		$this->co_queSTOR->OldValue = $this->co_queSTOR->CurrentValue;
		$this->co_quePVOL->CurrentValue = NULL;
		$this->co_quePVOL->OldValue = $this->co_quePVOL->CurrentValue;
		$this->co_queACAP->CurrentValue = NULL;
		$this->co_queACAP->OldValue = $this->co_queACAP->CurrentValue;
		$this->co_quePCAP->CurrentValue = NULL;
		$this->co_quePCAP->OldValue = $this->co_quePCAP->CurrentValue;
		$this->co_quePCON->CurrentValue = NULL;
		$this->co_quePCON->OldValue = $this->co_quePCON->CurrentValue;
		$this->co_queAPEX->CurrentValue = NULL;
		$this->co_queAPEX->OldValue = $this->co_queAPEX->CurrentValue;
		$this->co_quePLEX->CurrentValue = NULL;
		$this->co_quePLEX->OldValue = $this->co_quePLEX->CurrentValue;
		$this->co_queLTEX->CurrentValue = NULL;
		$this->co_queLTEX->OldValue = $this->co_queLTEX->CurrentValue;
		$this->co_queTOOL->CurrentValue = NULL;
		$this->co_queTOOL->OldValue = $this->co_queTOOL->CurrentValue;
		$this->co_queSITE->CurrentValue = NULL;
		$this->co_queSITE->OldValue = $this->co_queSITE->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// vr_constanteA
		$this->vr_constanteA->SetDbValueDef($rsnew, $this->vr_constanteA->CurrentValue, NULL, FALSE);

		// vr_constanteB
		$this->vr_constanteB->SetDbValueDef($rsnew, $this->vr_constanteB->CurrentValue, NULL, FALSE);

		// vr_constanteC
		$this->vr_constanteC->SetDbValueDef($rsnew, $this->vr_constanteC->CurrentValue, NULL, FALSE);

		// vr_constanteD
		$this->vr_constanteD->SetDbValueDef($rsnew, $this->vr_constanteD->CurrentValue, NULL, FALSE);

		// nu_altPREC
		$this->nu_altPREC->SetDbValueDef($rsnew, $this->nu_altPREC->CurrentValue, NULL, FALSE);

		// nu_altFLEX
		$this->nu_altFLEX->SetDbValueDef($rsnew, $this->nu_altFLEX->CurrentValue, NULL, FALSE);

		// nu_altRESL
		$this->nu_altRESL->SetDbValueDef($rsnew, $this->nu_altRESL->CurrentValue, NULL, FALSE);

		// nu_altTEAM
		$this->nu_altTEAM->SetDbValueDef($rsnew, $this->nu_altTEAM->CurrentValue, NULL, FALSE);

		// nu_altPMAT
		$this->nu_altPMAT->SetDbValueDef($rsnew, $this->nu_altPMAT->CurrentValue, NULL, FALSE);

		// nu_altRELY
		$this->nu_altRELY->SetDbValueDef($rsnew, $this->nu_altRELY->CurrentValue, NULL, FALSE);

		// nu_altDATA
		$this->nu_altDATA->SetDbValueDef($rsnew, $this->nu_altDATA->CurrentValue, NULL, FALSE);

		// nu_altCPLX1
		$this->nu_altCPLX1->SetDbValueDef($rsnew, $this->nu_altCPLX1->CurrentValue, NULL, FALSE);

		// nu_altCPLX2
		$this->nu_altCPLX2->SetDbValueDef($rsnew, $this->nu_altCPLX2->CurrentValue, NULL, FALSE);

		// nu_altCPLX3
		$this->nu_altCPLX3->SetDbValueDef($rsnew, $this->nu_altCPLX3->CurrentValue, NULL, FALSE);

		// nu_altCPLX4
		$this->nu_altCPLX4->SetDbValueDef($rsnew, $this->nu_altCPLX4->CurrentValue, NULL, FALSE);

		// nu_altCPLX5
		$this->nu_altCPLX5->SetDbValueDef($rsnew, $this->nu_altCPLX5->CurrentValue, NULL, FALSE);

		// nu_altDOCU
		$this->nu_altDOCU->SetDbValueDef($rsnew, $this->nu_altDOCU->CurrentValue, NULL, FALSE);

		// nu_altRUSE
		$this->nu_altRUSE->SetDbValueDef($rsnew, $this->nu_altRUSE->CurrentValue, NULL, FALSE);

		// nu_altTIME
		$this->nu_altTIME->SetDbValueDef($rsnew, $this->nu_altTIME->CurrentValue, NULL, FALSE);

		// nu_altSTOR
		$this->nu_altSTOR->SetDbValueDef($rsnew, $this->nu_altSTOR->CurrentValue, NULL, FALSE);

		// nu_altPVOL
		$this->nu_altPVOL->SetDbValueDef($rsnew, $this->nu_altPVOL->CurrentValue, NULL, FALSE);

		// nu_altACAP
		$this->nu_altACAP->SetDbValueDef($rsnew, $this->nu_altACAP->CurrentValue, NULL, FALSE);

		// nu_altPCAP
		$this->nu_altPCAP->SetDbValueDef($rsnew, $this->nu_altPCAP->CurrentValue, NULL, FALSE);

		// nu_altPCON
		$this->nu_altPCON->SetDbValueDef($rsnew, $this->nu_altPCON->CurrentValue, NULL, FALSE);

		// nu_altAPEX
		$this->nu_altAPEX->SetDbValueDef($rsnew, $this->nu_altAPEX->CurrentValue, NULL, FALSE);

		// nu_altPLEX
		$this->nu_altPLEX->SetDbValueDef($rsnew, $this->nu_altPLEX->CurrentValue, NULL, FALSE);

		// nu_altLTEX
		$this->nu_altLTEX->SetDbValueDef($rsnew, $this->nu_altLTEX->CurrentValue, NULL, FALSE);

		// nu_altTOOL
		$this->nu_altTOOL->SetDbValueDef($rsnew, $this->nu_altTOOL->CurrentValue, NULL, FALSE);

		// nu_altSITE
		$this->nu_altSITE->SetDbValueDef($rsnew, $this->nu_altSITE->CurrentValue, NULL, FALSE);

		// co_quePREC
		$this->co_quePREC->SetDbValueDef($rsnew, $this->co_quePREC->CurrentValue, NULL, FALSE);

		// co_queFLEX
		$this->co_queFLEX->SetDbValueDef($rsnew, $this->co_queFLEX->CurrentValue, NULL, FALSE);

		// co_queRESL
		$this->co_queRESL->SetDbValueDef($rsnew, $this->co_queRESL->CurrentValue, NULL, FALSE);

		// co_queTEAM
		$this->co_queTEAM->SetDbValueDef($rsnew, $this->co_queTEAM->CurrentValue, NULL, FALSE);

		// co_quePMAT
		$this->co_quePMAT->SetDbValueDef($rsnew, $this->co_quePMAT->CurrentValue, NULL, FALSE);

		// co_queRELY
		$this->co_queRELY->SetDbValueDef($rsnew, $this->co_queRELY->CurrentValue, NULL, FALSE);

		// co_queDATA
		$this->co_queDATA->SetDbValueDef($rsnew, $this->co_queDATA->CurrentValue, NULL, FALSE);

		// co_queCPLX1
		$this->co_queCPLX1->SetDbValueDef($rsnew, $this->co_queCPLX1->CurrentValue, NULL, FALSE);

		// co_queCPLX2
		$this->co_queCPLX2->SetDbValueDef($rsnew, $this->co_queCPLX2->CurrentValue, NULL, FALSE);

		// co_queCPLX3
		$this->co_queCPLX3->SetDbValueDef($rsnew, $this->co_queCPLX3->CurrentValue, NULL, FALSE);

		// co_queCPLX4
		$this->co_queCPLX4->SetDbValueDef($rsnew, $this->co_queCPLX4->CurrentValue, NULL, FALSE);

		// co_queCPLX5
		$this->co_queCPLX5->SetDbValueDef($rsnew, $this->co_queCPLX5->CurrentValue, NULL, FALSE);

		// co_queDOCU
		$this->co_queDOCU->SetDbValueDef($rsnew, $this->co_queDOCU->CurrentValue, NULL, FALSE);

		// co_queRUSE
		$this->co_queRUSE->SetDbValueDef($rsnew, $this->co_queRUSE->CurrentValue, NULL, FALSE);

		// co_queTIME
		$this->co_queTIME->SetDbValueDef($rsnew, $this->co_queTIME->CurrentValue, NULL, FALSE);

		// co_queSTOR
		$this->co_queSTOR->SetDbValueDef($rsnew, $this->co_queSTOR->CurrentValue, NULL, FALSE);

		// co_quePVOL
		$this->co_quePVOL->SetDbValueDef($rsnew, $this->co_quePVOL->CurrentValue, NULL, FALSE);

		// co_queACAP
		$this->co_queACAP->SetDbValueDef($rsnew, $this->co_queACAP->CurrentValue, NULL, FALSE);

		// co_quePCAP
		$this->co_quePCAP->SetDbValueDef($rsnew, $this->co_quePCAP->CurrentValue, NULL, FALSE);

		// co_quePCON
		$this->co_quePCON->SetDbValueDef($rsnew, $this->co_quePCON->CurrentValue, NULL, FALSE);

		// co_queAPEX
		$this->co_queAPEX->SetDbValueDef($rsnew, $this->co_queAPEX->CurrentValue, NULL, FALSE);

		// co_quePLEX
		$this->co_quePLEX->SetDbValueDef($rsnew, $this->co_quePLEX->CurrentValue, NULL, FALSE);

		// co_queLTEX
		$this->co_queLTEX->SetDbValueDef($rsnew, $this->co_queLTEX->CurrentValue, NULL, FALSE);

		// co_queTOOL
		$this->co_queTOOL->SetDbValueDef($rsnew, $this->co_queTOOL->CurrentValue, NULL, FALSE);

		// co_queSITE
		$this->co_queSITE->SetDbValueDef($rsnew, $this->co_queSITE->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($ambiente_valoracao_add)) $ambiente_valoracao_add = new cambiente_valoracao_add();

// Page init
$ambiente_valoracao_add->Page_Init();

// Page main
$ambiente_valoracao_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ambiente_valoracao_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var ambiente_valoracao_add = new ew_Page("ambiente_valoracao_add");
ambiente_valoracao_add.PageID = "add"; // Page ID
var EW_PAGE_ID = ambiente_valoracao_add.PageID; // For backward compatibility

// Form object
var fambiente_valoracaoadd = new ew_Form("fambiente_valoracaoadd");

// Validate form
fambiente_valoracaoadd.Validate = function() {
...
fambiente_valoracaoadd.Form_CustomValidate = 
...
fambiente_valoracaoadd.ValidateRequired = true;
<?php } else { ?>
fambiente_valoracaoadd.ValidateRequired = false; 
<?php } ?>

// Multi-Page properties
fambiente_valoracaoadd.MultiPage = new ew_MultiPage("fambiente_valoracaoadd",
...
fambiente_valoracaoadd.Lists["x_nu_usuarioResp"] = {"LinkField":"x_nu_usuario","Ajax":true,"AutoFill":false,"DisplayFields":["x_no_usuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altPREC"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_quePREC"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altFLEX"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_queFLEX"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altRESL"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_queRESL"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altTEAM"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_queTEAM"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altPMAT"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_quePMAT"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altRELY"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_queRELY"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altDATA"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_queDATA"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altCPLX1"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_queCPLX1"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altCPLX2"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_queCPLX2"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altCPLX3"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_queCPLX3"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altCPLX4"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_queCPLX4"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altCPLX5"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_queCPLX5"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altDOCU"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_queDOCU"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altRUSE"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_queRUSE"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altTIME"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_queTIME"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altSTOR"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_queSTOR"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altPVOL"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_quePVOL"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altACAP"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_queACAP"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altPCAP"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_quePCAP"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altPCON"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_quePCON"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altAPEX"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_queAPEX"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altPLEX"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_quePLEX"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altLTEX"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_queLTEX"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altTOOL"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_queTOOL"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_nu_altSITE"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","x_ds_alternativa","",""],"ParentFields":["x_co_queSITE"],"FilterFields":["x_co_questao"],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_quePREC"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_queFLEX"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_queRESL"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_queTEAM"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_quePMAT"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_queRELY"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_queDATA"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_queCPLX1"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_queCPLX2"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_queCPLX3"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_queCPLX4"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_queCPLX5"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_queDOCU"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_queRUSE"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_queTIME"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_queSTOR"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_quePVOL"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_queACAP"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_quePCAP"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_quePCON"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_queAPEX"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_quePLEX"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_queLTEX"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_queTOOL"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fambiente_valoracaoadd.Lists["x_co_queSITE"] = {"LinkField":"x_co_questao","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_questao","x_no_questao","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $ambiente_valoracao_add->ShowPageHeader(); ?>
<?php
$ambiente_valoracao_add->ShowMessage();
?>
<form name="fambiente_valoracaoadd" id="fambiente_valoracaoadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="ambiente_valoracao">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewStdTable"><tbody><tr><td>
<div class="tabbable" id="ambiente_valoracao_add">
...
<table id="tbl_ambiente_valoracaoadd1" class="table table-bordered table-striped">
...
<input type="text" data-field="x_nu_versaoValoracao" name="x_nu_versaoValoracao" id="x_nu_versaoValoracao" size="30" placeholder="<?php echo $ambiente_valoracao->nu_versaoValoracao->PlaceHolder ?>" value="<?php echo $ambiente_valoracao->nu_versaoValoracao->EditValue ?>"<?php echo $ambiente_valoracao->nu_versaoValoracao->EditAttributes() ?>>
</span>
...
<table cellspacing="0" class="ewGrid" style="width: 100%"><tr><td>
<table id="tbl_ambiente_valoracaoadd2" class="table table-bordered table-striped">
...
<table cellspacing="0" class="ewGrid" style="width: 100%"><tr><td>
<table id="tbl_ambiente_valoracaoadd3" class="table table-bordered table-striped">
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_quePREC"].Options = <?php echo (is_array($ambiente_valoracao->co_quePREC->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_quePREC->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_queFLEX"].Options = <?php echo (is_array($ambiente_valoracao->co_queFLEX->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_queFLEX->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_queRESL"].Options = <?php echo (is_array($ambiente_valoracao->co_queRESL->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_queRESL->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_queTEAM"].Options = <?php echo (is_array($ambiente_valoracao->co_queTEAM->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_queTEAM->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_quePMAT"].Options = <?php echo (is_array($ambiente_valoracao->co_quePMAT->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_quePMAT->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_queRELY"].Options = <?php echo (is_array($ambiente_valoracao->co_queRELY->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_queRELY->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_queDATA"].Options = <?php echo (is_array($ambiente_valoracao->co_queDATA->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_queDATA->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_queCPLX1"].Options = <?php echo (is_array($ambiente_valoracao->co_queCPLX1->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_queCPLX1->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_queCPLX2"].Options = <?php echo (is_array($ambiente_valoracao->co_queCPLX2->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_queCPLX2->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_queCPLX3"].Options = <?php echo (is_array($ambiente_valoracao->co_queCPLX3->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_queCPLX3->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_queCPLX4"].Options = <?php echo (is_array($ambiente_valoracao->co_queCPLX4->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_queCPLX4->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_queCPLX5"].Options = <?php echo (is_array($ambiente_valoracao->co_queCPLX5->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_queCPLX5->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_queDOCU"].Options = <?php echo (is_array($ambiente_valoracao->co_queDOCU->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_queDOCU->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_queRUSE"].Options = <?php echo (is_array($ambiente_valoracao->co_queRUSE->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_queRUSE->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_queTIME"].Options = <?php echo (is_array($ambiente_valoracao->co_queTIME->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_queTIME->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_queSTOR"].Options = <?php echo (is_array($ambiente_valoracao->co_queSTOR->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_queSTOR->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_quePVOL"].Options = <?php echo (is_array($ambiente_valoracao->co_quePVOL->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_quePVOL->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_queACAP"].Options = <?php echo (is_array($ambiente_valoracao->co_queACAP->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_queACAP->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_quePCAP"].Options = <?php echo (is_array($ambiente_valoracao->co_quePCAP->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_quePCAP->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_quePCON"].Options = <?php echo (is_array($ambiente_valoracao->co_quePCON->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_quePCON->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_queAPEX"].Options = <?php echo (is_array($ambiente_valoracao->co_queAPEX->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_queAPEX->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_quePLEX"].Options = <?php echo (is_array($ambiente_valoracao->co_quePLEX->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_quePLEX->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_queLTEX"].Options = <?php echo (is_array($ambiente_valoracao->co_queLTEX->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_queLTEX->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_queTOOL"].Options = <?php echo (is_array($ambiente_valoracao->co_queTOOL->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_queTOOL->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_co_queSITE"].Options = <?php echo (is_array($ambiente_valoracao->co_queSITE->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->co_queSITE->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<table cellspacing="0" class="ewGrid" style="width: 100%"><tr><td>
<table id="tbl_ambiente_valoracaoadd4" class="table table-bordered table-striped">
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altPREC"].Options = <?php echo (is_array($ambiente_valoracao->nu_altPREC->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altPREC->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altFLEX"].Options = <?php echo (is_array($ambiente_valoracao->nu_altFLEX->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altFLEX->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altRESL"].Options = <?php echo (is_array($ambiente_valoracao->nu_altRESL->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altRESL->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altTEAM"].Options = <?php echo (is_array($ambiente_valoracao->nu_altTEAM->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altTEAM->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altPMAT"].Options = <?php echo (is_array($ambiente_valoracao->nu_altPMAT->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altPMAT->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altRELY"].Options = <?php echo (is_array($ambiente_valoracao->nu_altRELY->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altRELY->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altDATA"].Options = <?php echo (is_array($ambiente_valoracao->nu_altDATA->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altDATA->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altCPLX1"].Options = <?php echo (is_array($ambiente_valoracao->nu_altCPLX1->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altCPLX1->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altCPLX2"].Options = <?php echo (is_array($ambiente_valoracao->nu_altCPLX2->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altCPLX2->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altCPLX3"].Options = <?php echo (is_array($ambiente_valoracao->nu_altCPLX3->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altCPLX3->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altCPLX4"].Options = <?php echo (is_array($ambiente_valoracao->nu_altCPLX4->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altCPLX4->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altCPLX5"].Options = <?php echo (is_array($ambiente_valoracao->nu_altCPLX5->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altCPLX5->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altDOCU"].Options = <?php echo (is_array($ambiente_valoracao->nu_altDOCU->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altDOCU->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altRUSE"].Options = <?php echo (is_array($ambiente_valoracao->nu_altRUSE->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altRUSE->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altTIME"].Options = <?php echo (is_array($ambiente_valoracao->nu_altTIME->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altTIME->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altSTOR"].Options = <?php echo (is_array($ambiente_valoracao->nu_altSTOR->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altSTOR->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altPVOL"].Options = <?php echo (is_array($ambiente_valoracao->nu_altPVOL->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altPVOL->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altACAP"].Options = <?php echo (is_array($ambiente_valoracao->nu_altACAP->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altACAP->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altPCAP"].Options = <?php echo (is_array($ambiente_valoracao->nu_altPCAP->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altPCAP->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altPCON"].Options = <?php echo (is_array($ambiente_valoracao->nu_altPCON->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altPCON->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altAPEX"].Options = <?php echo (is_array($ambiente_valoracao->nu_altAPEX->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altAPEX->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altPLEX"].Options = <?php echo (is_array($ambiente_valoracao->nu_altPLEX->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altPLEX->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altLTEX"].Options = <?php echo (is_array($ambiente_valoracao->nu_altLTEX->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altLTEX->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altTOOL"].Options = <?php echo (is_array($ambiente_valoracao->nu_altTOOL->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altTOOL->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fambiente_valoracaoadd.Lists["x_nu_altSITE"].Options = <?php echo (is_array($ambiente_valoracao->nu_altSITE->EditValue)) ? ew_ArrayToJson($ambiente_valoracao->nu_altSITE->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<table cellspacing="0" class="ewGrid" style="width: 100%"><tr><td>
<table id="tbl_ambiente_valoracaoadd5" class="table table-bordered table-striped">
...
<?php if (strval($ambiente_valoracao->nu_ambiente->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_nu_ambiente" id="x_nu_ambiente" value="<?php echo ew_HtmlEncode(strval($ambiente_valoracao->nu_ambiente->getSessionValue())) ?>">
<?php } ?>
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
</form>
<script type="text/javascript">
fambiente_valoracaoadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$ambiente_valoracao_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$ambiente_valoracao_add->Page_Terminate();
?>
