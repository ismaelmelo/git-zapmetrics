...
//
// Table class for rdm_query
//
class crdm_query extends cTable {
	var $id;
	var $name;
	var $is_public;
	var $project_id;
	...
	function __construct() {
		...
		$this->TableVar = 'rdm_query';
		$this->TableName = 'rdm_query';
		...
		// id
		$this->id = new cField('rdm_query', 'rdm_query', 'x_id', 'id', '[id]', 'CAST([id] AS NVARCHAR)', 3, -1, FALSE, '[id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// name
		$this->name = new cField('rdm_query', 'rdm_query', 'x_name', 'name', '[name]', '[name]', 200, -1, FALSE, '[name]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['name'] = &$this->name;

		// is_public
		$this->is_public = new cField('rdm_query', 'rdm_query', 'x_is_public', 'is_public', '[is_public]', '[is_public]', 129, -1, FALSE, '[is_public]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['is_public'] = &$this->is_public;

		// project_id
		$this->project_id = new cField('rdm_query', 'rdm_query', 'x_project_id', 'project_id', '[project_id]', 'CAST([project_id] AS NVARCHAR)', 3, -1, FALSE, '[project_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("rdm_queryview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("rdm_queryview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "rdm_queryadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("rdm_queryedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("rdm_queryadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("rdm_querydelete.php", $this->UrlParm());
	}
