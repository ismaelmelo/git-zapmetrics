...
$fornecedor_addopt = NULL; // Initialize page object first

class cfornecedor_addopt extends cfornecedor {
	...
	// Page object name
	var $PageObjName = 'fornecedor_addopt';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow()) { // Add successful
					...
					$row["x_no_fornecedor"] = $this->no_fornecedor->DbValue;
					$row["x_no_razaoSocial"] = $this->no_razaoSocial->DbValue;
	...
	function LoadFormValues() {
		...
		if (!$this->no_fornecedor->FldIsDetailKey) {
			$this->no_fornecedor->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_no_fornecedor")));
		}
		if (!$this->no_razaoSocial->FldIsDetailKey) {
			$this->no_razaoSocial->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_no_razaoSocial")));
		}
	...
	function RestoreFormValues() {
		...
		$this->no_fornecedor->CurrentValue = ew_ConvertToUtf8($this->no_fornecedor->FormValue);
		$this->no_razaoSocial->CurrentValue = ew_ConvertToUtf8($this->no_razaoSocial->FormValue);
...
// Create page object
if (!isset($fornecedor_addopt)) $fornecedor_addopt = new cfornecedor_addopt();

// Page init
$fornecedor_addopt->Page_Init();

// Page main
$fornecedor_addopt->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$fornecedor_addopt->Page_Render();
?>
<script type="text/javascript">

// Page object
var fornecedor_addopt = new ew_Page("fornecedor_addopt");
fornecedor_addopt.PageID = "addopt"; // Page ID
var EW_PAGE_ID = fornecedor_addopt.PageID; // For backward compatibility

// Form object
var ffornecedoraddopt = new ew_Form("ffornecedoraddopt");

// Validate form
ffornecedoraddopt.Validate = function() {
...
ffornecedoraddopt.Form_CustomValidate = 
...
ffornecedoraddopt.ValidateRequired = true;
<?php } else { ?>
ffornecedoraddopt.ValidateRequired = false; 
<?php } ?>
...
<?php
$fornecedor_addopt->ShowMessage();
?>
<form name="ffornecedoraddopt" id="ffornecedoraddopt" class="ewForm form-horizontal" action="fornecedoraddopt.php" method="post">
<input type="hidden" name="t" value="fornecedor">
<input type="hidden" name="a_addopt" id="a_addopt" value="A">
<div id="tbl_fornecedoraddopt">
	<div class="control-group">
		<label class="control-label" for="x_co_alternativo"><?php echo $fornecedor->co_alternativo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="controls">
<input type="text" data-field="x_co_alternativo" name="x_co_alternativo" id="x_co_alternativo" size="30" maxlength="20" placeholder="<?php echo $fornecedor->co_alternativo->PlaceHolder ?>" value="<?php echo $fornecedor->co_alternativo->EditValue ?>"<?php echo $fornecedor->co_alternativo->EditAttributes() ?>>
	...
	<div class="control-group">
		<label class="control-label" for="x_no_fornecedor"><?php echo $fornecedor->no_fornecedor->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="controls">
<input type="text" data-field="x_no_fornecedor" name="x_no_fornecedor" id="x_no_fornecedor" size="30" maxlength="100" placeholder="<?php echo $fornecedor->no_fornecedor->PlaceHolder ?>" value="<?php echo $fornecedor->no_fornecedor->EditValue ?>"<?php echo $fornecedor->no_fornecedor->EditAttributes() ?>>
	...
	<div class="control-group">
		<label class="control-label" for="x_no_razaoSocial"><?php echo $fornecedor->no_razaoSocial->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="controls">
<input type="text" data-field="x_no_razaoSocial" name="x_no_razaoSocial" id="x_no_razaoSocial" size="100" maxlength="150" placeholder="<?php echo $fornecedor->no_razaoSocial->PlaceHolder ?>" value="<?php echo $fornecedor->no_razaoSocial->EditValue ?>"<?php echo $fornecedor->no_razaoSocial->EditAttributes() ?>>
	...
	<div class="control-group">
		<label class="control-label" for="x_ic_ativo"><?php echo $fornecedor->ic_ativo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="controls">
...
<?php
$fornecedor_addopt->Page_Terminate();
?>
