...
$parintredmine_view = NULL; // Initialize page object first

class cparintredmine_view extends cparintredmine {
	...
	// Page object name
	var $PageObjName = 'parintredmine_view';
	...
	function __construct() {
		...
		if (@$_GET["nu_parIntRedmine"] <> "") {
			$this->RecKey["nu_parIntRedmine"] = $_GET["nu_parIntRedmine"];
			$KeyUrl .= "&nu_parIntRedmine=" . urlencode($this->RecKey["nu_parIntRedmine"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["nu_parIntRedmine"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["nu_parIntRedmine"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["nu_parIntRedmine"] <> "") {
				...
				$this->RecKey["nu_parIntRedmine"] = $this->nu_parIntRedmine->QueryStringValue;
			} else {
				$sReturnUrl = "parintredminelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "parintredminelist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "parintredminelist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_parintredmine\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_parintredmine',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fparintredmineview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($parintredmine_view)) $parintredmine_view = new cparintredmine_view();

// Page init
$parintredmine_view->Page_Init();

// Page main
$parintredmine_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$parintredmine_view->Page_Render();
?>
...
// Page object
var parintredmine_view = new ew_Page("parintredmine_view");
parintredmine_view.PageID = "view"; // Page ID
var EW_PAGE_ID = parintredmine_view.PageID; // For backward compatibility

// Form object
var fparintredmineview = new ew_Form("fparintredmineview");

// Form_CustomValidate event
fparintredmineview.Form_CustomValidate = 
...
fparintredmineview.ValidateRequired = true;
<?php } else { ?>
fparintredmineview.ValidateRequired = false; 
<?php } ?>
...
<?php $parintredmine_view->ExportOptions->Render("body") ?>
<?php if (!$parintredmine_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($parintredmine_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $parintredmine_view->ShowPageHeader(); ?>
<?php
$parintredmine_view->ShowMessage();
?>
<form name="fparintredmineview" id="fparintredmineview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="parintredmine">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_parintredmineview" class="table table-bordered table-striped">
...
<?php echo $parintredmine->nu_parIntRedmine->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($parintredmine->no_parIntRedmine->Visible) { // no_parIntRedmine ?>
	<tr id="r_no_parIntRedmine">
		<td><span id="elh_parintredmine_no_parIntRedmine"><?php echo $parintredmine->no_parIntRedmine->FldCaption() ?></span></td>
...
<?php echo $parintredmine->no_parIntRedmine->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $parintredmine->ic_grupoParIntRedmine->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $parintredmine->vr_variavel->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $parintredmine->no_variavel->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fparintredmineview.Init();
</script>
<?php
$parintredmine_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($parintredmine->Export == "") { ?>
...
<?php
$parintredmine_view->Page_Terminate();
?>
