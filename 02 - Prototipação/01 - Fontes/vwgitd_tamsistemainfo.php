...
$vwgitd_tamSistema = NULL;

//
// Table class for vwgitd_tamSistema
//
class cvwgitd_tamSistema extends cTable {
	var $nu_sistema;
	var $no_sistema;
	var $qt_pf;
	...
	function __construct() {
		...
		$this->TableVar = 'vwgitd_tamSistema';
		$this->TableName = 'vwgitd_tamSistema';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// nu_sistema
		$this->nu_sistema = new cField('vwgitd_tamSistema', 'vwgitd_tamSistema', 'x_nu_sistema', 'nu_sistema', '[nu_sistema]', 'CAST([nu_sistema] AS NVARCHAR)', 3, -1, FALSE, '[nu_sistema]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->nu_sistema->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['nu_sistema'] = &$this->nu_sistema;

		// no_sistema
		$this->no_sistema = new cField('vwgitd_tamSistema', 'vwgitd_tamSistema', 'x_no_sistema', 'no_sistema', '[no_sistema]', '[no_sistema]', 200, -1, FALSE, '[no_sistema]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['no_sistema'] = &$this->no_sistema;

		// qt_pf
		$this->qt_pf = new cField('vwgitd_tamSistema', 'vwgitd_tamSistema', 'x_qt_pf', 'qt_pf', '[qt_pf]', 'CAST([qt_pf] AS NVARCHAR)', 131, -1, FALSE, '[qt_pf]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlFrom() { // From
		return "[db_owner].[vwgitd_tamSistema]";
	}
	...
	// Update Table
	var $UpdateTable = "[db_owner].[vwgitd_tamSistema]";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "vwgitd_tamsistemalist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("vwgitd_tamsistemaview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("vwgitd_tamsistemaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "vwgitd_tamsistemaadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("vwgitd_tamsistemaedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("vwgitd_tamsistemaadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("vwgitd_tamsistemadelete.php", $this->UrlParm());
	}
