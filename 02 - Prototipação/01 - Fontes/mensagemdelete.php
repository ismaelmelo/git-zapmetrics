...
$mensagem_delete = NULL; // Initialize page object first

class cmensagem_delete extends cmensagem {
	...
	// Page object name
	var $PageObjName = 'mensagem_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("mensagemlist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in mensagem class, mensageminfo.php
...
// Create page object
if (!isset($mensagem_delete)) $mensagem_delete = new cmensagem_delete();

// Page init
$mensagem_delete->Page_Init();

// Page main
$mensagem_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$mensagem_delete->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var mensagem_delete = new ew_Page("mensagem_delete");
mensagem_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = mensagem_delete.PageID; // For backward compatibility

// Form object
var fmensagemdelete = new ew_Form("fmensagemdelete");

// Form_CustomValidate event
fmensagemdelete.Form_CustomValidate = 
...
fmensagemdelete.ValidateRequired = true;
<?php } else { ?>
fmensagemdelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmensagemdelete.Lists["x_nu_stMensagem"] = {"LinkField":"x_nu_stMensagem","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_stMensagem","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
if ($mensagem_delete->Recordset = $mensagem_delete->LoadRecordset())
	$mensagem_deleteTotalRecs = $mensagem_delete->Recordset->RecordCount(); // Get record count
if ($mensagem_deleteTotalRecs <= 0) { // No record found, exit
	if ($mensagem_delete->Recordset)
		$mensagem_delete->Recordset->Close();
	$mensagem_delete->Page_Terminate("mensagemlist.php"); // Return to list
}
?>
<?php $Breadcrumb->Render(); ?>
<?php $mensagem_delete->ShowPageHeader(); ?>
<?php
$mensagem_delete->ShowMessage();
?>
<form name="fmensagemdelete" id="fmensagemdelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="mensagem">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($mensagem_delete->RecKeys as $key) { ?>
<?php $keyvalue = is_array($key) ? implode($EW_COMPOSITE_KEY_SEPARATOR, $key) : $key; ?>
<input type="hidden" name="key_m[]" value="<?php echo ew_HtmlEncode($keyvalue) ?>">
<?php } ?>
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_mensagemdelete" class="ewTable ewTableSeparate">
<?php echo $mensagem->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
		<td><span id="elh_mensagem_co_alternativo" class="mensagem_co_alternativo"><?php echo $mensagem->co_alternativo->FldCaption() ?></span></td>
		<td><span id="elh_mensagem_no_mensagem" class="mensagem_no_mensagem"><?php echo $mensagem->no_mensagem->FldCaption() ?></span></td>
		<td><span id="elh_mensagem_ds_mensagem" class="mensagem_ds_mensagem"><?php echo $mensagem->ds_mensagem->FldCaption() ?></span></td>
		<td><span id="elh_mensagem_nu_stMensagem" class="mensagem_nu_stMensagem"><?php echo $mensagem->nu_stMensagem->FldCaption() ?></span></td>
	</tr>
	</thead>
	<tbody>
<?php
$mensagem_delete->RecCnt = 0;
$i = 0;
while (!$mensagem_delete->Recordset->EOF) {
	$mensagem_delete->RecCnt++;
	$mensagem_delete->RowCnt++;

	// Set row properties
	$mensagem->ResetAttrs();
	$mensagem->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$mensagem_delete->LoadRowValues($mensagem_delete->Recordset);

	// Render row
	$mensagem_delete->RenderRow();
?>
	<tr<?php echo $mensagem->RowAttributes() ?>>
		<td<?php echo $mensagem->co_alternativo->CellAttributes() ?>>
<span id="el<?php echo $mensagem_delete->RowCnt ?>_mensagem_co_alternativo" class="control-group mensagem_co_alternativo">
...
<span id="el<?php echo $mensagem_delete->RowCnt ?>_mensagem_no_mensagem" class="control-group mensagem_no_mensagem">
...
<span id="el<?php echo $mensagem_delete->RowCnt ?>_mensagem_ds_mensagem" class="control-group mensagem_ds_mensagem">
...
<span id="el<?php echo $mensagem_delete->RowCnt ?>_mensagem_nu_stMensagem" class="control-group mensagem_nu_stMensagem">
...
<?php
	$mensagem_delete->Recordset->MoveNext();
}
$mensagem_delete->Recordset->Close();
?>
</tbody>
...
<script type="text/javascript">
fmensagemdelete.Init();
</script>
<?php
$mensagem_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$mensagem_delete->Page_Terminate();
?>
