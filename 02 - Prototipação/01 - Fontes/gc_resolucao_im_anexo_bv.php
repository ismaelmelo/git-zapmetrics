...
$gc_resolucao_im_anexo_blobview = NULL; // Initialize page object first

class cgc_resolucao_im_anexo_blobview extends cgc_resolucao {
	...
	// Page object name
	var $PageObjName = 'gc_resolucao_im_anexo_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'gc_resolucao');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('gc_resolucao', 'x_im_anexo');
...
// Create page object
if (!isset($gc_resolucao_im_anexo_blobview)) $gc_resolucao_im_anexo_blobview = new cgc_resolucao_im_anexo_blobview();

// Page init
$gc_resolucao_im_anexo_blobview->Page_Init();

// Page main
$gc_resolucao_im_anexo_blobview->Page_Main();
?>
<?php
$gc_resolucao_im_anexo_blobview->Page_Terminate();
?>
