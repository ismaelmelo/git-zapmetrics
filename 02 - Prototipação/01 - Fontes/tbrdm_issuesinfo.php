...
//
// Table class for tbrdm_issues
//
class ctbrdm_issues extends cTable {
	var $id;
	var $tracker_id;
	var $project_id;
	var $subject;
	...
	function __construct() {
		...
		$this->TableVar = 'tbrdm_issues';
		$this->TableName = 'tbrdm_issues';
		...
		// id
		$this->id = new cField('tbrdm_issues', 'tbrdm_issues', 'x_id', 'id', '[id]', 'CAST([id] AS NVARCHAR)', 3, -1, FALSE, '[id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// tracker_id
		$this->tracker_id = new cField('tbrdm_issues', 'tbrdm_issues', 'x_tracker_id', 'tracker_id', '[tracker_id]', 'CAST([tracker_id] AS NVARCHAR)', 3, -1, FALSE, '[tracker_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->tracker_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['tracker_id'] = &$this->tracker_id;

		// project_id
		$this->project_id = new cField('tbrdm_issues', 'tbrdm_issues', 'x_project_id', 'project_id', '[project_id]', 'CAST([project_id] AS NVARCHAR)', 3, -1, FALSE, '[project_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->project_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['project_id'] = &$this->project_id;

		// subject
		$this->subject = new cField('tbrdm_issues', 'tbrdm_issues', 'x_subject', 'subject', '[subject]', '[subject]', 200, -1, FALSE, '[subject]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['subject'] = &$this->subject;

		// due_date
		$this->due_date = new cField('tbrdm_issues', 'tbrdm_issues', 'x_due_date', 'due_date', '[due_date]', '(REPLACE(STR(DAY([due_date]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([due_date]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([due_date]),4,0))', 133, 7, FALSE, '[due_date]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->due_date->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['due_date'] = &$this->due_date;

		// category_id
		$this->category_id = new cField('tbrdm_issues', 'tbrdm_issues', 'x_category_id', 'category_id', '[category_id]', 'CAST([category_id] AS NVARCHAR)', 3, -1, FALSE, '[category_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->category_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['category_id'] = &$this->category_id;

		// status_id
		$this->status_id = new cField('tbrdm_issues', 'tbrdm_issues', 'x_status_id', 'status_id', '[status_id]', 'CAST([status_id] AS NVARCHAR)', 3, -1, FALSE, '[status_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->status_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['status_id'] = &$this->status_id;

		// assigned_to_id
		$this->assigned_to_id = new cField('tbrdm_issues', 'tbrdm_issues', 'x_assigned_to_id', 'assigned_to_id', '[assigned_to_id]', 'CAST([assigned_to_id] AS NVARCHAR)', 3, -1, FALSE, '[assigned_to_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->assigned_to_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['assigned_to_id'] = &$this->assigned_to_id;

		// priority_id
		$this->priority_id = new cField('tbrdm_issues', 'tbrdm_issues', 'x_priority_id', 'priority_id', '[priority_id]', 'CAST([priority_id] AS NVARCHAR)', 3, -1, FALSE, '[priority_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->priority_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['priority_id'] = &$this->priority_id;

		// fixed_version_id
		$this->fixed_version_id = new cField('tbrdm_issues', 'tbrdm_issues', 'x_fixed_version_id', 'fixed_version_id', '[fixed_version_id]', 'CAST([fixed_version_id] AS NVARCHAR)', 3, -1, FALSE, '[fixed_version_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// author_id
		$this->author_id = new cField('tbrdm_issues', 'tbrdm_issues', 'x_author_id', 'author_id', '[author_id]', 'CAST([author_id] AS NVARCHAR)', 3, -1, FALSE, '[author_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->author_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['author_id'] = &$this->author_id;

		// lock_version
		$this->lock_version = new cField('tbrdm_issues', 'tbrdm_issues', 'x_lock_version', 'lock_version', '[lock_version]', 'CAST([lock_version] AS NVARCHAR)', 3, -1, FALSE, '[lock_version]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->lock_version->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['lock_version'] = &$this->lock_version;

		// created_on
		$this->created_on = new cField('tbrdm_issues', 'tbrdm_issues', 'x_created_on', 'created_on', '[created_on]', '(REPLACE(STR(DAY([created_on]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([created_on]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([created_on]),4,0))', 135, 7, FALSE, '[created_on]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->created_on->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['created_on'] = &$this->created_on;

		// updated_on
		$this->updated_on = new cField('tbrdm_issues', 'tbrdm_issues', 'x_updated_on', 'updated_on', '[updated_on]', '(REPLACE(STR(DAY([updated_on]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([updated_on]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([updated_on]),4,0))', 135, 7, FALSE, '[updated_on]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->updated_on->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['updated_on'] = &$this->updated_on;

		// start_date
		$this->start_date = new cField('tbrdm_issues', 'tbrdm_issues', 'x_start_date', 'start_date', '[start_date]', '(REPLACE(STR(DAY([start_date]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([start_date]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([start_date]),4,0))', 133, 7, FALSE, '[start_date]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->start_date->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['start_date'] = &$this->start_date;

		// done_ratio
		$this->done_ratio = new cField('tbrdm_issues', 'tbrdm_issues', 'x_done_ratio', 'done_ratio', '[done_ratio]', 'CAST([done_ratio] AS NVARCHAR)', 3, -1, FALSE, '[done_ratio]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->done_ratio->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['done_ratio'] = &$this->done_ratio;

		// estimated_hours
		$this->estimated_hours = new cField('tbrdm_issues', 'tbrdm_issues', 'x_estimated_hours', 'estimated_hours', '[estimated_hours]', 'CAST([estimated_hours] AS NVARCHAR)', 5, -1, FALSE, '[estimated_hours]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->estimated_hours->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['estimated_hours'] = &$this->estimated_hours;

		// parent_id
		$this->parent_id = new cField('tbrdm_issues', 'tbrdm_issues', 'x_parent_id', 'parent_id', '[parent_id]', 'CAST([parent_id] AS NVARCHAR)', 3, -1, FALSE, '[parent_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->parent_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['parent_id'] = &$this->parent_id;

		// root_id
		$this->root_id = new cField('tbrdm_issues', 'tbrdm_issues', 'x_root_id', 'root_id', '[root_id]', 'CAST([root_id] AS NVARCHAR)', 3, -1, FALSE, '[root_id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->root_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['root_id'] = &$this->root_id;

		// is_private
		$this->is_private = new cField('tbrdm_issues', 'tbrdm_issues', 'x_is_private', 'is_private', '[is_private]', 'CAST([is_private] AS NVARCHAR)', 3, -1, FALSE, '[is_private]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->is_private->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
	...
	// Update Table
	var $UpdateTable = "[dbo].[tbrdm_issues]";
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("tbrdm_issuesview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("tbrdm_issuesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "tbrdm_issuesadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("tbrdm_issuesedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("tbrdm_issuesadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tbrdm_issuesdelete.php", $this->UrlParm());
	}
