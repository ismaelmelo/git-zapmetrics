...
$tbrdm_custom_fields = NULL;

//
// Table class for tbrdm_custom_fields
//
class ctbrdm_custom_fields extends cTable {
	var $id;
	var $type;
	var $name;
	var $field_format;
	...
	function __construct() {
		...
		$this->TableVar = 'tbrdm_custom_fields';
		$this->TableName = 'tbrdm_custom_fields';
		...
		// id
		$this->id = new cField('tbrdm_custom_fields', 'tbrdm_custom_fields', 'x_id', 'id', '[id]', 'CAST([id] AS NVARCHAR)', 3, -1, FALSE, '[id]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// type
		$this->type = new cField('tbrdm_custom_fields', 'tbrdm_custom_fields', 'x_type', 'type', '[type]', '[type]', 200, -1, FALSE, '[type]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['type'] = &$this->type;

		// name
		$this->name = new cField('tbrdm_custom_fields', 'tbrdm_custom_fields', 'x_name', 'name', '[name]', '[name]', 200, -1, FALSE, '[name]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['name'] = &$this->name;

		// field_format
		$this->field_format = new cField('tbrdm_custom_fields', 'tbrdm_custom_fields', 'x_field_format', 'field_format', '[field_format]', '[field_format]', 200, -1, FALSE, '[field_format]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['field_format'] = &$this->field_format;

		// possible_values
		$this->possible_values = new cField('tbrdm_custom_fields', 'tbrdm_custom_fields', 'x_possible_values', 'possible_values', '[possible_values]', '[possible_values]', 201, -1, FALSE, '[possible_values]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['possible_values'] = &$this->possible_values;

		// min_length
		$this->min_length = new cField('tbrdm_custom_fields', 'tbrdm_custom_fields', 'x_min_length', 'min_length', '[min_length]', 'CAST([min_length] AS NVARCHAR)', 3, -1, FALSE, '[min_length]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->min_length->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['min_length'] = &$this->min_length;

		// max_length
		$this->max_length = new cField('tbrdm_custom_fields', 'tbrdm_custom_fields', 'x_max_length', 'max_length', '[max_length]', 'CAST([max_length] AS NVARCHAR)', 3, -1, FALSE, '[max_length]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->max_length->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['max_length'] = &$this->max_length;

		// default_value
		$this->default_value = new cField('tbrdm_custom_fields', 'tbrdm_custom_fields', 'x_default_value', 'default_value', '[default_value]', '[default_value]', 201, -1, FALSE, '[default_value]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['default_value'] = &$this->default_value;

		// editable
		$this->editable = new cField('tbrdm_custom_fields', 'tbrdm_custom_fields', 'x_editable', 'editable', '[editable]', 'CAST([editable] AS NVARCHAR)', 3, -1, FALSE, '[editable]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->editable->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
	...
	function SqlFrom() { // From
		return "[dbo].[tbrdm_custom_fields]";
	}
	...
	// Update Table
	var $UpdateTable = "[dbo].[tbrdm_custom_fields]";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "tbrdm_custom_fieldslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("tbrdm_custom_fieldsview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("tbrdm_custom_fieldsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "tbrdm_custom_fieldsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("tbrdm_custom_fieldsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("tbrdm_custom_fieldsadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tbrdm_custom_fieldsdelete.php", $this->UrlParm());
	}
