...
$riscoprojeto_edit = NULL; // Initialize page object first

class criscoprojeto_edit extends criscoprojeto {
	...
	// Page object name
	var $PageObjName = 'riscoprojeto_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->nu_riscoProjeto->CurrentValue == "")
			$this->Page_Terminate("riscoprojetolist.php"); // Invalid key, return to list
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->nu_riscoProjeto->FldIsDetailKey)
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// ds_risco
			$this->ds_risco->SetDbValueDef($rsnew, $this->ds_risco->CurrentValue, NULL, $this->ds_risco->ReadOnly);

			// ds_consequencia
			$this->ds_consequencia->SetDbValueDef($rsnew, $this->ds_consequencia->CurrentValue, NULL, $this->ds_consequencia->ReadOnly);
			...
			// ds_gatilho
			$this->ds_gatilho->SetDbValueDef($rsnew, $this->ds_gatilho->CurrentValue, NULL, $this->ds_gatilho->ReadOnly);

			// ds_respRisco
			$this->ds_respRisco->SetDbValueDef($rsnew, $this->ds_respRisco->CurrentValue, NULL, $this->ds_respRisco->ReadOnly);
...
// Create page object
if (!isset($riscoprojeto_edit)) $riscoprojeto_edit = new criscoprojeto_edit();

// Page init
$riscoprojeto_edit->Page_Init();

// Page main
$riscoprojeto_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$riscoprojeto_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var riscoprojeto_edit = new ew_Page("riscoprojeto_edit");
riscoprojeto_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = riscoprojeto_edit.PageID; // For backward compatibility

// Form object
var friscoprojetoedit = new ew_Form("friscoprojetoedit");

// Validate form
friscoprojetoedit.Validate = function() {
...
friscoprojetoedit.Form_CustomValidate = 
...
friscoprojetoedit.ValidateRequired = true;
<?php } else { ?>
friscoprojetoedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
friscoprojetoedit.Lists["x_nu_projeto"] = {"LinkField":"x_nu_projeto","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_projeto","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
friscoprojetoedit.Lists["x_nu_catRisco"] = {"LinkField":"x_nu_catRisco","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_catRisco","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
friscoprojetoedit.Lists["x_nu_probabilidade"] = {"LinkField":"x_nu_probOcoRisco","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_probOcoRisco","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
friscoprojetoedit.Lists["x_nu_impacto"] = {"LinkField":"x_nu_impactoRisco","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_impactoRisco","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
friscoprojetoedit.Lists["x_nu_acao"] = {"LinkField":"x_nu_acaoRisco","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_acaoRisco","","",""],"ParentFields":["x_ic_tpRisco"],"FilterFields":["x_ic_tpRisco"],"Options":[]};
friscoprojetoedit.Lists["x_nu_usuarioResp"] = {"LinkField":"x_nu_usuario","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_usuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $riscoprojeto_edit->ShowPageHeader(); ?>
<?php
$riscoprojeto_edit->ShowMessage();
?>
<form name="friscoprojetoedit" id="friscoprojetoedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="riscoprojeto">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_riscoprojetoedit" class="table table-bordered table-striped">
...
<input type="hidden" data-field="x_nu_riscoProjeto" name="x_nu_riscoProjeto" id="x_nu_riscoProjeto" value="<?php echo ew_HtmlEncode($riscoprojeto->nu_riscoProjeto->CurrentValue) ?>">
<?php echo $riscoprojeto->nu_riscoProjeto->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
friscoprojetoedit.Lists["x_nu_projeto"].Options = <?php echo (is_array($riscoprojeto->nu_projeto->EditValue)) ? ew_ArrayToJson($riscoprojeto->nu_projeto->EditValue, 1) : "[]" ?>;
</script>
<?php } ?>
...
<?php } ?>
<script type="text/javascript">
friscoprojetoedit.Lists["x_nu_catRisco"].Options = <?php echo (is_array($riscoprojeto->nu_catRisco->EditValue)) ? ew_ArrayToJson($riscoprojeto->nu_catRisco->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<?php } ?>
<script type="text/javascript">
friscoprojetoedit.Lists["x_nu_probabilidade"].Options = <?php echo (is_array($riscoprojeto->nu_probabilidade->EditValue)) ? ew_ArrayToJson($riscoprojeto->nu_probabilidade->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<?php } ?>
<script type="text/javascript">
friscoprojetoedit.Lists["x_nu_impacto"].Options = <?php echo (is_array($riscoprojeto->nu_impacto->EditValue)) ? ew_ArrayToJson($riscoprojeto->nu_impacto->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
friscoprojetoedit.Lists["x_nu_acao"].Options = <?php echo (is_array($riscoprojeto->nu_acao->EditValue)) ? ew_ArrayToJson($riscoprojeto->nu_acao->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
friscoprojetoedit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$riscoprojeto_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$riscoprojeto_edit->Page_Terminate();
?>
