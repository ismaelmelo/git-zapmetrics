...
$tbrdm_custom_fields_view = NULL; // Initialize page object first

class ctbrdm_custom_fields_view extends ctbrdm_custom_fields {
	...
	// Page object name
	var $PageObjName = 'tbrdm_custom_fields_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "tbrdm_custom_fieldslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tbrdm_custom_fieldslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "tbrdm_custom_fieldslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($tbrdm_custom_fields_view)) $tbrdm_custom_fields_view = new ctbrdm_custom_fields_view();

// Page init
$tbrdm_custom_fields_view->Page_Init();

// Page main
$tbrdm_custom_fields_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbrdm_custom_fields_view->Page_Render();
?>
...
// Page object
var tbrdm_custom_fields_view = new ew_Page("tbrdm_custom_fields_view");
tbrdm_custom_fields_view.PageID = "view"; // Page ID
var EW_PAGE_ID = tbrdm_custom_fields_view.PageID; // For backward compatibility

// Form object
var ftbrdm_custom_fieldsview = new ew_Form("ftbrdm_custom_fieldsview");

// Form_CustomValidate event
ftbrdm_custom_fieldsview.Form_CustomValidate = 
...
ftbrdm_custom_fieldsview.ValidateRequired = true;
<?php } else { ?>
ftbrdm_custom_fieldsview.ValidateRequired = false; 
<?php } ?>
...
<?php $tbrdm_custom_fields_view->ExportOptions->Render("body") ?>
<?php if (!$tbrdm_custom_fields_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($tbrdm_custom_fields_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $tbrdm_custom_fields_view->ShowPageHeader(); ?>
<?php
$tbrdm_custom_fields_view->ShowMessage();
?>
<form name="ftbrdm_custom_fieldsview" id="ftbrdm_custom_fieldsview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="tbrdm_custom_fields">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_tbrdm_custom_fieldsview" class="table table-bordered table-striped">
<?php if ($tbrdm_custom_fields->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_tbrdm_custom_fields_id"><?php echo $tbrdm_custom_fields->id->FldCaption() ?></span></td>
...
<?php echo $tbrdm_custom_fields->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_custom_fields->type->Visible) { // type ?>
	<tr id="r_type">
		<td><span id="elh_tbrdm_custom_fields_type"><?php echo $tbrdm_custom_fields->type->FldCaption() ?></span></td>
...
<?php echo $tbrdm_custom_fields->type->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_custom_fields->name->Visible) { // name ?>
	<tr id="r_name">
		<td><span id="elh_tbrdm_custom_fields_name"><?php echo $tbrdm_custom_fields->name->FldCaption() ?></span></td>
...
<?php echo $tbrdm_custom_fields->name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_custom_fields->field_format->Visible) { // field_format ?>
	<tr id="r_field_format">
		<td><span id="elh_tbrdm_custom_fields_field_format"><?php echo $tbrdm_custom_fields->field_format->FldCaption() ?></span></td>
...
<?php echo $tbrdm_custom_fields->field_format->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $tbrdm_custom_fields->possible_values->ViewAttributes() ?>>
<?php echo $tbrdm_custom_fields->possible_values->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_custom_fields->min_length->Visible) { // min_length ?>
	<tr id="r_min_length">
		<td><span id="elh_tbrdm_custom_fields_min_length"><?php echo $tbrdm_custom_fields->min_length->FldCaption() ?></span></td>
...
<?php echo $tbrdm_custom_fields->min_length->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_custom_fields->max_length->Visible) { // max_length ?>
	<tr id="r_max_length">
		<td><span id="elh_tbrdm_custom_fields_max_length"><?php echo $tbrdm_custom_fields->max_length->FldCaption() ?></span></td>
...
<?php echo $tbrdm_custom_fields->max_length->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $tbrdm_custom_fields->default_value->ViewAttributes() ?>>
<?php echo $tbrdm_custom_fields->default_value->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_custom_fields->editable->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ftbrdm_custom_fieldsview.Init();
</script>
<?php
$tbrdm_custom_fields_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($tbrdm_custom_fields->Export == "") { ?>
...
<?php
$tbrdm_custom_fields_view->Page_Terminate();
?>
