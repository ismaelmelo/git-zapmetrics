...
$tbrdm_projects_view = NULL; // Initialize page object first

class ctbrdm_projects_view extends ctbrdm_projects {
	...
	// Page object name
	var $PageObjName = 'tbrdm_projects_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "tbrdm_projectslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tbrdm_projectslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "tbrdm_projectslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_tbrdm_projects\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_tbrdm_projects',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.ftbrdm_projectsview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($tbrdm_projects_view)) $tbrdm_projects_view = new ctbrdm_projects_view();

// Page init
$tbrdm_projects_view->Page_Init();

// Page main
$tbrdm_projects_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbrdm_projects_view->Page_Render();
?>
...
// Page object
var tbrdm_projects_view = new ew_Page("tbrdm_projects_view");
tbrdm_projects_view.PageID = "view"; // Page ID
var EW_PAGE_ID = tbrdm_projects_view.PageID; // For backward compatibility

// Form object
var ftbrdm_projectsview = new ew_Form("ftbrdm_projectsview");

// Form_CustomValidate event
ftbrdm_projectsview.Form_CustomValidate = 
...
ftbrdm_projectsview.ValidateRequired = true;
<?php } else { ?>
ftbrdm_projectsview.ValidateRequired = false; 
<?php } ?>
...
<?php $tbrdm_projects_view->ExportOptions->Render("body") ?>
<?php if (!$tbrdm_projects_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($tbrdm_projects_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $tbrdm_projects_view->ShowPageHeader(); ?>
<?php
$tbrdm_projects_view->ShowMessage();
?>
<form name="ftbrdm_projectsview" id="ftbrdm_projectsview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="tbrdm_projects">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_tbrdm_projectsview" class="table table-bordered table-striped">
<?php if ($tbrdm_projects->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_tbrdm_projects_id"><?php echo $tbrdm_projects->id->FldCaption() ?></span></td>
...
<?php echo $tbrdm_projects->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_projects->name->Visible) { // name ?>
	<tr id="r_name">
		<td><span id="elh_tbrdm_projects_name"><?php echo $tbrdm_projects->name->FldCaption() ?></span></td>
...
<?php echo $tbrdm_projects->name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $tbrdm_projects->description->ViewAttributes() ?>>
<?php echo $tbrdm_projects->description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_projects->homepage->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_projects->is_public->Visible) { // is_public ?>
	<tr id="r_is_public">
		<td><span id="elh_tbrdm_projects_is_public"><?php echo $tbrdm_projects->is_public->FldCaption() ?></span></td>
...
<?php echo $tbrdm_projects->is_public->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_projects->parent_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_projects->created_on->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_projects->updated_on->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_projects->identifier->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_projects->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_tbrdm_projects_status"><?php echo $tbrdm_projects->status->FldCaption() ?></span></td>
...
<?php echo $tbrdm_projects->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ftbrdm_projectsview.Init();
</script>
<?php
$tbrdm_projects_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($tbrdm_projects->Export == "") { ?>
...
<?php
$tbrdm_projects_view->Page_Terminate();
?>
