...
$planoti_im_anexo_blobview = NULL; // Initialize page object first

class cplanoti_im_anexo_blobview extends cplanoti {
	...
	// Page object name
	var $PageObjName = 'planoti_im_anexo_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'planoti');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('planoti', 'x_im_anexo');
...
// Create page object
if (!isset($planoti_im_anexo_blobview)) $planoti_im_anexo_blobview = new cplanoti_im_anexo_blobview();

// Page init
$planoti_im_anexo_blobview->Page_Init();

// Page main
$planoti_im_anexo_blobview->Page_Main();
?>
<?php
$planoti_im_anexo_blobview->Page_Terminate();
?>
