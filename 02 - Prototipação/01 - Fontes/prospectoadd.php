...
$prospecto_add = NULL; // Initialize page object first

class cprospecto_add extends cprospecto {
	...
	function ValidateForm() {
		...
		if (in_array("prospecto_itempdti", $DetailTblVar) && $GLOBALS["prospecto_itempdti"]->DetailAdd) {
		...
		if (in_array("prospectoocorrencias", $DetailTblVar) && $GLOBALS["prospectoocorrencias"]->DetailAdd) {
	...
	function AddRow($rsold = NULL) {
		...
		if ($this->nu_prospecto->getSessionValue() <> "") {
			$rsnew['nu_prospecto'] = $this->nu_prospecto->getSessionValue();
		}
		...
		if ($AddRow) {
			$DetailTblVar = explode(",", $this->getCurrentDetailTable());
			if (in_array("prospecto_itempdti", $DetailTblVar) && $GLOBALS["prospecto_itempdti"]->DetailAdd) {
				$GLOBALS["prospecto_itempdti"]->nu_prospecto->setSessionValue($this->nu_prospecto->CurrentValue); // Set master key
				if (!isset($GLOBALS["prospecto_itempdti_grid"])) $GLOBALS["prospecto_itempdti_grid"] = new cprospecto_itempdti_grid(); // Get detail page object
				$AddRow = $GLOBALS["prospecto_itempdti_grid"]->GridInsert();
				if (!$AddRow)
					$GLOBALS["prospecto_itempdti"]->nu_prospecto->setSessionValue(""); // Clear master key if insert failed
			}
			if (in_array("prospectoocorrencias", $DetailTblVar) && $GLOBALS["prospectoocorrencias"]->DetailAdd) {
				$GLOBALS["prospectoocorrencias"]->nu_prospecto->setSessionValue($this->nu_prospecto->CurrentValue); // Set master key
				if (!isset($GLOBALS["prospectoocorrencias_grid"])) $GLOBALS["prospectoocorrencias_grid"] = new cprospectoocorrencias_grid(); // Get detail page object
				$AddRow = $GLOBALS["prospectoocorrencias_grid"]->GridInsert();
				if (!$AddRow)
					$GLOBALS["prospectoocorrencias"]->nu_prospecto->setSessionValue(""); // Clear master key if insert failed
			}
		}
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("prospecto_itempdti", $DetailTblVar)) {
				...
				if ($GLOBALS["prospecto_itempdti_grid"]->DetailAdd) {
					if ($this->CopyRecord)
						$GLOBALS["prospecto_itempdti_grid"]->CurrentMode = "copy";
					else
						$GLOBALS["prospecto_itempdti_grid"]->CurrentMode = "add";
					$GLOBALS["prospecto_itempdti_grid"]->CurrentAction = "gridadd";
			...
			if (in_array("prospectoocorrencias", $DetailTblVar)) {
				...
				if ($GLOBALS["prospectoocorrencias_grid"]->DetailAdd) {
					if ($this->CopyRecord)
						$GLOBALS["prospectoocorrencias_grid"]->CurrentMode = "copy";
					else
						$GLOBALS["prospectoocorrencias_grid"]->CurrentMode = "add";
					$GLOBALS["prospectoocorrencias_grid"]->CurrentAction = "gridadd";
...
// Create page object
if (!isset($prospecto_add)) $prospecto_add = new cprospecto_add();

// Page init
$prospecto_add->Page_Init();

// Page main
$prospecto_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$prospecto_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var prospecto_add = new ew_Page("prospecto_add");
prospecto_add.PageID = "add"; // Page ID
var EW_PAGE_ID = prospecto_add.PageID; // For backward compatibility

// Form object
var fprospectoadd = new ew_Form("fprospectoadd");

// Validate form
fprospectoadd.Validate = function() {
...
fprospectoadd.Form_CustomValidate = 
...
fprospectoadd.ValidateRequired = true;
<?php } else { ?>
fprospectoadd.ValidateRequired = false; 
<?php } ?>

// Multi-Page properties
fprospectoadd.MultiPage = new ew_MultiPage("fprospectoadd",
	[["x_no_prospecto",1],["x_nu_area",1],["x_no_solicitante",1],["x_no_patrocinador",1],["x_ar_entidade",1],["x_ar_nivel",1],["x_nu_categoriaProspecto",1],["x_nu_alternativaImpacto",1],["x_ds_sistemas",1],["x_ds_impactoNaoImplem",1],["x_nu_alternativaAlinhamento",2],["x_nu_alternativaAbrangencia",2],["x_nu_alternativaUrgencia",2],["x_dt_prazo",1],["x_nu_alternativaTmpEstimado",2],["x_nu_alternativaTmpFila",2],["x_ic_implicacaoLegal",2],["x_ic_risco",1],["x_ic_stProspecto",1],["x_ds_observacoes",1],["x_ic_ativo",1]]
);

// Dynamic selection lists
fprospectoadd.Lists["x_nu_area"] = {"LinkField":"x_nu_area","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_area","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fprospectoadd.Lists["x_ar_entidade[]"] = {"LinkField":"x_nu_organizacao","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_organizacao","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fprospectoadd.Lists["x_nu_categoriaProspecto"] = {"LinkField":"x_nu_categoria","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_categoria","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fprospectoadd.Lists["x_nu_alternativaImpacto"] = {"LinkField":"x_nu_alternativaAvaliacao","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fprospectoadd.Lists["x_nu_alternativaAlinhamento"] = {"LinkField":"x_nu_alternativaAvaliacao","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fprospectoadd.Lists["x_nu_alternativaAbrangencia"] = {"LinkField":"x_nu_alternativaAvaliacao","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fprospectoadd.Lists["x_nu_alternativaUrgencia"] = {"LinkField":"x_nu_alternativaAvaliacao","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fprospectoadd.Lists["x_nu_alternativaTmpEstimado"] = {"LinkField":"x_nu_alternativaAvaliacao","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fprospectoadd.Lists["x_nu_alternativaTmpFila"] = {"LinkField":"x_nu_alternativaAvaliacao","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $prospecto_add->ShowPageHeader(); ?>
<?php
$prospecto_add->ShowMessage();
?>
<form name="fprospectoadd" id="fprospectoadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="prospecto">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewStdTable"><tbody><tr><td>
<div class="tabbable" id="prospecto_add">
...
<table id="tbl_prospectoadd1" class="table table-bordered table-striped">
...
<script type="text/javascript">
fprospectoadd.Lists["x_nu_area"].Options = <?php echo (is_array($prospecto->nu_area->EditValue)) ? ew_ArrayToJson($prospecto->nu_area->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fprospectoadd.Lists["x_ar_entidade[]"].Options = <?php echo (is_array($prospecto->ar_entidade->EditValue)) ? ew_ArrayToJson($prospecto->ar_entidade->EditValue, 0) : "[]" ?>;
</script>
</span>
...
<?php } ?>
<script type="text/javascript">
fprospectoadd.Lists["x_nu_categoriaProspecto"].Options = <?php echo (is_array($prospecto->nu_categoriaProspecto->EditValue)) ? ew_ArrayToJson($prospecto->nu_categoriaProspecto->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fprospectoadd.Lists["x_nu_alternativaImpacto"].Options = <?php echo (is_array($prospecto->nu_alternativaImpacto->EditValue)) ? ew_ArrayToJson($prospecto->nu_alternativaImpacto->EditValue, 1) : "[]" ?>;
</script>
</span>
...
ew_CreateCalendar("fprospectoadd", "x_dt_prazo", "%d/%m/%Y");
</script>
<?php } ?>
</span>
...
<table cellspacing="0" class="ewGrid" style="width: 100%"><tr><td>
<table id="tbl_prospectoadd2" class="table table-bordered table-striped">
...
<script type="text/javascript">
fprospectoadd.Lists["x_nu_alternativaAlinhamento"].Options = <?php echo (is_array($prospecto->nu_alternativaAlinhamento->EditValue)) ? ew_ArrayToJson($prospecto->nu_alternativaAlinhamento->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fprospectoadd.Lists["x_nu_alternativaAbrangencia"].Options = <?php echo (is_array($prospecto->nu_alternativaAbrangencia->EditValue)) ? ew_ArrayToJson($prospecto->nu_alternativaAbrangencia->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fprospectoadd.Lists["x_nu_alternativaUrgencia"].Options = <?php echo (is_array($prospecto->nu_alternativaUrgencia->EditValue)) ? ew_ArrayToJson($prospecto->nu_alternativaUrgencia->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fprospectoadd.Lists["x_nu_alternativaTmpEstimado"].Options = <?php echo (is_array($prospecto->nu_alternativaTmpEstimado->EditValue)) ? ew_ArrayToJson($prospecto->nu_alternativaTmpEstimado->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fprospectoadd.Lists["x_nu_alternativaTmpFila"].Options = <?php echo (is_array($prospecto->nu_alternativaTmpFila->EditValue)) ? ew_ArrayToJson($prospecto->nu_alternativaTmpFila->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<?php if (strval($prospecto->nu_prospecto->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_nu_prospecto" id="x_nu_prospecto" value="<?php echo ew_HtmlEncode(strval($prospecto->nu_prospecto->getSessionValue())) ?>">
<?php } ?>
<?php
	if (in_array("prospecto_itempdti", explode(",", $prospecto->getCurrentDetailTable())) && $prospecto_itempdti->DetailAdd) {
?>
<?php include_once "prospecto_itempdtigrid.php" ?>
<?php } ?>
<?php
	if (in_array("prospectoocorrencias", explode(",", $prospecto->getCurrentDetailTable())) && $prospectoocorrencias->DetailAdd) {
?>
