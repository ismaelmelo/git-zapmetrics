...
$gpcomite_im_anexoParecerJuridico_blobview = NULL; // Initialize page object first

class cgpcomite_im_anexoParecerJuridico_blobview extends cgpcomite {
	...
	// Page object name
	var $PageObjName = 'gpcomite_im_anexoParecerJuridico_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'gpcomite');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('gpcomite', 'x_im_anexoParecerJuridico');
		...
		if ($this->Recordset = $conn->Execute($sSql)) {
			if (!$this->Recordset->EOF) {
				if (!EW_DEBUG_ENABLED && ob_get_length())
					ob_end_clean();
				$objBinary->Value = $this->Recordset->fields('im_anexoParecerJuridico');
				...
				if (trim(strval($this->Recordset->fields('im_anexoParecerJuridico'))) <> "") {
					header("Content-Disposition: attachment; filename=\"" . $this->Recordset->fields('im_anexoParecerJuridico') . "\"");
				}
...
// Create page object
if (!isset($gpcomite_im_anexoParecerJuridico_blobview)) $gpcomite_im_anexoParecerJuridico_blobview = new cgpcomite_im_anexoParecerJuridico_blobview();

// Page init
$gpcomite_im_anexoParecerJuridico_blobview->Page_Init();

// Page main
$gpcomite_im_anexoParecerJuridico_blobview->Page_Main();
?>
<?php
$gpcomite_im_anexoParecerJuridico_blobview->Page_Terminate();
?>
