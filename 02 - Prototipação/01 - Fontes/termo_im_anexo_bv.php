...
$termo_im_anexo_blobview = NULL; // Initialize page object first

class ctermo_im_anexo_blobview extends ctermo {
	...
	// Page object name
	var $PageObjName = 'termo_im_anexo_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'termo');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('termo', 'x_im_anexo');
...
// Create page object
if (!isset($termo_im_anexo_blobview)) $termo_im_anexo_blobview = new ctermo_im_anexo_blobview();

// Page init
$termo_im_anexo_blobview->Page_Init();

// Page main
$termo_im_anexo_blobview->Page_Main();
?>
<?php
$termo_im_anexo_blobview->Page_Terminate();
?>
