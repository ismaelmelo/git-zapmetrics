...
class cusuario_view extends cusuario {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["nu_usuario"] <> "") {
			$this->RecKey["nu_usuario"] = $_GET["nu_usuario"];
			$KeyUrl .= "&nu_usuario=" . urlencode($this->RecKey["nu_usuario"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["nu_usuario"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["nu_usuario"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["nu_usuario"] <> "") {
				...
				$this->RecKey["nu_usuario"] = $this->nu_usuario->QueryStringValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->Page_Terminate("usuariolist.php"); // Return to list page
						...
						while (!$this->Recordset->EOF) {
							if (strval($this->nu_usuario->CurrentValue) == strval($this->Recordset->fields('nu_usuario'))) {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_usuario\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_usuario',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fusuarioview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
fusuarioview.Lists["x_nu_pessoa"] = {"LinkField":"x_nu_pessoa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_pessoa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fusuarioview.Lists["x_nu_usuarioRedmine"] = {"LinkField":"x_id","Ajax":null,"AutoFill":false,"DisplayFields":["x__login","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fusuarioview.Lists["x_nu_perfil"] = {"LinkField":"x_nu_level","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_level","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fusuarioview.Lists["x_nu_stUsuario"] = {"LinkField":"x_nu_stUsuario","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_stUsuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if (!$usuario_view->ExportOptions->UseDropDownButton) { ?>
</div>
...
?>
<form name="fusuarioview" id="fusuarioview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="usuario">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_usuarioview" class="table table-bordered table-striped">
<?php if ($usuario->nu_pessoa->Visible) { // nu_pessoa ?>
	<tr id="r_nu_pessoa">
		<td><span id="elh_usuario_nu_pessoa"><?php echo $usuario->nu_pessoa->FldCaption() ?></span></td>
		<td<?php echo $usuario->nu_pessoa->CellAttributes() ?>>
<span id="el_usuario_nu_pessoa" class="control-group">
<span<?php echo $usuario->nu_pessoa->ViewAttributes() ?>>
<?php echo $usuario->nu_pessoa->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($usuario->nu_usuarioRedmine->Visible) { // nu_usuarioRedmine ?>
	<tr id="r_nu_usuarioRedmine">
		<td><span id="elh_usuario_nu_usuarioRedmine"><?php echo $usuario->nu_usuarioRedmine->FldCaption() ?></span></td>
		<td<?php echo $usuario->nu_usuarioRedmine->CellAttributes() ?>>
<span id="el_usuario_nu_usuarioRedmine" class="control-group">
<span<?php echo $usuario->nu_usuarioRedmine->ViewAttributes() ?>>
<?php echo $usuario->nu_usuarioRedmine->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($usuario->no_usuario->Visible) { // no_usuario ?>
	<tr id="r_no_usuario">
		<td><span id="elh_usuario_no_usuario"><?php echo $usuario->no_usuario->FldCaption() ?></span></td>
...
<?php echo $usuario->no_usuario->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($usuario->no_login->Visible) { // no_login ?>
	<tr id="r_no_login">
		<td><span id="elh_usuario_no_login"><?php echo $usuario->no_login->FldCaption() ?></span></td>
...
<?php echo $usuario->no_login->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($usuario->no_senha->Visible) { // no_senha ?>
	<tr id="r_no_senha">
		<td><span id="elh_usuario_no_senha"><?php echo $usuario->no_senha->FldCaption() ?></span></td>
		<td<?php echo $usuario->no_senha->CellAttributes() ?>>
<span id="el_usuario_no_senha" class="control-group">
<span<?php echo $usuario->no_senha->ViewAttributes() ?>>
<?php echo $usuario->no_senha->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($usuario->no_email->Visible) { // no_email ?>
	<tr id="r_no_email">
		<td><span id="elh_usuario_no_email"><?php echo $usuario->no_email->FldCaption() ?></span></td>
...
<?php echo $usuario->no_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($usuario->nu_perfil->Visible) { // nu_perfil ?>
	<tr id="r_nu_perfil">
		<td><span id="elh_usuario_nu_perfil"><?php echo $usuario->nu_perfil->FldCaption() ?></span></td>
...
<?php echo $usuario->nu_perfil->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($usuario->nu_stUsuario->Visible) { // nu_stUsuario ?>
	<tr id="r_nu_stUsuario">
		<td><span id="elh_usuario_nu_stUsuario"><?php echo $usuario->nu_stUsuario->FldCaption() ?></span></td>
...
<?php echo $usuario->nu_stUsuario->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<table class="ewPager">
<tr><td>
<?php if (!isset($usuario_view->Pager)) $usuario_view->Pager = new cNumericPager($usuario_view->StartRec, $usuario_view->DisplayRecs, $usuario_view->TotalRecs, $usuario_view->RecRange) ?>
<?php if ($usuario_view->Pager->RecordCount > 0) { ?>
<table cellspacing="0" class="ewStdTable"><tbody><tr><td>
<div class="pagination"><ul>
	<?php if ($usuario_view->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $usuario_view->PageUrl() ?>start=<?php echo $usuario_view->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($usuario_view->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $usuario_view->PageUrl() ?>start=<?php echo $usuario_view->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($usuario_view->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $usuario_view->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($usuario_view->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $usuario_view->PageUrl() ?>start=<?php echo $usuario_view->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($usuario_view->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $usuario_view->PageUrl() ?>start=<?php echo $usuario_view->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</td>
</tr></tbody></table>
