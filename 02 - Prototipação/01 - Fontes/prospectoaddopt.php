...
$prospecto_addopt = NULL; // Initialize page object first

class cprospecto_addopt extends cprospecto {
	...
	// Page object name
	var $PageObjName = 'prospecto_addopt';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow()) { // Add successful
					...
					$row["x_no_prospecto"] = $this->no_prospecto->DbValue;
					$row["x_nu_area"] = $this->nu_area->DbValue;
					$row["x_no_solicitante"] = $this->no_solicitante->DbValue;
					$row["x_no_patrocinador"] = $this->no_patrocinador->DbValue;
					$row["x_ar_entidade"] = $this->ar_entidade->DbValue;
					$row["x_ar_nivel"] = $this->ar_nivel->DbValue;
					$row["x_nu_categoriaProspecto"] = $this->nu_categoriaProspecto->DbValue;
					$row["x_nu_alternativaImpacto"] = $this->nu_alternativaImpacto->DbValue;
					$row["x_ds_sistemas"] = $this->ds_sistemas->DbValue;
					$row["x_ds_impactoNaoImplem"] = $this->ds_impactoNaoImplem->DbValue;
					$row["x_nu_alternativaAlinhamento"] = $this->nu_alternativaAlinhamento->DbValue;
					$row["x_nu_alternativaAbrangencia"] = $this->nu_alternativaAbrangencia->DbValue;
					$row["x_nu_alternativaUrgencia"] = $this->nu_alternativaUrgencia->DbValue;
					$row["x_dt_prazo"] = $this->dt_prazo->DbValue;
					$row["x_nu_alternativaTmpEstimado"] = $this->nu_alternativaTmpEstimado->DbValue;
					$row["x_nu_alternativaTmpFila"] = $this->nu_alternativaTmpFila->DbValue;
					$row["x_ic_implicacaoLegal"] = $this->ic_implicacaoLegal->DbValue;
					$row["x_ic_risco"] = $this->ic_risco->DbValue;
					$row["x_ic_stProspecto"] = $this->ic_stProspecto->DbValue;
					$row["x_ds_observacoes"] = $this->ds_observacoes->DbValue;
	...
	function LoadDefaultValues() {
		...
		$this->no_solicitante->CurrentValue = NULL;
		$this->no_solicitante->OldValue = $this->no_solicitante->CurrentValue;
		$this->no_patrocinador->CurrentValue = NULL;
		$this->no_patrocinador->OldValue = $this->no_patrocinador->CurrentValue;
		$this->ar_entidade->CurrentValue = NULL;
		$this->ar_entidade->OldValue = $this->ar_entidade->CurrentValue;
		$this->ar_nivel->CurrentValue = NULL;
		$this->ar_nivel->OldValue = $this->ar_nivel->CurrentValue;
		$this->nu_categoriaProspecto->CurrentValue = NULL;
		$this->nu_categoriaProspecto->OldValue = $this->nu_categoriaProspecto->CurrentValue;
		$this->nu_alternativaImpacto->CurrentValue = NULL;
		$this->nu_alternativaImpacto->OldValue = $this->nu_alternativaImpacto->CurrentValue;
		$this->ds_sistemas->CurrentValue = NULL;
		$this->ds_sistemas->OldValue = $this->ds_sistemas->CurrentValue;
		$this->ds_impactoNaoImplem->CurrentValue = NULL;
		$this->ds_impactoNaoImplem->OldValue = $this->ds_impactoNaoImplem->CurrentValue;
		$this->nu_alternativaAlinhamento->CurrentValue = NULL;
		$this->nu_alternativaAlinhamento->OldValue = $this->nu_alternativaAlinhamento->CurrentValue;
		$this->nu_alternativaAbrangencia->CurrentValue = NULL;
		$this->nu_alternativaAbrangencia->OldValue = $this->nu_alternativaAbrangencia->CurrentValue;
		$this->nu_alternativaUrgencia->CurrentValue = NULL;
		$this->nu_alternativaUrgencia->OldValue = $this->nu_alternativaUrgencia->CurrentValue;
		$this->dt_prazo->CurrentValue = NULL;
		$this->dt_prazo->OldValue = $this->dt_prazo->CurrentValue;
		$this->nu_alternativaTmpEstimado->CurrentValue = NULL;
		$this->nu_alternativaTmpEstimado->OldValue = $this->nu_alternativaTmpEstimado->CurrentValue;
		$this->nu_alternativaTmpFila->CurrentValue = NULL;
		$this->nu_alternativaTmpFila->OldValue = $this->nu_alternativaTmpFila->CurrentValue;
		$this->ic_implicacaoLegal->CurrentValue = "N";
		$this->ic_risco->CurrentValue = NULL;
		$this->ic_risco->OldValue = $this->ic_risco->CurrentValue;
	...
	function LoadFormValues() {
		...
		if (!$this->no_prospecto->FldIsDetailKey) {
			$this->no_prospecto->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_no_prospecto")));
		}
		...
		if (!$this->no_solicitante->FldIsDetailKey) {
			$this->no_solicitante->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_no_solicitante")));
		}
		if (!$this->no_patrocinador->FldIsDetailKey) {
			$this->no_patrocinador->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_no_patrocinador")));
		}
		if (!$this->ar_entidade->FldIsDetailKey) {
			$this->ar_entidade->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_ar_entidade")));
		}
		if (!$this->ar_nivel->FldIsDetailKey) {
			$this->ar_nivel->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_ar_nivel")));
		}
		if (!$this->nu_categoriaProspecto->FldIsDetailKey) {
			$this->nu_categoriaProspecto->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_nu_categoriaProspecto")));
		}
		if (!$this->nu_alternativaImpacto->FldIsDetailKey) {
			$this->nu_alternativaImpacto->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_nu_alternativaImpacto")));
		}
		if (!$this->ds_sistemas->FldIsDetailKey) {
			$this->ds_sistemas->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_ds_sistemas")));
		}
		if (!$this->ds_impactoNaoImplem->FldIsDetailKey) {
			$this->ds_impactoNaoImplem->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_ds_impactoNaoImplem")));
		}
		if (!$this->nu_alternativaAlinhamento->FldIsDetailKey) {
			$this->nu_alternativaAlinhamento->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_nu_alternativaAlinhamento")));
		}
		if (!$this->nu_alternativaAbrangencia->FldIsDetailKey) {
			$this->nu_alternativaAbrangencia->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_nu_alternativaAbrangencia")));
		}
		if (!$this->nu_alternativaUrgencia->FldIsDetailKey) {
			$this->nu_alternativaUrgencia->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_nu_alternativaUrgencia")));
		}
		if (!$this->dt_prazo->FldIsDetailKey) {
			$this->dt_prazo->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_dt_prazo")));
		...
		if (!$this->nu_alternativaTmpEstimado->FldIsDetailKey) {
			$this->nu_alternativaTmpEstimado->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_nu_alternativaTmpEstimado")));
		}
		if (!$this->nu_alternativaTmpFila->FldIsDetailKey) {
			$this->nu_alternativaTmpFila->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_nu_alternativaTmpFila")));
		}
		if (!$this->ic_implicacaoLegal->FldIsDetailKey) {
			$this->ic_implicacaoLegal->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_ic_implicacaoLegal")));
		}
		if (!$this->ic_risco->FldIsDetailKey) {
			$this->ic_risco->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_ic_risco")));
		}
		if (!$this->ic_stProspecto->FldIsDetailKey) {
			$this->ic_stProspecto->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_ic_stProspecto")));
		}
		if (!$this->ds_observacoes->FldIsDetailKey) {
			$this->ds_observacoes->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_ds_observacoes")));
		}
	...
	function RestoreFormValues() {
		global $objForm;
		$this->no_prospecto->CurrentValue = ew_ConvertToUtf8($this->no_prospecto->FormValue);
		$this->nu_area->CurrentValue = ew_ConvertToUtf8($this->nu_area->FormValue);
		$this->no_solicitante->CurrentValue = ew_ConvertToUtf8($this->no_solicitante->FormValue);
		$this->no_patrocinador->CurrentValue = ew_ConvertToUtf8($this->no_patrocinador->FormValue);
		$this->ar_entidade->CurrentValue = ew_ConvertToUtf8($this->ar_entidade->FormValue);
		$this->ar_nivel->CurrentValue = ew_ConvertToUtf8($this->ar_nivel->FormValue);
		$this->nu_categoriaProspecto->CurrentValue = ew_ConvertToUtf8($this->nu_categoriaProspecto->FormValue);
		$this->nu_alternativaImpacto->CurrentValue = ew_ConvertToUtf8($this->nu_alternativaImpacto->FormValue);
		$this->ds_sistemas->CurrentValue = ew_ConvertToUtf8($this->ds_sistemas->FormValue);
		$this->ds_impactoNaoImplem->CurrentValue = ew_ConvertToUtf8($this->ds_impactoNaoImplem->FormValue);
		$this->nu_alternativaAlinhamento->CurrentValue = ew_ConvertToUtf8($this->nu_alternativaAlinhamento->FormValue);
		$this->nu_alternativaAbrangencia->CurrentValue = ew_ConvertToUtf8($this->nu_alternativaAbrangencia->FormValue);
		$this->nu_alternativaUrgencia->CurrentValue = ew_ConvertToUtf8($this->nu_alternativaUrgencia->FormValue);
		$this->dt_prazo->CurrentValue = ew_ConvertToUtf8($this->dt_prazo->FormValue);
		$this->dt_prazo->CurrentValue = ew_UnFormatDateTime($this->dt_prazo->CurrentValue, 7);
		$this->nu_alternativaTmpEstimado->CurrentValue = ew_ConvertToUtf8($this->nu_alternativaTmpEstimado->FormValue);
		$this->nu_alternativaTmpFila->CurrentValue = ew_ConvertToUtf8($this->nu_alternativaTmpFila->FormValue);
		$this->ic_implicacaoLegal->CurrentValue = ew_ConvertToUtf8($this->ic_implicacaoLegal->FormValue);
		$this->ic_risco->CurrentValue = ew_ConvertToUtf8($this->ic_risco->FormValue);
		$this->ic_stProspecto->CurrentValue = ew_ConvertToUtf8($this->ic_stProspecto->FormValue);
		$this->ds_observacoes->CurrentValue = ew_ConvertToUtf8($this->ds_observacoes->FormValue);
	...
	function AddRow($rsold = NULL) {
		...
		// no_solicitante
		$this->no_solicitante->SetDbValueDef($rsnew, $this->no_solicitante->CurrentValue, NULL, FALSE);

		// no_patrocinador
		$this->no_patrocinador->SetDbValueDef($rsnew, $this->no_patrocinador->CurrentValue, NULL, FALSE);

		// ar_entidade
		$this->ar_entidade->SetDbValueDef($rsnew, $this->ar_entidade->CurrentValue, NULL, FALSE);

		// ar_nivel
		$this->ar_nivel->SetDbValueDef($rsnew, $this->ar_nivel->CurrentValue, NULL, FALSE);

		// nu_categoriaProspecto
		$this->nu_categoriaProspecto->SetDbValueDef($rsnew, $this->nu_categoriaProspecto->CurrentValue, NULL, FALSE);

		// nu_alternativaImpacto
		$this->nu_alternativaImpacto->SetDbValueDef($rsnew, $this->nu_alternativaImpacto->CurrentValue, NULL, FALSE);

		// ds_sistemas
		$this->ds_sistemas->SetDbValueDef($rsnew, $this->ds_sistemas->CurrentValue, NULL, FALSE);

		// ds_impactoNaoImplem
		$this->ds_impactoNaoImplem->SetDbValueDef($rsnew, $this->ds_impactoNaoImplem->CurrentValue, NULL, FALSE);

		// nu_alternativaAlinhamento
		$this->nu_alternativaAlinhamento->SetDbValueDef($rsnew, $this->nu_alternativaAlinhamento->CurrentValue, NULL, FALSE);

		// nu_alternativaAbrangencia
		$this->nu_alternativaAbrangencia->SetDbValueDef($rsnew, $this->nu_alternativaAbrangencia->CurrentValue, NULL, FALSE);

		// nu_alternativaUrgencia
		$this->nu_alternativaUrgencia->SetDbValueDef($rsnew, $this->nu_alternativaUrgencia->CurrentValue, NULL, FALSE);

		// dt_prazo
		$this->dt_prazo->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->dt_prazo->CurrentValue, 7), NULL, FALSE);

		// nu_alternativaTmpEstimado
		$this->nu_alternativaTmpEstimado->SetDbValueDef($rsnew, $this->nu_alternativaTmpEstimado->CurrentValue, NULL, FALSE);

		// nu_alternativaTmpFila
		$this->nu_alternativaTmpFila->SetDbValueDef($rsnew, $this->nu_alternativaTmpFila->CurrentValue, NULL, FALSE);

		// ic_implicacaoLegal
		$this->ic_implicacaoLegal->SetDbValueDef($rsnew, $this->ic_implicacaoLegal->CurrentValue, NULL, FALSE);

		// ic_risco
		$this->ic_risco->SetDbValueDef($rsnew, $this->ic_risco->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($prospecto_addopt)) $prospecto_addopt = new cprospecto_addopt();

// Page init
$prospecto_addopt->Page_Init();

// Page main
$prospecto_addopt->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$prospecto_addopt->Page_Render();
?>
<script type="text/javascript">

// Page object
var prospecto_addopt = new ew_Page("prospecto_addopt");
prospecto_addopt.PageID = "addopt"; // Page ID
var EW_PAGE_ID = prospecto_addopt.PageID; // For backward compatibility

// Form object
var fprospectoaddopt = new ew_Form("fprospectoaddopt");

// Validate form
fprospectoaddopt.Validate = function() {
...
fprospectoaddopt.Form_CustomValidate = 
...
fprospectoaddopt.ValidateRequired = true;
<?php } else { ?>
fprospectoaddopt.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fprospectoaddopt.Lists["x_nu_area"] = {"LinkField":"x_nu_area","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_area","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fprospectoaddopt.Lists["x_ar_entidade[]"] = {"LinkField":"x_nu_organizacao","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_organizacao","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fprospectoaddopt.Lists["x_nu_categoriaProspecto"] = {"LinkField":"x_nu_categoria","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_categoria","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fprospectoaddopt.Lists["x_nu_alternativaImpacto"] = {"LinkField":"x_nu_alternativaAvaliacao","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fprospectoaddopt.Lists["x_nu_alternativaAlinhamento"] = {"LinkField":"x_nu_alternativaAvaliacao","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fprospectoaddopt.Lists["x_nu_alternativaAbrangencia"] = {"LinkField":"x_nu_alternativaAvaliacao","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fprospectoaddopt.Lists["x_nu_alternativaUrgencia"] = {"LinkField":"x_nu_alternativaAvaliacao","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fprospectoaddopt.Lists["x_nu_alternativaTmpEstimado"] = {"LinkField":"x_nu_alternativaAvaliacao","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fprospectoaddopt.Lists["x_nu_alternativaTmpFila"] = {"LinkField":"x_nu_alternativaAvaliacao","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php
$prospecto_addopt->ShowMessage();
?>
<form name="fprospectoaddopt" id="fprospectoaddopt" class="ewForm form-horizontal" action="prospectoaddopt.php" method="post">
<input type="hidden" name="t" value="prospecto">
<input type="hidden" name="a_addopt" id="a_addopt" value="A">
<div id="tbl_prospectoaddopt">
	<div class="control-group">
		<label class="control-label" for="x_no_prospecto"><?php echo $prospecto->no_prospecto->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="controls">
<input type="text" data-field="x_no_prospecto" name="x_no_prospecto" id="x_no_prospecto" size="75" maxlength="120" placeholder="<?php echo $prospecto->no_prospecto->PlaceHolder ?>" value="<?php echo $prospecto->no_prospecto->EditValue ?>"<?php echo $prospecto->no_prospecto->EditAttributes() ?>>
	...
	<div class="control-group">
		<label class="control-label" for="x_nu_area"><?php echo $prospecto->nu_area->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="controls">
...
<script type="text/javascript">
fprospectoaddopt.Lists["x_nu_area"].Options = <?php echo (is_array($prospecto->nu_area->EditValue)) ? ew_ArrayToJson($prospecto->nu_area->EditValue, 1) : "[]" ?>;
</script>
</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="x_no_solicitante"><?php echo $prospecto->no_solicitante->FldCaption() ?></label>
		<div class="controls">
<input type="text" data-field="x_no_solicitante" name="x_no_solicitante" id="x_no_solicitante" size="75" maxlength="120" placeholder="<?php echo $prospecto->no_solicitante->PlaceHolder ?>" value="<?php echo $prospecto->no_solicitante->EditValue ?>"<?php echo $prospecto->no_solicitante->EditAttributes() ?>>
	...
	<div class="control-group">
		<label class="control-label" for="x_no_patrocinador"><?php echo $prospecto->no_patrocinador->FldCaption() ?></label>
		<div class="controls">
<input type="text" data-field="x_no_patrocinador" name="x_no_patrocinador" id="x_no_patrocinador" size="75" maxlength="120" placeholder="<?php echo $prospecto->no_patrocinador->PlaceHolder ?>" value="<?php echo $prospecto->no_patrocinador->EditValue ?>"<?php echo $prospecto->no_patrocinador->EditAttributes() ?>>
	...
	<div class="control-group">
		<label class="control-label" for="x_ar_entidade"><?php echo $prospecto->ar_entidade->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="controls">
...
<script type="text/javascript">
fprospectoaddopt.Lists["x_ar_entidade[]"].Options = <?php echo (is_array($prospecto->ar_entidade->EditValue)) ? ew_ArrayToJson($prospecto->ar_entidade->EditValue, 0) : "[]" ?>;
</script>
</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="x_ar_nivel"><?php echo $prospecto->ar_nivel->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="controls">
...
?>
	...
	<div class="control-group">
		<label class="control-label" for="x_nu_categoriaProspecto"><?php echo $prospecto->nu_categoriaProspecto->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="controls">
...
<script type="text/javascript">
fprospectoaddopt.Lists["x_nu_categoriaProspecto"].Options = <?php echo (is_array($prospecto->nu_categoriaProspecto->EditValue)) ? ew_ArrayToJson($prospecto->nu_categoriaProspecto->EditValue, 1) : "[]" ?>;
</script>
</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="x_nu_alternativaImpacto"><?php echo $prospecto->nu_alternativaImpacto->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="controls">
...
<script type="text/javascript">
fprospectoaddopt.Lists["x_nu_alternativaImpacto"].Options = <?php echo (is_array($prospecto->nu_alternativaImpacto->EditValue)) ? ew_ArrayToJson($prospecto->nu_alternativaImpacto->EditValue, 1) : "[]" ?>;
</script>
</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="x_ds_sistemas"><?php echo $prospecto->ds_sistemas->FldCaption() ?></label>
		<div class="controls">
<textarea data-field="x_ds_sistemas" name="x_ds_sistemas" id="x_ds_sistemas" cols="35" rows="4" placeholder="<?php echo $prospecto->ds_sistemas->PlaceHolder ?>"<?php echo $prospecto->ds_sistemas->EditAttributes() ?>><?php echo $prospecto->ds_sistemas->EditValue ?></textarea>
	...
	<div class="control-group">
		<label class="control-label" for="x_ds_impactoNaoImplem"><?php echo $prospecto->ds_impactoNaoImplem->FldCaption() ?></label>
		<div class="controls">
<textarea data-field="x_ds_impactoNaoImplem" name="x_ds_impactoNaoImplem" id="x_ds_impactoNaoImplem" cols="35" rows="4" placeholder="<?php echo $prospecto->ds_impactoNaoImplem->PlaceHolder ?>"<?php echo $prospecto->ds_impactoNaoImplem->EditAttributes() ?>><?php echo $prospecto->ds_impactoNaoImplem->EditValue ?></textarea>
	...
	<div class="control-group">
		<label class="control-label" for="x_nu_alternativaAlinhamento"><?php echo $prospecto->nu_alternativaAlinhamento->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="controls">
...
<script type="text/javascript">
fprospectoaddopt.Lists["x_nu_alternativaAlinhamento"].Options = <?php echo (is_array($prospecto->nu_alternativaAlinhamento->EditValue)) ? ew_ArrayToJson($prospecto->nu_alternativaAlinhamento->EditValue, 1) : "[]" ?>;
</script>
</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="x_nu_alternativaAbrangencia"><?php echo $prospecto->nu_alternativaAbrangencia->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="controls">
...
<script type="text/javascript">
fprospectoaddopt.Lists["x_nu_alternativaAbrangencia"].Options = <?php echo (is_array($prospecto->nu_alternativaAbrangencia->EditValue)) ? ew_ArrayToJson($prospecto->nu_alternativaAbrangencia->EditValue, 1) : "[]" ?>;
</script>
</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="x_nu_alternativaUrgencia"><?php echo $prospecto->nu_alternativaUrgencia->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="controls">
...
<script type="text/javascript">
fprospectoaddopt.Lists["x_nu_alternativaUrgencia"].Options = <?php echo (is_array($prospecto->nu_alternativaUrgencia->EditValue)) ? ew_ArrayToJson($prospecto->nu_alternativaUrgencia->EditValue, 1) : "[]" ?>;
</script>
</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="x_dt_prazo"><?php echo $prospecto->dt_prazo->FldCaption() ?></label>
		<div class="controls">
...
ew_CreateCalendar("fprospectoaddopt", "x_dt_prazo", "%d/%m/%Y");
</script>
<?php } ?>
</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="x_nu_alternativaTmpEstimado"><?php echo $prospecto->nu_alternativaTmpEstimado->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="controls">
...
<script type="text/javascript">
fprospectoaddopt.Lists["x_nu_alternativaTmpEstimado"].Options = <?php echo (is_array($prospecto->nu_alternativaTmpEstimado->EditValue)) ? ew_ArrayToJson($prospecto->nu_alternativaTmpEstimado->EditValue, 1) : "[]" ?>;
</script>
</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="x_nu_alternativaTmpFila"><?php echo $prospecto->nu_alternativaTmpFila->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="controls">
...
<script type="text/javascript">
fprospectoaddopt.Lists["x_nu_alternativaTmpFila"].Options = <?php echo (is_array($prospecto->nu_alternativaTmpFila->EditValue)) ? ew_ArrayToJson($prospecto->nu_alternativaTmpFila->EditValue, 1) : "[]" ?>;
</script>
</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="x_ic_implicacaoLegal"><?php echo $prospecto->ic_implicacaoLegal->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="controls">
...
?>
	...
	<div class="control-group">
		<label class="control-label" for="x_ic_risco"><?php echo $prospecto->ic_risco->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="controls">
...
?>
	...
	<div class="control-group">
		<label class="control-label" for="x_ic_stProspecto"><?php echo $prospecto->ic_stProspecto->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="controls">
...
?>
	...
	<div class="control-group">
		<label class="control-label" for="x_ds_observacoes"><?php echo $prospecto->ds_observacoes->FldCaption() ?></label>
		<div class="controls">
<textarea data-field="x_ds_observacoes" name="x_ds_observacoes" id="x_ds_observacoes" cols="75" rows="4" placeholder="<?php echo $prospecto->ds_observacoes->PlaceHolder ?>"<?php echo $prospecto->ds_observacoes->EditAttributes() ?>><?php echo $prospecto->ds_observacoes->EditValue ?></textarea>
	...
	<div class="control-group">
		<label class="control-label" for="x_ic_ativo"><?php echo $prospecto->ic_ativo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="controls">
...
<?php
$prospecto_addopt->Page_Terminate();
?>
