...
$tpnegocio_edit = NULL; // Initialize page object first

class ctpnegocio_edit extends ctpnegocio {
	...
	// Page object name
	var $PageObjName = 'tpnegocio_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->nu_tpNegocio->CurrentValue == "")
			$this->Page_Terminate("tpnegociolist.php"); // Invalid key, return to list
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// no_tpNegocio
			$this->no_tpNegocio->SetDbValueDef($rsnew, $this->no_tpNegocio->CurrentValue, "", $this->no_tpNegocio->ReadOnly);

			// co_ativo
			$this->co_ativo->SetDbValueDef($rsnew, $this->co_ativo->CurrentValue, "", $this->co_ativo->ReadOnly);
...
// Create page object
if (!isset($tpnegocio_edit)) $tpnegocio_edit = new ctpnegocio_edit();

// Page init
$tpnegocio_edit->Page_Init();

// Page main
$tpnegocio_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tpnegocio_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var tpnegocio_edit = new ew_Page("tpnegocio_edit");
tpnegocio_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = tpnegocio_edit.PageID; // For backward compatibility

// Form object
var ftpnegocioedit = new ew_Form("ftpnegocioedit");

// Validate form
ftpnegocioedit.Validate = function() {
...
ftpnegocioedit.Form_CustomValidate = 
...
ftpnegocioedit.ValidateRequired = true;
<?php } else { ?>
ftpnegocioedit.ValidateRequired = false; 
<?php } ?>
...
<?php $tpnegocio_edit->ShowPageHeader(); ?>
<?php
$tpnegocio_edit->ShowMessage();
?>
<form name="ftpnegocioedit" id="ftpnegocioedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="tpnegocio">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_tpnegocioedit" class="table table-bordered table-striped">
...
<input type="hidden" data-field="x_nu_tpNegocio" name="x_nu_tpNegocio" id="x_nu_tpNegocio" value="<?php echo ew_HtmlEncode($tpnegocio->nu_tpNegocio->CurrentValue) ?>">
