...
$estimativa_add = NULL; // Initialize page object first

class cestimativa_add extends cestimativa {
	...
	// Page object name
	var $PageObjName = 'estimativa_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["nu_estimativa"] != "") {
				...
				$this->setKey("nu_estimativa", $this->nu_estimativa->CurrentValue); // Set up key
			} else {
				$this->setKey("nu_estimativa", ""); // Clear key
	...
	function AddRow($rsold = NULL) {
		...
		// nu_solMetricas
		$this->nu_solMetricas->SetDbValueDef($rsnew, $this->nu_solMetricas->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($estimativa_add)) $estimativa_add = new cestimativa_add();

// Page init
$estimativa_add->Page_Init();

// Page main
$estimativa_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$estimativa_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var estimativa_add = new ew_Page("estimativa_add");
estimativa_add.PageID = "add"; // Page ID
var EW_PAGE_ID = estimativa_add.PageID; // For backward compatibility

// Form object
var festimativaadd = new ew_Form("festimativaadd");

// Validate form
festimativaadd.Validate = function() {
...
festimativaadd.Form_CustomValidate = 
...
festimativaadd.ValidateRequired = true;
<?php } else { ?>
festimativaadd.ValidateRequired = false; 
<?php } ?>

// Multi-Page properties
festimativaadd.MultiPage = new ew_MultiPage("festimativaadd",
	[["x_nu_solMetricas",1],["x_ic_solicitacaoCritica",1],["x_nu_ambienteMaisRepresentativo",1],["x_qt_tamBase",1],["x_ic_modeloCocomo",1],["x_nu_metPrazo",1],["x_vr_doPf",1],["x_pz_estimadoMeses",3],["x_pz_estimadoDias",3],["x_vr_ipMaximo",3],["x_vr_ipMedio",3],["x_vr_ipMinimo",3],["x_vr_ipInformado",3],["x_qt_esforco",3],["x_vr_custoDesenv",3],["x_vr_outrosCustos",3],["x_vr_custoTotal",3],["x_qt_tamBaseFaturamento",3],["x_qt_recursosEquipe",3],["x_ds_observacoes",3],["x_nu_altRELY",2],["x_nu_altDATA",2],["x_nu_altCPLX1",2],["x_nu_altCPLX2",2],["x_nu_altCPLX3",2],["x_nu_altCPLX4",2],["x_nu_altCPLX5",2],["x_nu_altDOCU",2],["x_nu_altRUSE",2],["x_nu_altTIME",2],["x_nu_altSTOR",2],["x_nu_altPVOL",2],["x_nu_altACAP",2],["x_nu_altPCAP",2],["x_nu_altPCON",2],["x_nu_altAPEX",2],["x_nu_altPLEX",2],["x_nu_altLTEX",2],["x_nu_altTOOL",2],["x_nu_altSITE",2]]
);

// Dynamic selection lists
festimativaadd.Lists["x_nu_solMetricas"] = {"LinkField":"x_nu_solMetricas","Ajax":null,"AutoFill":false,"DisplayFields":["x_nu_solMetricas","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_ambienteMaisRepresentativo"] = {"LinkField":"x_nu_ambiente","Ajax":true,"AutoFill":false,"DisplayFields":["x_no_ambiente","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_altRELY"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_altDATA"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_altCPLX1"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_altCPLX2"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_altCPLX3"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_altCPLX4"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_altCPLX5"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_altDOCU"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_altRUSE"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_altTIME"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_altSTOR"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_altPVOL"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_altACAP"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_altPCAP"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_altPCON"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_altAPEX"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_altPLEX"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_altLTEX"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_altTOOL"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
festimativaadd.Lists["x_nu_altSITE"] = {"LinkField":"x_nu_alternativa","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_alternativa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $estimativa_add->ShowPageHeader(); ?>
<?php
$estimativa_add->ShowMessage();
?>
<form name="festimativaadd" id="festimativaadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="estimativa">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewStdTable"><tbody><tr><td>
<div class="tabbable" id="estimativa_add">
...
<table id="tbl_estimativaadd1" class="table table-bordered table-striped">
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_solMetricas"].Options = <?php echo (is_array($estimativa->nu_solMetricas->EditValue)) ? ew_ArrayToJson($estimativa->nu_solMetricas->EditValue, 1) : "[]" ?>;
</script>
<?php } ?>
...
<script type="text/javascript">
var oas = new ew_AutoSuggest("x_nu_ambienteMaisRepresentativo", festimativaadd, false, EW_AUTO_SUGGEST_MAX_ENTRIES);
...
festimativaadd.AutoSuggests["x_nu_ambienteMaisRepresentativo"] = oas;
</script>
</span>
...
<table cellspacing="0" class="ewGrid" style="width: 100%"><tr><td>
<table id="tbl_estimativaadd2" class="table table-bordered table-striped">
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_altRELY"].Options = <?php echo (is_array($estimativa->nu_altRELY->EditValue)) ? ew_ArrayToJson($estimativa->nu_altRELY->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_altDATA"].Options = <?php echo (is_array($estimativa->nu_altDATA->EditValue)) ? ew_ArrayToJson($estimativa->nu_altDATA->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_altCPLX1"].Options = <?php echo (is_array($estimativa->nu_altCPLX1->EditValue)) ? ew_ArrayToJson($estimativa->nu_altCPLX1->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_altCPLX2"].Options = <?php echo (is_array($estimativa->nu_altCPLX2->EditValue)) ? ew_ArrayToJson($estimativa->nu_altCPLX2->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_altCPLX3"].Options = <?php echo (is_array($estimativa->nu_altCPLX3->EditValue)) ? ew_ArrayToJson($estimativa->nu_altCPLX3->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_altCPLX4"].Options = <?php echo (is_array($estimativa->nu_altCPLX4->EditValue)) ? ew_ArrayToJson($estimativa->nu_altCPLX4->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_altCPLX5"].Options = <?php echo (is_array($estimativa->nu_altCPLX5->EditValue)) ? ew_ArrayToJson($estimativa->nu_altCPLX5->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_altDOCU"].Options = <?php echo (is_array($estimativa->nu_altDOCU->EditValue)) ? ew_ArrayToJson($estimativa->nu_altDOCU->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_altRUSE"].Options = <?php echo (is_array($estimativa->nu_altRUSE->EditValue)) ? ew_ArrayToJson($estimativa->nu_altRUSE->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_altTIME"].Options = <?php echo (is_array($estimativa->nu_altTIME->EditValue)) ? ew_ArrayToJson($estimativa->nu_altTIME->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_altSTOR"].Options = <?php echo (is_array($estimativa->nu_altSTOR->EditValue)) ? ew_ArrayToJson($estimativa->nu_altSTOR->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_altPVOL"].Options = <?php echo (is_array($estimativa->nu_altPVOL->EditValue)) ? ew_ArrayToJson($estimativa->nu_altPVOL->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_altACAP"].Options = <?php echo (is_array($estimativa->nu_altACAP->EditValue)) ? ew_ArrayToJson($estimativa->nu_altACAP->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_altPCAP"].Options = <?php echo (is_array($estimativa->nu_altPCAP->EditValue)) ? ew_ArrayToJson($estimativa->nu_altPCAP->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_altPCON"].Options = <?php echo (is_array($estimativa->nu_altPCON->EditValue)) ? ew_ArrayToJson($estimativa->nu_altPCON->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_altAPEX"].Options = <?php echo (is_array($estimativa->nu_altAPEX->EditValue)) ? ew_ArrayToJson($estimativa->nu_altAPEX->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_altPLEX"].Options = <?php echo (is_array($estimativa->nu_altPLEX->EditValue)) ? ew_ArrayToJson($estimativa->nu_altPLEX->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_altLTEX"].Options = <?php echo (is_array($estimativa->nu_altLTEX->EditValue)) ? ew_ArrayToJson($estimativa->nu_altLTEX->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_altTOOL"].Options = <?php echo (is_array($estimativa->nu_altTOOL->EditValue)) ? ew_ArrayToJson($estimativa->nu_altTOOL->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
festimativaadd.Lists["x_nu_altSITE"].Options = <?php echo (is_array($estimativa->nu_altSITE->EditValue)) ? ew_ArrayToJson($estimativa->nu_altSITE->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<table cellspacing="0" class="ewGrid" style="width: 100%"><tr><td>
<table id="tbl_estimativaadd3" class="table table-bordered table-striped">
