...
$necti_edit = NULL; // Initialize page object first

class cnecti_edit extends cnecti {
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->nu_necTi->CurrentValue == "")
			$this->Page_Terminate("nectilist.php"); // Invalid key, return to list
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->nu_necTi->FldIsDetailKey)
			$this->nu_necTi->setFormValue($objForm->GetValue("x_nu_necTi"));
	...
	function RestoreFormValues() {
		global $objForm;
		$this->LoadRow();
		$this->nu_necTi->CurrentValue = $this->nu_necTi->FormValue;
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			// nu_necTi
			$this->nu_necTi->EditCustomAttributes = "";
			$this->nu_necTi->EditValue = $this->nu_necTi->CurrentValue;
			$this->nu_necTi->ViewCustomAttributes = "";
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// nu_periodoPdti
			$this->nu_periodoPdti->SetDbValueDef($rsnew, $this->nu_periodoPdti->CurrentValue, NULL, $this->nu_periodoPdti->ReadOnly);

			// nu_tpNecTi
			$this->nu_tpNecTi->SetDbValueDef($rsnew, $this->nu_tpNecTi->CurrentValue, NULL, $this->nu_tpNecTi->ReadOnly);

			// ic_tpNec
			$this->ic_tpNec->SetDbValueDef($rsnew, $this->ic_tpNec->CurrentValue, NULL, $this->ic_tpNec->ReadOnly);

			// nu_metaneg
			$this->nu_metaneg->SetDbValueDef($rsnew, $this->nu_metaneg->CurrentValue, NULL, $this->nu_metaneg->ReadOnly);

			// nu_origem
			$this->nu_origem->SetDbValueDef($rsnew, $this->nu_origem->CurrentValue, NULL, $this->nu_origem->ReadOnly);

			// nu_area
			$this->nu_area->SetDbValueDef($rsnew, $this->nu_area->CurrentValue, NULL, $this->nu_area->ReadOnly);

			// ic_gravidade
			$this->ic_gravidade->SetDbValueDef($rsnew, $this->ic_gravidade->CurrentValue, NULL, $this->ic_gravidade->ReadOnly);

			// ic_urgencia
			$this->ic_urgencia->SetDbValueDef($rsnew, $this->ic_urgencia->CurrentValue, NULL, $this->ic_urgencia->ReadOnly);

			// ic_tendencia
			$this->ic_tendencia->SetDbValueDef($rsnew, $this->ic_tendencia->CurrentValue, NULL, $this->ic_tendencia->ReadOnly);

			// ic_prioridade
			$this->ic_prioridade->SetDbValueDef($rsnew, $this->ic_prioridade->CurrentValue, NULL, $this->ic_prioridade->ReadOnly);
...
// Create page object
if (!isset($necti_edit)) $necti_edit = new cnecti_edit();

// Page init
$necti_edit->Page_Init();

// Page main
$necti_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$necti_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var necti_edit = new ew_Page("necti_edit");
necti_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = necti_edit.PageID; // For backward compatibility

// Form object
var fnectiedit = new ew_Form("fnectiedit");

// Validate form
fnectiedit.Validate = function() {
...
fnectiedit.Form_CustomValidate = 
...
fnectiedit.ValidateRequired = true;
<?php } else { ?>
fnectiedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fnectiedit.Lists["x_nu_periodoPei"] = {"LinkField":"x_nu_periodoPei","Ajax":null,"AutoFill":false,"DisplayFields":["x_nu_anoInicio","x_nu_anoFim","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fnectiedit.Lists["x_nu_periodoPdti"] = {"LinkField":"x_nu_periodo","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_periodo","","",""],"ParentFields":["x_nu_periodoPei"],"FilterFields":["x_nu_periodoPei"],"Options":[]};
fnectiedit.Lists["x_nu_tpNecTi"] = {"LinkField":"x_nu_tpNecTi","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_tpNecTi","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fnectiedit.Lists["x_nu_metaneg"] = {"LinkField":"x_nu_metaneg","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_metaneg","","",""],"ParentFields":["x_nu_periodoPei"],"FilterFields":["x_nu_periodoPei"],"Options":[]};
fnectiedit.Lists["x_nu_origem"] = {"LinkField":"x_nu_origem","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_origem","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fnectiedit.Lists["x_nu_area"] = {"LinkField":"x_nu_area","Ajax":true,"AutoFill":false,"DisplayFields":["x_no_area","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $necti_edit->ShowPageHeader(); ?>
<?php
$necti_edit->ShowMessage();
?>
<form name="fnectiedit" id="fnectiedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="necti">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_nectiedit" class="table table-bordered table-striped">
...
<?php echo $necti->nu_necTi->EditValue ?></span>
</span>
<input type="hidden" data-field="x_nu_necTi" name="x_nu_necTi" id="x_nu_necTi" value="<?php echo ew_HtmlEncode($necti->nu_necTi->CurrentValue) ?>">
<?php echo $necti->nu_necTi->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fnectiedit.Lists["x_nu_periodoPei"].Options = <?php echo (is_array($necti->nu_periodoPei->EditValue)) ? ew_ArrayToJson($necti->nu_periodoPei->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fnectiedit.Lists["x_nu_periodoPdti"].Options = <?php echo (is_array($necti->nu_periodoPdti->EditValue)) ? ew_ArrayToJson($necti->nu_periodoPdti->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<?php } ?>
<script type="text/javascript">
fnectiedit.Lists["x_nu_tpNecTi"].Options = <?php echo (is_array($necti->nu_tpNecTi->EditValue)) ? ew_ArrayToJson($necti->nu_tpNecTi->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fnectiedit.Lists["x_nu_metaneg"].Options = <?php echo (is_array($necti->nu_metaneg->EditValue)) ? ew_ArrayToJson($necti->nu_metaneg->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<?php } ?>
<script type="text/javascript">
fnectiedit.Lists["x_nu_origem"].Options = <?php echo (is_array($necti->nu_origem->EditValue)) ? ew_ArrayToJson($necti->nu_origem->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
var oas = new ew_AutoSuggest("x_nu_area", fnectiedit, false, EW_AUTO_SUGGEST_MAX_ENTRIES);
...
fnectiedit.AutoSuggests["x_nu_area"] = oas;
</script>
