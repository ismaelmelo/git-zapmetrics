...
$rdm_lancamento_view = NULL; // Initialize page object first

class crdm_lancamento_view extends crdm_lancamento {
	...
	// Page object name
	var $PageObjName = 'rdm_lancamento_view';
	...
	function Page_Init() {
		...
		if (!$Security->CanView()) {
			...
			$this->Page_Terminate("rdm_lancamentolist.php");
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "rdm_lancamentolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "rdm_lancamentolist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "rdm_lancamentolist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_rdm_lancamento\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_rdm_lancamento',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.frdm_lancamentoview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", "<span id=\"ewPageCaption\">" . $PageCaption . "</span>", "rdm_lancamentolist.php", $this->TableVar);
...
// Create page object
if (!isset($rdm_lancamento_view)) $rdm_lancamento_view = new crdm_lancamento_view();

// Page init
$rdm_lancamento_view->Page_Init();

// Page main
$rdm_lancamento_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$rdm_lancamento_view->Page_Render();
?>
...
// Page object
var rdm_lancamento_view = new ew_Page("rdm_lancamento_view");
rdm_lancamento_view.PageID = "view"; // Page ID
var EW_PAGE_ID = rdm_lancamento_view.PageID; // For backward compatibility

// Form object
var frdm_lancamentoview = new ew_Form("frdm_lancamentoview");

// Form_CustomValidate event
frdm_lancamentoview.Form_CustomValidate = 
...
frdm_lancamentoview.ValidateRequired = true;
<?php } else { ?>
frdm_lancamentoview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
frdm_lancamentoview.Lists["x_project_id"] = {"LinkField":"x_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
frdm_lancamentoview.Lists["x_user_id"] = {"LinkField":"x_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $rdm_lancamento_view->ExportOptions->Render("body") ?>
<?php if (!$rdm_lancamento_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($rdm_lancamento_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $rdm_lancamento_view->ShowPageHeader(); ?>
<?php
$rdm_lancamento_view->ShowMessage();
?>
<form name="frdm_lancamentoview" id="frdm_lancamentoview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="rdm_lancamento">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_rdm_lancamentoview" class="table table-bordered table-striped">
<?php if ($rdm_lancamento->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_rdm_lancamento_id"><?php echo $rdm_lancamento->id->FldCaption() ?></span></td>
		<td<?php echo $rdm_lancamento->id->CellAttributes() ?>>
<span id="el_rdm_lancamento_id" class="control-group">
<span<?php echo $rdm_lancamento->id->ViewAttributes() ?>>
<?php echo $rdm_lancamento->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($rdm_lancamento->project_id->Visible) { // project_id ?>
	<tr id="r_project_id">
		<td><span id="elh_rdm_lancamento_project_id"><?php echo $rdm_lancamento->project_id->FldCaption() ?></span></td>
		<td<?php echo $rdm_lancamento->project_id->CellAttributes() ?>>
<span id="el_rdm_lancamento_project_id" class="control-group">
<span<?php echo $rdm_lancamento->project_id->ViewAttributes() ?>>
<?php echo $rdm_lancamento->project_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($rdm_lancamento->issue_id->Visible) { // issue_id ?>
	<tr id="r_issue_id">
		<td><span id="elh_rdm_lancamento_issue_id"><?php echo $rdm_lancamento->issue_id->FldCaption() ?></span></td>
		<td<?php echo $rdm_lancamento->issue_id->CellAttributes() ?>>
<span id="el_rdm_lancamento_issue_id" class="control-group">
<span<?php echo $rdm_lancamento->issue_id->ViewAttributes() ?>>
<?php echo $rdm_lancamento->issue_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($rdm_lancamento->user_id->Visible) { // user_id ?>
	<tr id="r_user_id">
		<td><span id="elh_rdm_lancamento_user_id"><?php echo $rdm_lancamento->user_id->FldCaption() ?></span></td>
		<td<?php echo $rdm_lancamento->user_id->CellAttributes() ?>>
<span id="el_rdm_lancamento_user_id" class="control-group">
<span<?php echo $rdm_lancamento->user_id->ViewAttributes() ?>>
<?php echo $rdm_lancamento->user_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($rdm_lancamento->activity_id->Visible) { // activity_id ?>
	<tr id="r_activity_id">
		<td><span id="elh_rdm_lancamento_activity_id"><?php echo $rdm_lancamento->activity_id->FldCaption() ?></span></td>
		<td<?php echo $rdm_lancamento->activity_id->CellAttributes() ?>>
<span id="el_rdm_lancamento_activity_id" class="control-group">
<span<?php echo $rdm_lancamento->activity_id->ViewAttributes() ?>>
<?php echo $rdm_lancamento->activity_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($rdm_lancamento->hours->Visible) { // hours ?>
	<tr id="r_hours">
		<td><span id="elh_rdm_lancamento_hours"><?php echo $rdm_lancamento->hours->FldCaption() ?></span></td>
		<td<?php echo $rdm_lancamento->hours->CellAttributes() ?>>
<span id="el_rdm_lancamento_hours" class="control-group">
<span<?php echo $rdm_lancamento->hours->ViewAttributes() ?>>
<?php echo $rdm_lancamento->hours->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($rdm_lancamento->comments->Visible) { // comments ?>
	<tr id="r_comments">
		<td><span id="elh_rdm_lancamento_comments"><?php echo $rdm_lancamento->comments->FldCaption() ?></span></td>
		<td<?php echo $rdm_lancamento->comments->CellAttributes() ?>>
<span id="el_rdm_lancamento_comments" class="control-group">
<span<?php echo $rdm_lancamento->comments->ViewAttributes() ?>>
<?php echo $rdm_lancamento->comments->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($rdm_lancamento->spent_on->Visible) { // spent_on ?>
	<tr id="r_spent_on">
		<td><span id="elh_rdm_lancamento_spent_on"><?php echo $rdm_lancamento->spent_on->FldCaption() ?></span></td>
		<td<?php echo $rdm_lancamento->spent_on->CellAttributes() ?>>
<span id="el_rdm_lancamento_spent_on" class="control-group">
<span<?php echo $rdm_lancamento->spent_on->ViewAttributes() ?>>
<?php echo $rdm_lancamento->spent_on->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($rdm_lancamento->created_on->Visible) { // created_on ?>
	<tr id="r_created_on">
		<td><span id="elh_rdm_lancamento_created_on"><?php echo $rdm_lancamento->created_on->FldCaption() ?></span></td>
		<td<?php echo $rdm_lancamento->created_on->CellAttributes() ?>>
<span id="el_rdm_lancamento_created_on" class="control-group">
<span<?php echo $rdm_lancamento->created_on->ViewAttributes() ?>>
<?php echo $rdm_lancamento->created_on->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($rdm_lancamento->updated_on->Visible) { // updated_on ?>
	<tr id="r_updated_on">
		<td><span id="elh_rdm_lancamento_updated_on"><?php echo $rdm_lancamento->updated_on->FldCaption() ?></span></td>
		<td<?php echo $rdm_lancamento->updated_on->CellAttributes() ?>>
<span id="el_rdm_lancamento_updated_on" class="control-group">
<span<?php echo $rdm_lancamento->updated_on->ViewAttributes() ?>>
<?php echo $rdm_lancamento->updated_on->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
frdm_lancamentoview.Init();
</script>
<?php
$rdm_lancamento_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($rdm_lancamento->Export == "") { ?>
...
<?php
$rdm_lancamento_view->Page_Terminate();
?>
