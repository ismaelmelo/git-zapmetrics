...
$usuario_permissoes_edit = NULL; // Initialize page object first

class cusuario_permissoes_edit extends cusuario_permissoes {
	...
	// Page object name
	var $PageObjName = 'usuario_permissoes_edit';
	...
	function Page_Main() {
		...
		if ($this->nu_level->CurrentValue == "")
			$this->Page_Terminate("usuario_permissoeslist.php"); // Invalid key, return to list
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// no_level
			$this->no_level->SetDbValueDef($rsnew, $this->no_level->CurrentValue, "", $this->no_level->ReadOnly);
...
// Create page object
if (!isset($usuario_permissoes_edit)) $usuario_permissoes_edit = new cusuario_permissoes_edit();

// Page init
$usuario_permissoes_edit->Page_Init();

// Page main
$usuario_permissoes_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$usuario_permissoes_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var usuario_permissoes_edit = new ew_Page("usuario_permissoes_edit");
usuario_permissoes_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = usuario_permissoes_edit.PageID; // For backward compatibility

// Form object
var fusuario_permissoesedit = new ew_Form("fusuario_permissoesedit");

// Validate form
fusuario_permissoesedit.Validate = function() {
...
fusuario_permissoesedit.Form_CustomValidate = 
...
fusuario_permissoesedit.ValidateRequired = true;
<?php } else { ?>
fusuario_permissoesedit.ValidateRequired = false; 
<?php } ?>
...
<?php $usuario_permissoes_edit->ShowPageHeader(); ?>
<?php
$usuario_permissoes_edit->ShowMessage();
?>
<form name="fusuario_permissoesedit" id="fusuario_permissoesedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="usuario_permissoes">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_usuario_permissoesedit" class="table table-bordered table-striped">
...
<input type="hidden" data-field="x_nu_level" name="x_nu_level" id="x_nu_level" value="<?php echo ew_HtmlEncode($usuario_permissoes->nu_level->CurrentValue) ?>">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("EditBtn") ?></button>
</form>
<script type="text/javascript">
fusuario_permissoesedit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$usuario_permissoes_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$usuario_permissoes_edit->Page_Terminate();
?>
