...
$divisao_view = NULL; // Initialize page object first

class cdivisao_view extends cdivisao {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["nu_divisao"] <> "") {
			$this->RecKey["nu_divisao"] = $_GET["nu_divisao"];
			$KeyUrl .= "&nu_divisao=" . urlencode($this->RecKey["nu_divisao"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["nu_divisao"] <> "") {
				...
				$this->RecKey["nu_divisao"] = $this->nu_divisao->QueryStringValue;
			} else {
				$sReturnUrl = "divisaolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "divisaolist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "divisaolist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($divisao_view)) $divisao_view = new cdivisao_view();

// Page init
$divisao_view->Page_Init();

// Page main
$divisao_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$divisao_view->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var divisao_view = new ew_Page("divisao_view");
divisao_view.PageID = "view"; // Page ID
var EW_PAGE_ID = divisao_view.PageID; // For backward compatibility

// Form object
var fdivisaoview = new ew_Form("fdivisaoview");

// Form_CustomValidate event
fdivisaoview.Form_CustomValidate = 
...
fdivisaoview.ValidateRequired = true;
<?php } else { ?>
fdivisaoview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fdivisaoview.Lists["x_nu_area"] = {"LinkField":"x_nu_area","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_area","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $divisao_view->ExportOptions->Render("body") ?>
<?php if (!$divisao_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($divisao_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php $divisao_view->ShowPageHeader(); ?>
<?php
$divisao_view->ShowMessage();
?>
<form name="fdivisaoview" id="fdivisaoview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="divisao">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_divisaoview" class="table table-bordered table-striped">
...
<?php echo $divisao->nu_area->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($divisao->no_divisao->Visible) { // no_divisao ?>
	<tr id="r_no_divisao">
		<td><span id="elh_divisao_no_divisao"><?php echo $divisao->no_divisao->FldCaption() ?></span></td>
...
<span<?php echo $divisao->ds_divisao->ViewAttributes() ?>>
<?php echo $divisao->ds_divisao->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($divisao->ic_ativo->Visible) { // ic_ativo ?>
	<tr id="r_ic_ativo">
		<td><span id="elh_divisao_ic_ativo"><?php echo $divisao->ic_ativo->FldCaption() ?></span></td>
