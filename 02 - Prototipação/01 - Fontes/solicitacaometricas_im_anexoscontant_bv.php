...
$solicitacaoMetricas_im_anexosContAnt_blobview = NULL; // Initialize page object first

class csolicitacaoMetricas_im_anexosContAnt_blobview extends csolicitacaoMetricas {
	...
	// Page object name
	var $PageObjName = 'solicitacaoMetricas_im_anexosContAnt_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('solicitacaoMetricas', 'x_im_anexosContAnt');
		...
		if ($this->Recordset = $conn->Execute($sSql)) {
			if (!$this->Recordset->EOF) {
				if (!EW_DEBUG_ENABLED && ob_get_length())
					ob_end_clean();
				$objBinary->Value = $this->Recordset->fields('im_anexosContAnt');
				...
				if (trim(strval($this->Recordset->fields('im_anexosContAnt'))) <> "") {
					header("Content-Disposition: attachment; filename=\"" . $this->Recordset->fields('im_anexosContAnt') . "\"");
				}
...
// Create page object
if (!isset($solicitacaoMetricas_im_anexosContAnt_blobview)) $solicitacaoMetricas_im_anexosContAnt_blobview = new csolicitacaoMetricas_im_anexosContAnt_blobview();

// Page init
$solicitacaoMetricas_im_anexosContAnt_blobview->Page_Init();

// Page main
$solicitacaoMetricas_im_anexosContAnt_blobview->Page_Main();
?>
<?php
$solicitacaoMetricas_im_anexosContAnt_blobview->Page_Terminate();
?>
