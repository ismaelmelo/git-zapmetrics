...
$metaneg_add = NULL; // Initialize page object first

class cmetaneg_add extends cmetaneg {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["nu_metaneg"] != "") {
				...
				$this->setKey("nu_metaneg", $this->nu_metaneg->CurrentValue); // Set up key
			} else {
				$this->setKey("nu_metaneg", ""); // Clear key
	...
	function LoadDefaultValues() {
		...
		$this->nu_necessidade->CurrentValue = NULL;
		$this->nu_necessidade->OldValue = $this->nu_necessidade->CurrentValue;
		$this->ic_perspectiva->CurrentValue = NULL;
		$this->ic_perspectiva->OldValue = $this->ic_perspectiva->CurrentValue;
		$this->no_metaneg->CurrentValue = NULL;
		$this->no_metaneg->OldValue = $this->no_metaneg->CurrentValue;
		$this->ds_metaneg->CurrentValue = NULL;
		$this->ds_metaneg->OldValue = $this->ds_metaneg->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// nu_necessidade
		$this->nu_necessidade->SetDbValueDef($rsnew, $this->nu_necessidade->CurrentValue, NULL, FALSE);

		// ic_perspectiva
		$this->ic_perspectiva->SetDbValueDef($rsnew, $this->ic_perspectiva->CurrentValue, NULL, FALSE);

		// no_metaneg
		$this->no_metaneg->SetDbValueDef($rsnew, $this->no_metaneg->CurrentValue, NULL, FALSE);

		// ds_metaneg
		$this->ds_metaneg->SetDbValueDef($rsnew, $this->ds_metaneg->CurrentValue, NULL, FALSE);
		...
		if ($AddRow) {
			$this->nu_metaneg->setDbValue($conn->Insert_ID());
			$rsnew['nu_metaneg'] = $this->nu_metaneg->DbValue;
		}
		if ($AddRow) {
...
// Create page object
if (!isset($metaneg_add)) $metaneg_add = new cmetaneg_add();

// Page init
$metaneg_add->Page_Init();

// Page main
$metaneg_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$metaneg_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var metaneg_add = new ew_Page("metaneg_add");
metaneg_add.PageID = "add"; // Page ID
var EW_PAGE_ID = metaneg_add.PageID; // For backward compatibility

// Form object
var fmetanegadd = new ew_Form("fmetanegadd");

// Validate form
fmetanegadd.Validate = function() {
...
fmetanegadd.Form_CustomValidate = 
...
fmetanegadd.ValidateRequired = true;
<?php } else { ?>
fmetanegadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmetanegadd.Lists["x_nu_periodoPei"] = {"LinkField":"x_nu_periodoPei","Ajax":null,"AutoFill":false,"DisplayFields":["x_nu_anoInicio","x_nu_anoFim","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $metaneg_add->ShowPageHeader(); ?>
<?php
$metaneg_add->ShowMessage();
?>
<form name="fmetanegadd" id="fmetanegadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="metaneg">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_metanegadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
fmetanegadd.Lists["x_nu_periodoPei"].Options = <?php echo (is_array($metaneg->nu_periodoPei->EditValue)) ? ew_ArrayToJson($metaneg->nu_periodoPei->EditValue, 1) : "[]" ?>;
</script>
</span>
