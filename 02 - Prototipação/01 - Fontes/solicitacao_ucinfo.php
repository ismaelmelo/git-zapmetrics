...
//
// Table class for solicitacao_uc
//
class csolicitacao_uc extends cTable {
	var $nu_solicitacao;
	var $nu_sistema;
	var $nu_uc;
	var $ic_impacto;
	...
	function __construct() {
		...
		$this->TableVar = 'solicitacao_uc';
		$this->TableName = 'solicitacao_uc';
		...
		// nu_solicitacao
		$this->nu_solicitacao = new cField('solicitacao_uc', 'solicitacao_uc', 'x_nu_solicitacao', 'nu_solicitacao', '[nu_solicitacao]', 'CAST([nu_solicitacao] AS NVARCHAR)', 3, -1, FALSE, '[nu_solicitacao]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->nu_solicitacao->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['nu_solicitacao'] = &$this->nu_solicitacao;

		// nu_sistema
		$this->nu_sistema = new cField('solicitacao_uc', 'solicitacao_uc', 'x_nu_sistema', 'nu_sistema', '[nu_sistema]', 'CAST([nu_sistema] AS NVARCHAR)', 3, -1, FALSE, '[nu_sistema]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->nu_sistema->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['nu_sistema'] = &$this->nu_sistema;

		// nu_uc
		$this->nu_uc = new cField('solicitacao_uc', 'solicitacao_uc', 'x_nu_uc', 'nu_uc', '[nu_uc]', 'CAST([nu_uc] AS NVARCHAR)', 3, -1, FALSE, '[nu_uc]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->nu_uc->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['nu_uc'] = &$this->nu_uc;

		// ic_impacto
		$this->ic_impacto = new cField('solicitacao_uc', 'solicitacao_uc', 'x_ic_impacto', 'ic_impacto', '[ic_impacto]', '[ic_impacto]', 129, -1, FALSE, '[ic_impacto]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['ic_impacto'] = &$this->ic_impacto;
	}
	...
	// Update Table
	var $UpdateTable = "[dbo].[solicitacao_uc]";
	...
	function SqlKeyFilter() {
		return "[nu_solicitacao] = @nu_solicitacao@ AND [nu_uc] = @nu_uc@";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("solicitacao_ucview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("solicitacao_ucview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "solicitacao_ucadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("solicitacao_ucedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("solicitacao_ucadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("solicitacao_ucdelete.php", $this->UrlParm());
	}
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				if ($this->ic_impacto->Exportable) $Doc->ExportCaption($this->ic_impacto);
			} else {
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					if ($this->ic_impacto->Exportable) $Doc->ExportField($this->ic_impacto);
				} else {
