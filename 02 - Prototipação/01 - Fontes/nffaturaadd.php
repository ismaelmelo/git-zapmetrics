...
$nffatura_add = NULL; // Initialize page object first

class cnffatura_add extends cnffatura {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["nu_nfFatura"] != "") {
				...
				$this->setKey("nu_nfFatura", $this->nu_nfFatura->CurrentValue); // Set up key
			} else {
				$this->setKey("nu_nfFatura", ""); // Clear key
	...
	function AddRow($rsold = NULL) {
		...
		// nu_fatura
		$this->nu_fatura->SetDbValueDef($rsnew, $this->nu_fatura->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($nffatura_add)) $nffatura_add = new cnffatura_add();

// Page init
$nffatura_add->Page_Init();

// Page main
$nffatura_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$nffatura_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var nffatura_add = new ew_Page("nffatura_add");
nffatura_add.PageID = "add"; // Page ID
var EW_PAGE_ID = nffatura_add.PageID; // For backward compatibility

// Form object
var fnffaturaadd = new ew_Form("fnffaturaadd");

// Validate form
fnffaturaadd.Validate = function() {
...
fnffaturaadd.Form_CustomValidate = 
...
fnffaturaadd.ValidateRequired = true;
<?php } else { ?>
fnffaturaadd.ValidateRequired = false; 
<?php } ?>
...
<?php $nffatura_add->ShowPageHeader(); ?>
<?php
$nffatura_add->ShowMessage();
?>
<form name="fnffaturaadd" id="fnffaturaadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="nffatura">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_nffaturaadd" class="table table-bordered table-striped">
