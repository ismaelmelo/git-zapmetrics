...
$prospecto_itempdti_edit = NULL; // Initialize page object first

class cprospecto_itempdti_edit extends cprospecto_itempdti {
	...
	// Page object name
	var $PageObjName = 'prospecto_itempdti_edit';
	...
	function Page_Main() {
		...
		if ($this->nu_prospecto->CurrentValue == "")
			$this->Page_Terminate("prospecto_itempdtilist.php"); // Invalid key, return to list
		if ($this->nu_itemPdti->CurrentValue == "")
			$this->Page_Terminate("prospecto_itempdtilist.php"); // Invalid key, return to list
...
// Create page object
if (!isset($prospecto_itempdti_edit)) $prospecto_itempdti_edit = new cprospecto_itempdti_edit();

// Page init
$prospecto_itempdti_edit->Page_Init();

// Page main
$prospecto_itempdti_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$prospecto_itempdti_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var prospecto_itempdti_edit = new ew_Page("prospecto_itempdti_edit");
prospecto_itempdti_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = prospecto_itempdti_edit.PageID; // For backward compatibility

// Form object
var fprospecto_itempdtiedit = new ew_Form("fprospecto_itempdtiedit");

// Validate form
fprospecto_itempdtiedit.Validate = function() {
...
fprospecto_itempdtiedit.Form_CustomValidate = 
...
fprospecto_itempdtiedit.ValidateRequired = true;
<?php } else { ?>
fprospecto_itempdtiedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fprospecto_itempdtiedit.Lists["x_nu_prospecto"] = {"LinkField":"x_nu_prospecto","Ajax":null,"AutoFill":false,"DisplayFields":["x_no_prospecto","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $prospecto_itempdti_edit->ShowPageHeader(); ?>
<?php
$prospecto_itempdti_edit->ShowMessage();
?>
<form name="fprospecto_itempdtiedit" id="fprospecto_itempdtiedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="prospecto_itempdti">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_prospecto_itempdtiedit" class="table table-bordered table-striped">
<?php if ($prospecto_itempdti->nu_prospecto->Visible) { // nu_prospecto ?>
	<tr id="r_nu_prospecto">
		<td><span id="elh_prospecto_itempdti_nu_prospecto"><?php echo $prospecto_itempdti->nu_prospecto->FldCaption() ?></span></td>
		<td<?php echo $prospecto_itempdti->nu_prospecto->CellAttributes() ?>>
<span id="el_prospecto_itempdti_nu_prospecto" class="control-group">
<span<?php echo $prospecto_itempdti->nu_prospecto->ViewAttributes() ?>>
<?php echo $prospecto_itempdti->nu_prospecto->EditValue ?></span>
</span>
<input type="hidden" data-field="x_nu_prospecto" name="x_nu_prospecto" id="x_nu_prospecto" value="<?php echo ew_HtmlEncode($prospecto_itempdti->nu_prospecto->CurrentValue) ?>">
...
<input type="hidden" data-field="x_nu_itemPdti" name="x_nu_itemPdti" id="x_nu_itemPdti" value="<?php echo ew_HtmlEncode($prospecto_itempdti->nu_itemPdti->CurrentValue) ?>">
...
<script type="text/javascript">
fprospecto_itempdtiedit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$prospecto_itempdti_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$prospecto_itempdti_edit->Page_Terminate();
?>
