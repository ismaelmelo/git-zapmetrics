...
$tbrdm_workflows_view = NULL; // Initialize page object first

class ctbrdm_workflows_view extends ctbrdm_workflows {
	...
	// Page object name
	var $PageObjName = 'tbrdm_workflows_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "tbrdm_workflowslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tbrdm_workflowslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "tbrdm_workflowslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_tbrdm_workflows\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_tbrdm_workflows',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.ftbrdm_workflowsview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($tbrdm_workflows_view)) $tbrdm_workflows_view = new ctbrdm_workflows_view();

// Page init
$tbrdm_workflows_view->Page_Init();

// Page main
$tbrdm_workflows_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbrdm_workflows_view->Page_Render();
?>
...
// Page object
var tbrdm_workflows_view = new ew_Page("tbrdm_workflows_view");
tbrdm_workflows_view.PageID = "view"; // Page ID
var EW_PAGE_ID = tbrdm_workflows_view.PageID; // For backward compatibility

// Form object
var ftbrdm_workflowsview = new ew_Form("ftbrdm_workflowsview");

// Form_CustomValidate event
ftbrdm_workflowsview.Form_CustomValidate = 
...
ftbrdm_workflowsview.ValidateRequired = true;
<?php } else { ?>
ftbrdm_workflowsview.ValidateRequired = false; 
<?php } ?>
...
<?php $tbrdm_workflows_view->ExportOptions->Render("body") ?>
<?php if (!$tbrdm_workflows_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($tbrdm_workflows_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $tbrdm_workflows_view->ShowPageHeader(); ?>
<?php
$tbrdm_workflows_view->ShowMessage();
?>
<form name="ftbrdm_workflowsview" id="ftbrdm_workflowsview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="tbrdm_workflows">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_tbrdm_workflowsview" class="table table-bordered table-striped">
<?php if ($tbrdm_workflows->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_tbrdm_workflows_id"><?php echo $tbrdm_workflows->id->FldCaption() ?></span></td>
...
<?php echo $tbrdm_workflows->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_workflows->tracker_id->Visible) { // tracker_id ?>
	<tr id="r_tracker_id">
		<td><span id="elh_tbrdm_workflows_tracker_id"><?php echo $tbrdm_workflows->tracker_id->FldCaption() ?></span></td>
...
<?php echo $tbrdm_workflows->tracker_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_workflows->old_status_id->Visible) { // old_status_id ?>
	<tr id="r_old_status_id">
		<td><span id="elh_tbrdm_workflows_old_status_id"><?php echo $tbrdm_workflows->old_status_id->FldCaption() ?></span></td>
...
<?php echo $tbrdm_workflows->old_status_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_workflows->new_status_id->Visible) { // new_status_id ?>
	<tr id="r_new_status_id">
		<td><span id="elh_tbrdm_workflows_new_status_id"><?php echo $tbrdm_workflows->new_status_id->FldCaption() ?></span></td>
...
<?php echo $tbrdm_workflows->new_status_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_workflows->role_id->Visible) { // role_id ?>
	<tr id="r_role_id">
		<td><span id="elh_tbrdm_workflows_role_id"><?php echo $tbrdm_workflows->role_id->FldCaption() ?></span></td>
...
<?php echo $tbrdm_workflows->role_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_workflows->assignee->Visible) { // assignee ?>
	<tr id="r_assignee">
		<td><span id="elh_tbrdm_workflows_assignee"><?php echo $tbrdm_workflows->assignee->FldCaption() ?></span></td>
...
<?php echo $tbrdm_workflows->assignee->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_workflows->author->Visible) { // author ?>
	<tr id="r_author">
		<td><span id="elh_tbrdm_workflows_author"><?php echo $tbrdm_workflows->author->FldCaption() ?></span></td>
...
<?php echo $tbrdm_workflows->author->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ftbrdm_workflowsview.Init();
</script>
<?php
$tbrdm_workflows_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($tbrdm_workflows->Export == "") { ?>
...
<?php
$tbrdm_workflows_view->Page_Terminate();
?>
