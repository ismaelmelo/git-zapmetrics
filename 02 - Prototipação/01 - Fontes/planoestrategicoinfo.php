...
$planoestrategico = NULL;

//
// Table class for planoestrategico
//
class cplanoestrategico extends cTable {
	var $nu_plano;
	var $nu_anoInicio;
	var $nu_anoFim;
	var $no_plano;
	...
	function __construct() {
		...
		$this->TableVar = 'planoestrategico';
		$this->TableName = 'planoestrategico';
		...
		// nu_plano
		$this->nu_plano = new cField('planoestrategico', 'planoestrategico', 'x_nu_plano', 'nu_plano', '[nu_plano]', 'CAST([nu_plano] AS NVARCHAR)', 3, -1, FALSE, '[nu_plano]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->nu_plano->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['nu_plano'] = &$this->nu_plano;

		// nu_anoInicio
		$this->nu_anoInicio = new cField('planoestrategico', 'planoestrategico', 'x_nu_anoInicio', 'nu_anoInicio', '[nu_anoInicio]', 'CAST([nu_anoInicio] AS NVARCHAR)', 3, -1, FALSE, '[nu_anoInicio]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->nu_anoInicio->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['nu_anoInicio'] = &$this->nu_anoInicio;

		// nu_anoFim
		$this->nu_anoFim = new cField('planoestrategico', 'planoestrategico', 'x_nu_anoFim', 'nu_anoFim', '[nu_anoFim]', 'CAST([nu_anoFim] AS NVARCHAR)', 3, -1, FALSE, '[nu_anoFim]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->nu_anoFim->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['nu_anoFim'] = &$this->nu_anoFim;

		// no_plano
		$this->no_plano = new cField('planoestrategico', 'planoestrategico', 'x_no_plano', 'no_plano', '[no_plano]', '[no_plano]', 200, -1, FALSE, '[no_plano]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['no_plano'] = &$this->no_plano;

		// ds_plano
		$this->ds_plano = new cField('planoestrategico', 'planoestrategico', 'x_ds_plano', 'ds_plano', '[ds_plano]', '[ds_plano]', 201, -1, FALSE, '[ds_plano]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['ds_plano'] = &$this->ds_plano;

		// ds_missao
		$this->ds_missao = new cField('planoestrategico', 'planoestrategico', 'x_ds_missao', 'ds_missao', '[ds_missao]', '[ds_missao]', 201, -1, FALSE, '[ds_missao]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['ds_missao'] = &$this->ds_missao;

		// ds_visao
		$this->ds_visao = new cField('planoestrategico', 'planoestrategico', 'x_ds_visao', 'ds_visao', '[ds_visao]', '[ds_visao]', 201, -1, FALSE, '[ds_visao]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['ds_visao'] = &$this->ds_visao;

		// ds_valores
		$this->ds_valores = new cField('planoestrategico', 'planoestrategico', 'x_ds_valores', 'ds_valores', '[ds_valores]', '[ds_valores]', 201, -1, FALSE, '[ds_valores]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['ds_valores'] = &$this->ds_valores;

		// no_localArquivo
		$this->no_localArquivo = new cField('planoestrategico', 'planoestrategico', 'x_no_localArquivo', 'no_localArquivo', '[no_localArquivo]', '[no_localArquivo]', 200, -1, FALSE, '[no_localArquivo]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['no_localArquivo'] = &$this->no_localArquivo;

		// im_anexo
		$this->im_anexo = new cField('planoestrategico', 'planoestrategico', 'x_im_anexo', 'im_anexo', '[im_anexo]', '[im_anexo]', 200, -1, TRUE, '[im_anexo]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->im_anexo->UploadMultiple = TRUE;
		$this->fields['im_anexo'] = &$this->im_anexo;

		// ic_situacao
		$this->ic_situacao = new cField('planoestrategico', 'planoestrategico', 'x_ic_situacao', 'ic_situacao', '[ic_situacao]', '[ic_situacao]', 129, -1, FALSE, '[ic_situacao]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['ic_situacao'] = &$this->ic_situacao;

		// nu_usuario
		$this->nu_usuario = new cField('planoestrategico', 'planoestrategico', 'x_nu_usuario', 'nu_usuario', '[nu_usuario]', 'CAST([nu_usuario] AS NVARCHAR)', 3, -1, FALSE, '[nu_usuario]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->nu_usuario->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['nu_usuario'] = &$this->nu_usuario;

		// ts_datahora
		$this->ts_datahora = new cField('planoestrategico', 'planoestrategico', 'x_ts_datahora', 'ts_datahora', '[ts_datahora]', '(REPLACE(STR(DAY([ts_datahora]),2,0),\' \',\'0\') + \'/\' + REPLACE(STR(MONTH([ts_datahora]),2,0),\' \',\'0\') + \'/\' + STR(YEAR([ts_datahora]),4,0))', 135, 7, FALSE, '[ts_datahora]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "[dbo].[planoestrategico]";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "planoestrategicolist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("planoestrategicoview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("planoestrategicoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "planoestrategicoadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("planoestrategicoedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("planoestrategicoadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("planoestrategicodelete.php", $this->UrlParm());
	}
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				if ($this->ds_missao->Exportable) $Doc->ExportCaption($this->ds_missao);
				if ($this->ds_visao->Exportable) $Doc->ExportCaption($this->ds_visao);
				if ($this->ds_valores->Exportable) $Doc->ExportCaption($this->ds_valores);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					if ($this->ds_missao->Exportable) $Doc->ExportField($this->ds_missao);
					if ($this->ds_visao->Exportable) $Doc->ExportField($this->ds_visao);
					if ($this->ds_valores->Exportable) $Doc->ExportField($this->ds_valores);
