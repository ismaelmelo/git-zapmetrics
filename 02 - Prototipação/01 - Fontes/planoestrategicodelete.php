...
$planoestrategico_delete = NULL; // Initialize page object first

class cplanoestrategico_delete extends cplanoestrategico {
	...
	// Page object name
	var $PageObjName = 'planoestrategico_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("planoestrategicolist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in planoestrategico class, planoestrategicoinfo.php
...
// Create page object
if (!isset($planoestrategico_delete)) $planoestrategico_delete = new cplanoestrategico_delete();

// Page init
$planoestrategico_delete->Page_Init();

// Page main
$planoestrategico_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$planoestrategico_delete->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var planoestrategico_delete = new ew_Page("planoestrategico_delete");
planoestrategico_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = planoestrategico_delete.PageID; // For backward compatibility

// Form object
var fplanoestrategicodelete = new ew_Form("fplanoestrategicodelete");

// Form_CustomValidate event
fplanoestrategicodelete.Form_CustomValidate = 
...
fplanoestrategicodelete.ValidateRequired = true;
<?php } else { ?>
fplanoestrategicodelete.ValidateRequired = false; 
<?php } ?>
...
if ($planoestrategico_delete->Recordset = $planoestrategico_delete->LoadRecordset())
	$planoestrategico_deleteTotalRecs = $planoestrategico_delete->Recordset->RecordCount(); // Get record count
if ($planoestrategico_deleteTotalRecs <= 0) { // No record found, exit
	if ($planoestrategico_delete->Recordset)
		$planoestrategico_delete->Recordset->Close();
	$planoestrategico_delete->Page_Terminate("planoestrategicolist.php"); // Return to list
}
?>
<?php $Breadcrumb->Render(); ?>
<?php $planoestrategico_delete->ShowPageHeader(); ?>
<?php
$planoestrategico_delete->ShowMessage();
?>
<form name="fplanoestrategicodelete" id="fplanoestrategicodelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="planoestrategico">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($planoestrategico_delete->RecKeys as $key) { ?>
<?php $keyvalue = is_array($key) ? implode($EW_COMPOSITE_KEY_SEPARATOR, $key) : $key; ?>
<input type="hidden" name="key_m[]" value="<?php echo ew_HtmlEncode($keyvalue) ?>">
<?php } ?>
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_planoestrategicodelete" class="ewTable ewTableSeparate">
<?php echo $planoestrategico->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
		<td><span id="elh_planoestrategico_nu_anoInicio" class="planoestrategico_nu_anoInicio"><?php echo $planoestrategico->nu_anoInicio->FldCaption() ?></span></td>
		<td><span id="elh_planoestrategico_nu_anoFim" class="planoestrategico_nu_anoFim"><?php echo $planoestrategico->nu_anoFim->FldCaption() ?></span></td>
		<td><span id="elh_planoestrategico_no_plano" class="planoestrategico_no_plano"><?php echo $planoestrategico->no_plano->FldCaption() ?></span></td>
		<td><span id="elh_planoestrategico_ic_situacao" class="planoestrategico_ic_situacao"><?php echo $planoestrategico->ic_situacao->FldCaption() ?></span></td>
	</tr>
	</thead>
	<tbody>
<?php
$planoestrategico_delete->RecCnt = 0;
$i = 0;
while (!$planoestrategico_delete->Recordset->EOF) {
	$planoestrategico_delete->RecCnt++;
	$planoestrategico_delete->RowCnt++;

	// Set row properties
	$planoestrategico->ResetAttrs();
	$planoestrategico->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$planoestrategico_delete->LoadRowValues($planoestrategico_delete->Recordset);

	// Render row
	$planoestrategico_delete->RenderRow();
?>
	<tr<?php echo $planoestrategico->RowAttributes() ?>>
		<td<?php echo $planoestrategico->nu_anoInicio->CellAttributes() ?>>
<span id="el<?php echo $planoestrategico_delete->RowCnt ?>_planoestrategico_nu_anoInicio" class="control-group planoestrategico_nu_anoInicio">
...
<span id="el<?php echo $planoestrategico_delete->RowCnt ?>_planoestrategico_nu_anoFim" class="control-group planoestrategico_nu_anoFim">
...
<span id="el<?php echo $planoestrategico_delete->RowCnt ?>_planoestrategico_no_plano" class="control-group planoestrategico_no_plano">
...
<span id="el<?php echo $planoestrategico_delete->RowCnt ?>_planoestrategico_ic_situacao" class="control-group planoestrategico_ic_situacao">
...
<?php
	$planoestrategico_delete->Recordset->MoveNext();
}
$planoestrategico_delete->Recordset->Close();
?>
</tbody>
...
<script type="text/javascript">
fplanoestrategicodelete.Init();
</script>
<?php
$planoestrategico_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$planoestrategico_delete->Page_Terminate();
?>
