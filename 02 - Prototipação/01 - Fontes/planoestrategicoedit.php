...
$planoestrategico_edit = NULL; // Initialize page object first

class cplanoestrategico_edit extends cplanoestrategico {
	...
	// Page object name
	var $PageObjName = 'planoestrategico_edit';
	...
	function Page_Main() {
		...
		if ($this->nu_plano->CurrentValue == "")
			$this->Page_Terminate("planoestrategicolist.php"); // Invalid key, return to list
...
// Create page object
if (!isset($planoestrategico_edit)) $planoestrategico_edit = new cplanoestrategico_edit();

// Page init
$planoestrategico_edit->Page_Init();

// Page main
$planoestrategico_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$planoestrategico_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var planoestrategico_edit = new ew_Page("planoestrategico_edit");
planoestrategico_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = planoestrategico_edit.PageID; // For backward compatibility

// Form object
var fplanoestrategicoedit = new ew_Form("fplanoestrategicoedit");

// Validate form
fplanoestrategicoedit.Validate = function() {
...
fplanoestrategicoedit.Form_CustomValidate = 
...
fplanoestrategicoedit.ValidateRequired = true;
<?php } else { ?>
fplanoestrategicoedit.ValidateRequired = false; 
<?php } ?>

// Multi-Page properties
fplanoestrategicoedit.MultiPage = new ew_MultiPage("fplanoestrategicoedit",
...
<?php $planoestrategico_edit->ShowPageHeader(); ?>
<?php
$planoestrategico_edit->ShowMessage();
?>
<form name="fplanoestrategicoedit" id="fplanoestrategicoedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="planoestrategico">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table class="ewStdTable"><tbody><tr><td>
<div class="tabbable" id="planoestrategico_edit">
...
<table id="tbl_planoestrategicoedit1" class="table table-bordered table-striped">
...
<?php echo $planoestrategico->nu_anoInicio->EditValue ?></span>
</span>
<input type="hidden" data-field="x_nu_anoInicio" name="x_nu_anoInicio" id="x_nu_anoInicio" value="<?php echo ew_HtmlEncode($planoestrategico->nu_anoInicio->CurrentValue) ?>">
...
<?php echo $planoestrategico->nu_anoFim->EditValue ?></span>
</span>
<input type="hidden" data-field="x_nu_anoFim" name="x_nu_anoFim" id="x_nu_anoFim" value="<?php echo ew_HtmlEncode($planoestrategico->nu_anoFim->CurrentValue) ?>">
...
<table cellspacing="0" class="ewGrid" style="width: 100%"><tr><td>
<table id="tbl_planoestrategicoedit2" class="table table-bordered table-striped">
...
<table cellspacing="0" class="ewGrid" style="width: 100%"><tr><td>
<table id="tbl_planoestrategicoedit3" class="table table-bordered table-striped">
...
<input type="hidden" data-field="x_nu_plano" name="x_nu_plano" id="x_nu_plano" value="<?php echo ew_HtmlEncode($planoestrategico->nu_plano->CurrentValue) ?>">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("EditBtn") ?></button>
</form>
<script type="text/javascript">
fplanoestrategicoedit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$planoestrategico_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$planoestrategico_edit->Page_Terminate();
?>
