...
define("EW_PROJECT_NAME", "_20140622", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{F59C7BF3-F287-4BE0-9F86-FCB94F808AF8}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'iu6sFbxZ6FI7yx2R', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/_20140622.css", TRUE); // Project stylesheet file name
...
define("EW_LANGUAGE_DEFAULT_ID", "pt", TRUE);
...
define("EW_AUDIT_TRAIL_TABLE_NAME", "[dbo].[auditoria]", TRUE); // Audit trail table name
define("EW_AUDIT_TRAIL_FIELD_NAME_DATETIME", "dt_data", TRUE); // Audit trail DateTime field name
define("EW_AUDIT_TRAIL_FIELD_NAME_SCRIPT", "ds_dominioArquivo", TRUE); // Audit trail Script field name
define("EW_AUDIT_TRAIL_FIELD_NAME_USER", "no_perfil", TRUE); // Audit trail User field name
define("EW_AUDIT_TRAIL_FIELD_NAME_ACTION", "ic_acao", TRUE); // Audit trail Action field name
define("EW_AUDIT_TRAIL_FIELD_NAME_TABLE", "no_tabela", TRUE); // Audit trail Table field name
define("EW_AUDIT_TRAIL_FIELD_NAME_FIELD", "no_campo", TRUE); // Audit trail Field field name
define("EW_AUDIT_TRAIL_FIELD_NAME_KEYVALUE", "nu_chaveCampo", TRUE); // Audit trail Key Value field name
define("EW_AUDIT_TRAIL_FIELD_NAME_OLDVALUE", "im_antes", TRUE); // Audit trail Old Value field name
define("EW_AUDIT_TRAIL_FIELD_NAME_NEWVALUE", "im_depois", TRUE); // Audit trail New Value field name

// Security
define("EW_ADMIN_USER_NAME", "admin", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "eufrabad", TRUE); // Administrator password
define("EW_USE_CUSTOM_LOGIN", TRUE, TRUE); // Use custom login

// Dynamic User Level settings
// User level definition table/field names

@define("EW_USER_LEVEL_TABLE", "[dbo].[usuario_permissoes]", TRUE);
@define("EW_USER_LEVEL_ID_FIELD", "[nu_level]", TRUE);
@define("EW_USER_LEVEL_NAME_FIELD", "[no_level]", TRUE);

// User Level privileges table/field names
@define("EW_USER_LEVEL_PRIV_TABLE", "[dbo].[permissoes]", TRUE);
@define("EW_USER_LEVEL_PRIV_TABLE_NAME_FIELD", "[no_tabela]", TRUE);
@define("EW_USER_LEVEL_PRIV_TABLE_NAME_FIELD_2", "no_tabela", TRUE);
@define("EW_USER_LEVEL_PRIV_TABLE_NAME_FIELD_SIZE", 255, TRUE);
@define("EW_USER_LEVEL_PRIV_USER_LEVEL_ID_FIELD", "[nu_level]", TRUE);
@define("EW_USER_LEVEL_PRIV_PRIV_FIELD", "[ic_permissao]", TRUE);
...
define("EW_USER_NAME_FILTER", "([no_login] = '%u')",  TRUE);
define("EW_USER_ID_FILTER", "([nu_usuario] = %u)",  TRUE);
define("EW_USER_EMAIL_FILTER", "([no_email] = '%e')",  TRUE);
define("EW_USER_ACTIVATE_FILTER", "",  TRUE);
define("EW_USER_PROFILE_FIELD_NAME", "nu_perfil",  TRUE);
...
// File upload
define("EW_UPLOAD_DEST_PATH", "arquivos/contratos/", TRUE); // Upload destination path (relative to app root)
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "gif,jpg,jpeg,bmp,png,doc,xls,pdf,zip,pdf,docm,docx,xlsx,xls,odt,php,html", TRUE); // Allowed file extensions
...
define("EW_DEFAULT_LOCALE", '{"decimal_point":",","thousands_sep":".","int_curr_symbol":"$","currency_symbol":"R$","mon_decimal_point":",","mon_thousands_sep":".","positive_sign":null,"negative_sign":"-","int_frac_digits":2,"frac_digits":2,"p_cs_precedes":true,"p_sep_by_space":false,"n_cs_precedes":true,"n_sep_by_space":false,"p_sign_posn":3,"n_sign_posn":3}', TRUE);
