...
?>
<form name="fpermissoesdelete" id="fpermissoesdelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<table id="tbl_permissoesdelete" class="ewTable ewTableSeparate">
<?php echo $permissoes->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
		<td><span id="elh_permissoes_no_tabela" class="permissoes_no_tabela"><?php echo $permissoes->no_tabela->FldCaption() ?></span></td>
		<td><span id="elh_permissoes_ic_permissao" class="permissoes_ic_permissao"><?php echo $permissoes->ic_permissao->FldCaption() ?></span></td>
	</tr>
	</thead>
	<tbody>
<?php
...
<span id="el<?php echo $permissoes_delete->RowCnt ?>_permissoes_no_tabela" class="control-group permissoes_no_tabela">
<span<?php echo $permissoes->no_tabela->ViewAttributes() ?>>
<?php echo $permissoes->no_tabela->ListViewValue() ?></span>
</span>
</td>
		<td<?php echo $permissoes->ic_permissao->CellAttributes() ?>>
<span id="el<?php echo $permissoes_delete->RowCnt ?>_permissoes_ic_permissao" class="control-group permissoes_ic_permissao">
<span<?php echo $permissoes->ic_permissao->ViewAttributes() ?>>
<?php echo $permissoes->ic_permissao->ListViewValue() ?></span>
</span>
</td>
	</tr>
<?php
