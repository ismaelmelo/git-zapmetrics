...
$tbrdm_issues_view = NULL; // Initialize page object first

class ctbrdm_issues_view extends ctbrdm_issues {
	...
	// Page object name
	var $PageObjName = 'tbrdm_issues_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "tbrdm_issueslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tbrdm_issueslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "tbrdm_issueslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_tbrdm_issues\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_tbrdm_issues',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.ftbrdm_issuesview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($tbrdm_issues_view)) $tbrdm_issues_view = new ctbrdm_issues_view();

// Page init
$tbrdm_issues_view->Page_Init();

// Page main
$tbrdm_issues_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbrdm_issues_view->Page_Render();
?>
...
// Page object
var tbrdm_issues_view = new ew_Page("tbrdm_issues_view");
tbrdm_issues_view.PageID = "view"; // Page ID
var EW_PAGE_ID = tbrdm_issues_view.PageID; // For backward compatibility

// Form object
var ftbrdm_issuesview = new ew_Form("ftbrdm_issuesview");

// Form_CustomValidate event
ftbrdm_issuesview.Form_CustomValidate = 
...
ftbrdm_issuesview.ValidateRequired = true;
<?php } else { ?>
ftbrdm_issuesview.ValidateRequired = false; 
<?php } ?>
...
<?php $tbrdm_issues_view->ExportOptions->Render("body") ?>
<?php if (!$tbrdm_issues_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($tbrdm_issues_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $tbrdm_issues_view->ShowPageHeader(); ?>
<?php
$tbrdm_issues_view->ShowMessage();
?>
<form name="ftbrdm_issuesview" id="ftbrdm_issuesview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="tbrdm_issues">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_tbrdm_issuesview" class="table table-bordered table-striped">
<?php if ($tbrdm_issues->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_tbrdm_issues_id"><?php echo $tbrdm_issues->id->FldCaption() ?></span></td>
...
<?php echo $tbrdm_issues->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_issues->tracker_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_issues->project_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_issues->subject->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_issues->due_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_issues->category_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_issues->status_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_issues->assigned_to_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_issues->priority_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_issues->fixed_version_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_issues->author_id->Visible) { // author_id ?>
	<tr id="r_author_id">
		<td><span id="elh_tbrdm_issues_author_id"><?php echo $tbrdm_issues->author_id->FldCaption() ?></span></td>
...
<?php echo $tbrdm_issues->author_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_issues->lock_version->Visible) { // lock_version ?>
	<tr id="r_lock_version">
		<td><span id="elh_tbrdm_issues_lock_version"><?php echo $tbrdm_issues->lock_version->FldCaption() ?></span></td>
...
<?php echo $tbrdm_issues->lock_version->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_issues->created_on->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_issues->updated_on->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_issues->start_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_issues->done_ratio->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_issues->estimated_hours->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_issues->parent_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tbrdm_issues->root_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbrdm_issues->is_private->Visible) { // is_private ?>
	<tr id="r_is_private">
		<td><span id="elh_tbrdm_issues_is_private"><?php echo $tbrdm_issues->is_private->FldCaption() ?></span></td>
...
<?php echo $tbrdm_issues->is_private->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ftbrdm_issuesview.Init();
</script>
<?php
$tbrdm_issues_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($tbrdm_issues->Export == "") { ?>
...
<?php
$tbrdm_issues_view->Page_Terminate();
?>
