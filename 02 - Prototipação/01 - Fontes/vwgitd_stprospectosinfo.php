...
$vwgitd_stProspectos = NULL;

//
// Table class for vwgitd_stProspectos
//
class cvwgitd_stProspectos extends cTable {
	var $ic_stProspecto;
	var $qt_prospecto;
	...
	function __construct() {
		...
		$this->TableVar = 'vwgitd_stProspectos';
		$this->TableName = 'vwgitd_stProspectos';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// ic_stProspecto
		$this->ic_stProspecto = new cField('vwgitd_stProspectos', 'vwgitd_stProspectos', 'x_ic_stProspecto', 'ic_stProspecto', '[ic_stProspecto]', '[ic_stProspecto]', 129, -1, FALSE, '[ic_stProspecto]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['ic_stProspecto'] = &$this->ic_stProspecto;

		// qt_prospecto
		$this->qt_prospecto = new cField('vwgitd_stProspectos', 'vwgitd_stProspectos', 'x_qt_prospecto', 'qt_prospecto', '[qt_prospecto]', 'CAST([qt_prospecto] AS NVARCHAR)', 3, -1, FALSE, '[qt_prospecto]', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlFrom() { // From
		return "[db_owner].[vwgitd_stProspectos]";
	}
	...
	// Update Table
	var $UpdateTable = "[db_owner].[vwgitd_stProspectos]";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "vwgitd_stprospectoslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("vwgitd_stprospectosview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("vwgitd_stprospectosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "vwgitd_stprospectosadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("vwgitd_stprospectosedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("vwgitd_stprospectosadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("vwgitd_stprospectosdelete.php", $this->UrlParm());
	}
