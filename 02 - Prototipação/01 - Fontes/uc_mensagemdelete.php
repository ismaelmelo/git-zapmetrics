...
$uc_mensagem_delete = NULL; // Initialize page object first

class cuc_mensagem_delete extends cuc_mensagem {
	...
	// Page object name
	var $PageObjName = 'uc_mensagem_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("uc_mensagemlist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in uc_mensagem class, uc_mensageminfo.php
...
// Create page object
if (!isset($uc_mensagem_delete)) $uc_mensagem_delete = new cuc_mensagem_delete();

// Page init
$uc_mensagem_delete->Page_Init();

// Page main
$uc_mensagem_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$uc_mensagem_delete->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var uc_mensagem_delete = new ew_Page("uc_mensagem_delete");
uc_mensagem_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = uc_mensagem_delete.PageID; // For backward compatibility

// Form object
var fuc_mensagemdelete = new ew_Form("fuc_mensagemdelete");

// Form_CustomValidate event
fuc_mensagemdelete.Form_CustomValidate = 
...
fuc_mensagemdelete.ValidateRequired = true;
<?php } else { ?>
fuc_mensagemdelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fuc_mensagemdelete.Lists["x_nu_mensagem"] = {"LinkField":"x_nu_mensagem","Ajax":null,"AutoFill":false,"DisplayFields":["x_co_alternativo","x_no_mensagem","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
if ($uc_mensagem_delete->Recordset = $uc_mensagem_delete->LoadRecordset())
	$uc_mensagem_deleteTotalRecs = $uc_mensagem_delete->Recordset->RecordCount(); // Get record count
if ($uc_mensagem_deleteTotalRecs <= 0) { // No record found, exit
	if ($uc_mensagem_delete->Recordset)
		$uc_mensagem_delete->Recordset->Close();
	$uc_mensagem_delete->Page_Terminate("uc_mensagemlist.php"); // Return to list
}
?>
<?php $Breadcrumb->Render(); ?>
<?php $uc_mensagem_delete->ShowPageHeader(); ?>
<?php
$uc_mensagem_delete->ShowMessage();
?>
<form name="fuc_mensagemdelete" id="fuc_mensagemdelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="uc_mensagem">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($uc_mensagem_delete->RecKeys as $key) { ?>
<?php $keyvalue = is_array($key) ? implode($EW_COMPOSITE_KEY_SEPARATOR, $key) : $key; ?>
<input type="hidden" name="key_m[]" value="<?php echo ew_HtmlEncode($keyvalue) ?>">
<?php } ?>
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_uc_mensagemdelete" class="ewTable ewTableSeparate">
<?php echo $uc_mensagem->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
		<td><span id="elh_uc_mensagem_nu_mensagem" class="uc_mensagem_nu_mensagem"><?php echo $uc_mensagem->nu_mensagem->FldCaption() ?></span></td>
	</tr>
	</thead>
	<tbody>
<?php
$uc_mensagem_delete->RecCnt = 0;
$i = 0;
while (!$uc_mensagem_delete->Recordset->EOF) {
	$uc_mensagem_delete->RecCnt++;
	$uc_mensagem_delete->RowCnt++;

	// Set row properties
	$uc_mensagem->ResetAttrs();
	$uc_mensagem->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$uc_mensagem_delete->LoadRowValues($uc_mensagem_delete->Recordset);

	// Render row
	$uc_mensagem_delete->RenderRow();
?>
	<tr<?php echo $uc_mensagem->RowAttributes() ?>>
		<td<?php echo $uc_mensagem->nu_mensagem->CellAttributes() ?>>
<span id="el<?php echo $uc_mensagem_delete->RowCnt ?>_uc_mensagem_nu_mensagem" class="control-group uc_mensagem_nu_mensagem">
...
<?php
	$uc_mensagem_delete->Recordset->MoveNext();
}
$uc_mensagem_delete->Recordset->Close();
?>
</tbody>
...
<script type="text/javascript">
fuc_mensagemdelete.Init();
</script>
<?php
$uc_mensagem_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$uc_mensagem_delete->Page_Terminate();
?>
